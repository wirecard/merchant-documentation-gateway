...
_Wirecard Payment Gateway_ will generate a _Provider Transaction Reference ID_
...
[source,xml]
----
include::samples/xml/API_POIPIA_SamplesAuthorization_AuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_POIPIA_SamplesAuthorization_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_POIPIA_SamplesAuthorization_AuthorizationRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_POIPIA_SamplesAuthorization_AuthorizationResponseFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_POIPIA_SamplesVoidauthorization_VoidAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_POIPIA_SamplesVoidauthorization_VoidAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_POIPIA_SamplesVoidauthorization_VoidAuthorizationRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_POIPIA_SamplesVoidauthorization_VoidAuthorizationResponseFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_POIPIA_SamplesDeposit_DepositNotificationMatched.xml[]
----
