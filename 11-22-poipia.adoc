...
[source,xml]
----
include::samples/xml/wiretransfer_void-authorization_request_success.xml[]
----
...
[source,xml]
----
include::samples/xml/wiretransfer_void-authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/wiretransfer_void-authorization_request_failure.xml[]
----
