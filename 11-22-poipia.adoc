...
For the {payment-provider-name} Hosted Payment Page (HPP) integration an invoicing page
...
for a transaction. It is generated automatically.
...
|provider-transaction-reference-id |  |M |String |10 |_{payment-gateway-abbr}_ generates this
