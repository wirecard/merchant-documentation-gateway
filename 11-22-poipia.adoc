...
[source,xml]
----
include::src-files/xml/API_POIPIA_Samples_authorization__authorization__Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_POIPIA_Samples_authorization__authorization__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_POIPIA_Samples_authorization__authorization__Request_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_POIPIA_Samples_authorization__authorization__Response_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_POIPIA_Samples_voidauthorization__authorization__Response_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_POIPIA_Samples_deposit__deposit__Notification_matched.xml[]
----
