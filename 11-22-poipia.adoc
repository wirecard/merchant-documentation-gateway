...
_Wirecard Payment Processing Gateway_ allows a merchant to integrate
...
. _Wirecard Payment Processing Gateway_ deposits the funds into the merchants'
bank account.
. _Wirecard Payment Processing Gateway_ sends a notification to the merchants.
...
entered _Wirecard Payment Processing Gateway_ successfully. The payment is in the
...
Once the consumer's payment reaches the _Wirecard Payment Processing Gateway_,
_Wirecard Payment Processing Gateway_ matches the transaction to the original
