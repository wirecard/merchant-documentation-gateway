...
ifndef::env-nova[]
4+| <<CC_Fields_{listname}_response_avs, avs>>
endif::[]

4+|<<CC_Fields_{listname}_response_customfield, custom-fields.custom-field>>.

4+|<<CC_Fields_{listname}_response_status, statuses.status>>.

4+|<<CC_Fields_{listname}_response_threed, three-d>>
