...
| String 
| 36 
| Card account number of the consumer. It is mandatory if <<{listname}_request_cardtoken,``card-token``>> is not used.
...
|card-emv
// <<{listname}_request_cardemv, card-emv>>
|O 
| 
| 
...
// |card-pin
// <<{listname}_request_cardpin, card-pin>>
// |O 
// | 
// | 
...
// |card-raw
// <<{listname}_request_cardraw, card-raw>> 
// |O 
// | 
// | 
// |The raw card data.
