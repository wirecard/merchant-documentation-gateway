...
- *Recommended* for <<CreditCard_3DS2_Fields, 3D Secure 2 transactions>> to reduce likelihood of an authentication challenge.
//-
...
- Optional for shipping address.
- *Recommended* for billing address and shipping address in <<CreditCard_3DS2_Fields, 3D Secure 2 transactions>> to reduce likelihood of an authentication challenge.
