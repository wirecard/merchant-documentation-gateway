...
// this note contains a logical error: It must either be 
// with ``periodic-type`` = 'installment' or ``periodic-type`` = 'recurring'
// or
// with ``periodic-type`` = 'installment' and ``sequence-type`` = 'recurring'
// end::three-ds[]
