...
[source,xml]
----
include::samples/xml/POLiSamplesDebit_DebitRequestSuccessful.xml[]
----

.XML debit Response (Successful)
[source,xml]
----
include::samples/xml/POLiSamplesDebit_DebitResponseSuccessful.xml[]
----

.XML debit Request (Failure)
[source,xml]
----
include::samples/xml/POLiSamplesDebit_DebitRequestFailure.xml[]
----

.XML debit Response (Failure)
[source,xml]
----
include::samples/xml/POLiSamplesDebit_DebitResponseFailure.xml[]
----
