...
[source,xml]
----
include::src-files/xml/POLi_Samples_debit_debit_Request_Successful.xml[]
----

.XML debit Response (Successful)
[source,xml]
----
include::src-files/xml/POLi_Samples_debit_debit_Response_Successful.xml[]
----

.XML debit Request (Failure)
[source,xml]
----
include::src-files/xml/POLi_Samples_debit_debit_Request_Failure.xml[]
----

.XML debit Response (Failure)
[source,xml]
----
include::src-files/xml/POLi_Samples_debit_debit_Response_Failure.xml[]
----
