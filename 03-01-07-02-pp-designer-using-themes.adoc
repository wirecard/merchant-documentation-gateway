...
+
NOTE: You can toggle between the Payment Page Designer and the {payment-page-v2-abbr} design manager menu. Use *BACK TO DESIGNER* to switch to the Payment Page Designer menu. Use *MANAGE* in the Payment Page Designer to return to the {payment-page-v2-abbr} design manager menu.
