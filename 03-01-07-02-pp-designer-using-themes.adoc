...
WARNING: Make sure that only one user is editing a theme. If two users edit a theme at the same time, some changes are lost.
...
When you expand the *Translations* section, note that the *Import translations* and *Export default translations* buttons, and a list of uploaded translations are displayed.

In the *Translations* section you can: 

- Import a translation file (the translation file must be available in .json format)
- Edit the default translation file (click *Export default translations* to export the translation to a .json file, then edit the file in a text editor and reimport it)
...
When you expand the *Themes* section, note that the *Create New Theme* and *Import Theme* buttons, and a list of saved themes are displayed.
...
- Change the theme settings (click *Style it* to open the theme in the Payment Page Designer menu, *MANAGE* to return to Themes Manager, and *BACK TO DESIGNER* to return to the Payment Page Designer menu) 

NOTE: If *Style it* is unavailable, the theme is already in the Payment Page Designer. 
