...
[#PPD_{payment-page-v2}-Manager_Use]
====== The {payment-page-v2-abbr} Manager

[#PPD_{payment-page-v2}-Manager_Change_User]
.Selected User

Expand the *Selected User* section to change the user

?????Ronald: Why is this necessary?????

[#PPD_{payment-page-v2}-Manager_Use_Translations]
.Translations
...
[#PPD_{payment-page-v2}-Manager_Use_Themes]
.Themes
...
* Select a <<PPD_{payment-page-v2}-Manager_Use_Translations, translation file>> 
* Set the theme as default (the default theme will be used for payment processes if not indicated otherwise <<PPD_{payment-page-v2}-Manager_Sample, in a request>>)
...
[#PPD_{payment-page-v2}-Manager_Field]
...
[#PPD_{payment-page-v2}-Manager_Sample]
