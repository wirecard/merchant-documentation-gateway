[#PPD_{payment-page-v2-abbr}-Manager]
...
[#PPD_{payment-page-v2-abbr}-Manager_Change_User]
.Selected User
...
[#PPD_{payment-page-v2-abbr}-Manager_Translations]
.Translations
...
[#PPD_{payment-page-v2-abbr}-Manager_Themes]
.Themes
...
* Select a <<PPD_{payment-page-v2-abbr}-Manager_Translations, translation file>> 
* Set the theme as default (the default theme will be used for payment processes if not indicated otherwise <<PPD_{payment-page-v2-abbr}-Manager_Sample, in a request>>)
...
[#PPD_{payment-page-v2-abbr}-Manager_Field]
...
[#PPD_{payment-page-v2-abbr}-Manager_Sample]
