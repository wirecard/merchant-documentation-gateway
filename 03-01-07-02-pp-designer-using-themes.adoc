...
===== {payment-page-v2} Design Manager

With the <<PPD_customize, Payment Page Designer>> you can design individual payment forms for your {payment-page-v2}. +
You can have more than one payment form available. +
You can save each payment form as a theme. +
Use the {payment-page-v2-abbr} Design Manager to edit and organize your themes and translations.

. Open the https://designer-test.{domain}[Payment Page Designer]. 
. Click *Login*.
. Use your credentials provided by Merchant Support to access the {payment-page-v2-abbr} Design Manager.
...
NOTE: A session timeout requires a relogin to the {payment-page-v2-abbr} Design Manager after 60 minutes of inactivity.

The {payment-page-v2-abbr} Design Manager is divided into two sections:
...
In the list of imported themes: 
...
NOTE: You can toggle between the Payment Page Designer menu and the {payment-page-v2-abbr} Design Manager. Use *MANAGE* in the Payment Page Designer to return to {payment-page-v2-abbr} Design Manager, and *BACK TO DESIGNER* to return to the Payment Page Designer menu. +
If *Style it* is unavailable in the {payment-page-v2-abbr} Design Manager, the theme is already open in the Payment Page Designer. 
