...
**Re**presentational **S**tate **T**ransfer (REST). {payment-provider-name}'s REST APIs
...
Every request sent to the {payment-gateway} is
...
| Credit Card | ``\https://{rest-api-test-endpoint}/engine/rest/payments`` | ``\https://{instance-hostname}/engine/rest/payments``
| Alternative Payment Methods | ``\https://{rest-api-test-endpoint}/engine/rest/paymentmethods/`` | ``\https://{instance-hostname}/engine/rest/paymentmethods/``
| Mobile Payments | ``\https://{rest-api-test-endpoint}/engine/rest/mobile/payments`` | ``\https://{instance-hostname}/engine/rest/mobile/payments``
