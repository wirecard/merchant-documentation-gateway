...
In the *Custom CSS* section you can find more detailed settings. If you want a more precise customization than the available presets, personalize your style sheet further, save it (<<PPD_customize_save, export it to a theme>>).
