...
Click *Login* to access the <<PPD_customize_save, **Payment Page Manager**>>.
////
Include link to Payment Page Manager
////
...
* Add further input fields (*Card form fields*) for additional consumer information (e.g. address, email, phone, etc).
