...
- select a language (35 languages are available) for your payment page.
- select a payment method.
- cancel a payment process.

*Payment Page Styler* +
In the head of the Payment Page Styler you can select a language (possible are English, German and French) and you find the login button. 
...
You can see your uploaded font as custom font. You can select the font for both, text/buttons or input fields.
...
- the buttons (change primary color), 
- the <<PPD_customize_misc, *CANCEL PAYMENT* button>>, if you set it next to the submit button (change "Secondary (Dismiss) Color"). This has an effect to every visibility of the *CANCEL PAYMENT* button, 
- the entire background 
- the payment page form (change Content Background).
- the input fields 
...
In the "Custom CSS" section you can define your own style sheet. If you don't want to follow the available presets in the preceding sections you can personalize your style sheet here and export it to a theme.
...
If you want to save your settings you can export them to a theme.
