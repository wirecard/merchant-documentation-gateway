...
- *Grid* shows all the available payment methods
- *Processing* shows the *Spinner* (process indicator as it is presented to the consumer while waiting for the execution of the payment process)
...
- Insert additional input fields (*Card form fields*) for detailed consumer information (e.g. address, email, phone, etc)
