...
For desktop {payment-provider-name} supports the operating systems (OS) _Windows_ and
_Mac OS_.
...
On mobile devices {payment-provider-name} supports the OS _Android_ and _iOS_. See
