...
[NOTE]
Typically, a _capture-authorization_ captures either a part of or the full amount of the authorized amount. If you want to capture an amount larger than initially authorized, <<CreditCard_Overcapturing, overcapturing>> must be enabled.
