...
[NOTE]
Typically, a _capture-authorization_ captures either a part of or the full amount of the authorized amount. If you want to capture an amount higher than initially authorized, your merchant account needs to be configured (details see <<CreditCard_Overcapturing, overcapturing>>).
