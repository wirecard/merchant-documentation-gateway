...
.  WPG sends response containing the transaction result back to
merchant.
...
|country |O |O |O |String |3 |Name of the shipment recipient's country. Please use the list of country codes supported by https://developer.paypal.com/docs/classic/api/country-codes/[Paypal]
...
Please use the list of state codes supported by Paypal: https://developer.paypal.com/docs/classic/api/state-codes/
...
|postal-code |C |C |C |String |16 |Postal code of the shipment recipient's city. It is a mandatory field if the shipment recipient's country is marked with a <<API_PayPal_Fields_Payment_Shipping_Address_footnote, ^(1)^>> in the field description for ``shipping.address.state``.
7+a|
...
====== custom-field.
|paypal-address-status |O |O |O |String |256 |This is the status of the PayPal address check. Note that this field must be explicitly enabled by <<ContactUs, Wirecard's Merchant Support>>.
|paypal-protection-eligibility |O |O |O |String |256 |This is the status of the PayPal Seller Protection offered to merchants to protect them from chargebacks, reversals, etc. Note that this field must be explicitly enabled by <<ContactUs, Wirecard's Merchant Support>>.
7+a|
...
(<<GeneralPlatformFeatures_IPN_Configuration, Instant Payment Notification>>) has to be enabled and pointed to the Wirecard
...
<<ContactUs, Wirecard Merchant Support>>.
...
[source,xml]
----
include::samples/xml/API_PayPalFeaturesProvider_BasketItems.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_PreauthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_PreauthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_PreauthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_PreauthorizationRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_PreauthorizationResponseFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationResponseSuccessful.xml[]
----
._authorization_ Notification (Successful)

[source, xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationResponseFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_FirstRecurringAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_FirstRecurringAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_FirstRecurringAuthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_RecurringAuthorizationRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_RecurringAuthorizationResponseFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_RecurringAuthorizationNotificationFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationOnlyRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationOnlyResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationOnlyNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationReferencingAnOrderRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_AuthorizationReferencingAnOrderResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_CaptureAuthorizationSubsequentPaymentRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_CaptureAuthorizationSubsequentPaymentResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_CaptureAuthorizationSubsequentPaymentNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_VoidAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_VoidAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorization_VoidAuthorizationNotificationSuccessful.xml[]
----
...
[source,json]
----
include::samples/json/API_PayPalSamplesGeneralSamplesAuthorizationJson_JSON_AuthorizationRequestSuccessful.json[]
----
...
[source,json]
----
include::samples/json/API_PayPalSamplesGeneralSamplesAuthorizationJson_JSON_AuthorizationRequestSuccessful_5.json[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesCredit_PendingCreditRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesCredit_PendingCreditResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesCredit_PendingCreditResponseSuccessful_6.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesDebit_DebitRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesDebit_DebitResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesDebit_DebitNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesOrder_OrderRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesOrder_OrderResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesOrder_OrderNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesRefunddebit_RefundDebitRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesRefunddebit_RefundDebitResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesRefunddebit_RefundDebitNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesRefundcapture_RefundCaptureRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesRefundcapture_RefundCaptureResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesRefundcapture_RefundCaptureNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowPreauthorization_PreauthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowPreauthorization_PreauthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowPreauthorization_PreauthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowAuthorization_AuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowAuthorization_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowAuthorization_AuthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowCaptureauthorization_CaptureRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowCaptureauthorization_CaptureResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowCaptureauthorization_CaptureNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowrefundCapture_RefundCaptureRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowrefundCapture_RefundCaptureResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowrefundCapture_RefundCaptureNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowDebit_DebitRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowDebit_DebitResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowDebit_DebitNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesrefundDebit_RefundDebitRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesrefundDebit_RefundDebitResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesrefundDebit_RefundDebitNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesAuthorization_AuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesAuthorization_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesAuthorization_AuthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesVoidauthorization_VoidAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesVoidauthorization_VoidAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesVoidauthorization_VoidAuthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesOrder_OrderRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesOrder_OrderResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesOrder_OrderNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesReferencingOrderAuthorization_ReferencingAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesReferencingOrderAuthorization_ReferencingAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesReferencingOrderAuthorization_ReferencingAuthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesCaptureAuthorization_CaptureRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesCaptureAuthorization_CaptureResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesCaptureAuthorization_CaptureNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesCaptureAuthorization_ReferencingAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesCaptureAuthorization_ReferencingAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesReferencingAuthorizationCaptureAuthorization_CaptureAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesReferencingAuthorizationCaptureAuthorization_CaptureAuthorizationResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/API_PayPalSamplesReferencingAuthorizationCaptureAuthorization_CaptureAuthorizationNotificationSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesPendingcredit_PendingCreditRequestSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesPendingcredit_PendingCreditResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesPendingcredit_PendingCreditNotificationSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorizationonly_AuthorizationOnlyRequestSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorizationonly_AuthorizationOnlyResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/API_PayPalSamplesGeneralSamplesAuthorizationonly_AuthorizationOnlyNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitRecurringFirst_DebitRequestFirstTransactionSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitRecurringFirst_DebitResponseFirstTransactionSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitRecurringRecurring_DebitRequestRecurringSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitRecurringRecurring_DebitResponseRecurringSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitRecurringRecurring_DebitRefundRequestRecurringSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitRecurringFinal_DebitRequestFinalSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitRecurringFinal_DebitResponseFinalSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitRecurringFinal_DebitRefundFinalSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitInstallmentFirst_DebitRequestFirstSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitInstallmentFirst_DebitResponseFirstSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitInstallmentFirst_DebitNotificationFirstSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitInstallmentRecurring_DebitRequestRecurringSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitInstallmentRecurring_DebitResponseRecurringSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitInstallmentRecurring_DebitNotificationRecurringSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitInstallmentFinal_DebitRequestFinalSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitInstallmentFinal_DebitResponseFinalSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesDebitInstallmentFinal_DebitNotificationFinalSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowShowonlyAuthorization_AuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowShowonlyAuthorization_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowShowonlyAuthorization_AuthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowShowonlycaptureAuthorization_CaptureAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowShowonlycaptureAuthorization_CaptureAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowShowonlycaptureAuthorization_CaptureAuthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowEditAddressAuthorization_AuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowEditAddressAuthorization_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowEditAddressAuthorization_AuthorizationNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowEditAddresscaptureAuthorization_CaptureAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowEditAddresscaptureAuthorization_CaptureAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_PayPalSamplesWorkflowEditAddresscaptureAuthorization_CaptureAuthorizationResponseSuccessful_7.xml[]
----
