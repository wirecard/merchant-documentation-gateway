...
|parent-transaction-id |C |C |C |String |36 |Transaction ID of the first transaction of a payment. For an individual payment parent-transaction-id is not necessary. If the process is recurring, parent-transaction-id is mandatory in the recurring and final transaction.
...
|shipping.address.country |O |O |O |String |3 |Name of the shipment recipient's country. Please use the list of country codes supported by https://developer.paypal.com/docs/classic/api/country-codes/[Paypal]
