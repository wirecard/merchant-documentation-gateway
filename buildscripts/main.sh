...
function buildPartner() {
  ...
  find samples/{auto-generated,xml}/ -name "*.xml" -exec tidy -xml -indent -modify -wrap 120 {} \; 2>/dev/null
  find samples/{auto-generated,json}/ -name "*.json" -exec jsonlint --in-place --quiet {} +
