...
[[title-heading]]
[[title-text]] API merchant specification : WeChat QRPay
---------------------------------------------------------

[[content]]
Created by Volker Hauss, last modified by Karin Kraus on Jan 09, 2019

[[main-content]]
* link:#WeChatQRPay-Introduction[Introduction]
** link:#WeChatQRPay-WeChat[WeChat]
** link:#WeChatQRPay-WeChatQRPay[WeChat QRPay]
* link:#WeChatQRPay-GeneralInformation[General Information]
** link:#WeChatQRPay-PaymentMode,CountriesandCurrencies[Payment Mode,
Countries and Currencies]
** link:#WeChatQRPay-CommunicationFormats[Communication Formats]
* link:#WeChatQRPay-TransactionTypes[Transaction Types]
* link:#WeChatQRPay-TestCredentials[Test Credentials]
* link:#WeChatQRPay-Workflow[Workflow]
* link:#WeChatQRPay-Fields[Fields]
* #WeChatQRPay-Samples:Requests,ResponsesandNotifications[Samples:
Requests, Responses and Notifications]
** link:#WeChatQRPay-ReSTAPI[ReST API]
*** link:#WeChatQRPay-debit/get-url[debit/get-url]
**** link:#WeChatQRPay-XML[XML]
**** link:#WeChatQRPay-NVP[NVP]
*** link:#WeChatQRPay-refund-debit[refund-debit]
**** link:#WeChatQRPay-XML.1[XML]
*** link:#WeChatQRPay-void-debit[void-debit]
**** link:#WeChatQRPay-XML.2[XML]
** link:#WeChatQRPay-PaymentPage[Payment Page]
*** link:#WeChatQRPay-debit[debit]
**** link:#WeChatQRPay-NVP.1[NVP]

image:attachments/3703046/4194365.png[image]

[[WeChatQRPay-Introduction]]
Introduction
------------
...
[[WeChatQRPay-GeneralInformation]]
General Information
-------------------

[[WeChatQRPay-PaymentMode,CountriesandCurrencies]]
...
|*Currencies* a|
Payers pay in CNY, and major settlement currencies are included but not
...
[[WeChatQRPay-CommunicationFormats]]
...
[[WeChatQRPay-Samples:Requests,ResponsesandNotifications]]
...
*XML get-url Notification (Successful)*  Expand source
...
*XML Any Notification (Failure)*  Expand source
...
*NVP Debit Request (Successful)*  Expand source
...
*NVP Any Response (Successful)*  Expand source

[source,syntaxhighlighter-pre]
----
 NVP Response is a web page
----
...
*NVP Debit Request (Failure)*  Expand source
...
*NVP Any Response (Failure)*  Expand source
...
*NVP Any Notification (Failure)*  Expand source
...
*XML refund-debit Notification (Successful)*  Expand source
...
*XML void-debit Notification (Successful)*  Expand source
...
*NVP Request Debit (Successful)*  Expand source
...
*NVP Response Debit (Successful)*  Expand source
...
*NVP Notification Debit (Successful)*  Expand source
...
link:attachments/3703046/3703045.png[20180126_WeChat_QRCode.png]
(image/png) +
image:images/icons/bullet_blue.gif[image,width=8,height=8]
link:attachments/3703046/3703819.png[Logo_WeChat_QRCode.png]
(image/png) +
image:images/icons/bullet_blue.gif[image,width=8,height=8]
link:attachments/3703046/4194365.png[WeChat_QRCode_logo.png]
(image/png) +
image:images/icons/bullet_blue.gif[image,width=8,height=8]
link:attachments/3703046/4194366.png[WeChat_QRCode_flowchart.png]
(image/png) +
