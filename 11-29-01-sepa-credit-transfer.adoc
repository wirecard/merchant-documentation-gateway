...
[source,xml]
----
include::src-files/xml/SEPACreditTransfer_Samples_PendingCredit_Xml__Once_the_transaction_has_been_successfully_sent_to_and_processed_by.xml[]
----
...
[source,json]
----
include::src-files/json/SEPACreditTransfer_Samples_PendingCredit_Json__Once_the_transaction_has_been_successfully_sent_to_and_processed_by.json[]
----
...
[source,xml]
----
include::src-files/xml/SEPACreditTransfer_Samples_VoidPendingCredit__Once_the_transaction_has_been_successfully_sent_to_and_processed_by.xml[]
----
