...
_{payment-gateway}_ supports referenced and non-referenced _SEPA Credit Transfer_ options.
...
| _pending-credit_ | Transaction is processed in the _{payment-gateway}_.
...
----
include::samples/xml/sepacredit_pending-credit_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sepacredit_pending-credit_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sepacredit_pending-credit_request_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sepacredit_pending-credit_response_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sepacredit_void-pending-credit_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sepacredit_void-pending-credit_response_success_8938d389.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sepacredit_void-pending-credit_request_.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sepacredit_void-pending-credit_response_.xml[]
----
