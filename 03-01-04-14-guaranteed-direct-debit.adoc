...
Below, we provide sample requests for the transaction type <<PPv2_GuaranteedDirectDebit_TransactionType_authorization, _authorization_>>, including a field lists with short descriptions.
