...
This payment method is available for integration with <<PP, {payment-page-v1}>> only.  
...
[cols="35h,65"]
|===
| Bank to use for Bank Selection 
...
----
 var requestedData = {
    ...
    "request_signature": "" //generate request signature, see link. 
