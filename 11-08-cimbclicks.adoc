...
[source,xml]
----
include::samples/xml/CIMBClicksSamples_DebitRequestSuccessful.xml[]
----

.debit Response (Successful)
[source,xml]
----
include::samples/xml/CIMBClicksSamples_DebitResponseSuccessful.xml[]
----

.debit Notification (Successful)
[source,xml]
----
include::samples/xml/CIMBClicksSamples_DebitNotificationSuccessful.xml[]
----
