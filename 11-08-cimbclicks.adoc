...
[source,xml]
----
include::src-files/xml/CIMBClicks_Samples_debit_Request_Successful.xml[]
----

.debit Response (Successful)
[source,xml]
----
include::src-files/xml/CIMBClicks_Samples_debit_Response_Successful.xml[]
----

.debit Notification (Successful)
[source,xml]
----
include::src-files/xml/CIMBClicks_Samples_debit_Notification_Successful.xml[]
----
