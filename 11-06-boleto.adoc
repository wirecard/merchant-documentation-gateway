...
|transaction-id                                                  |  |M |  |M |M |String    |36   |The Transaction ID is the unique identifier for a transaction. It is generated automatically.
...
----
include::samples/xml/boleto_debit_request_success.xml[]
----

.Debit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/boleto_debit_response_success.xml[]
----
