...
[source,json]
----
include::src-files/json/WPP_SEPADirectDebit_TransactionType_debit_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_SEPADirectDebit_RecurringTransactions_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_SEPADirectDebit_B2BScheme_SEPA_Direct_Debit_Example_Request_with_B2B_Scheme_Enabled.json[]
----
...
[source,json]
----
include::src-files/json/WPP_SEPADirectDebit_JSON_NVPFields_JSON_Structure_for_SEPA_Direct_Debit_Requests.json[]
----
...
[source,json]
----
include::src-files/json/WPP_SEPADirectDebit_JSON_NVPFields_Request_JSON_Structure_for_SEPA_Direct_Debit_Requests.json[]
----
