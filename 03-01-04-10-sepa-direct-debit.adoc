...
{payment-page-abbr} is best used to deal with one-off payments (e.g. regular,
...
WARNING: A direct refund through {payment-page-abbr} is not possible for _SEPA Direct Debit_ so you have to
