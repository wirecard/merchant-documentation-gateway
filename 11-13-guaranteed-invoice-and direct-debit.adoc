...
image::images/11-09-guaranteed-invoice-and-direct-debit/guaranteed_invoice_workflow.png[Guaranteed Invoice Workflow, width=950, align="center"]
...
image::images/11-09-guaranteed-invoice-and-direct-debit/guaranteed_DD_workflow.png[Guaranteed Direct Debit Workflow, width=950, align="center"]
