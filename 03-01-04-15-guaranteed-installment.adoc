...
<<PPv2_GuaranteedInstallment_Samples, Below>> you find sample requests for the available transaction type <<PPv2_GuaranteedInstallment_TransactionType_authorization, authorization>>, including a field list with short descriptions.
