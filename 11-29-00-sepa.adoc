...
_{payment-gateway-abbr}_ offers two SEPA payment methods.
...
_{payment-gateway}_ allows merchants to void _SEPA Direct Debit_
...
time the transaction request has been received by the _{payment-gateway}_
...
These supplementary payments enter the _{payment-gateway}_ as
...
in the descriptor of his transfer, the _{payment-gateway}_ will
...
----
include::samples/xml/wiretransfer_deposit_notification__a88b4b46.xml[]
----
...
_credit-return_ are then initiated by the _{payment-gateway}_. It is not possible for a
...
[source,xml,subs=attributes+]
----
include::samples/xml/sepadirectdebit_debit-return_notification__3fa23529.xml[]
----
...
<<Reporting_DataReconciliation, Data Reconciliation>> or please contact <<ContactUs, Merchant Support>>.

[#SEPA_Reporting_BankDataValidation]
==== Bank Data Validation

The _{payment-gateway}_ validates the consumer's bank data, to
...
_{payment-gateway}_ validates the consumer's IBAN in the
following manner:
...
_{payment-gateway}_ validates the consumer's BIC in the following
manner:
