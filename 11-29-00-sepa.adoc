...
[source,xml]
----
include::samples/xml/SEPA_SamplesDepositNotification_DepositNotification.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPA_SamplesDebitReturnNotification_DebitReturnNotification.xml[]
----
