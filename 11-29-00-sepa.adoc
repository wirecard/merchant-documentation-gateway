...
[source,xml]
----
include::src-files/xml/SEPA_Samples_DepositNotification_deposit_Notification.xml[]
----
...
[source,xml]
----
include::src-files/xml/SEPA_Samples_DebitReturnNotification__WPG_uses_the_PTRID_to_find_an_initial_parent__debit__or_parent.xml[]
----
