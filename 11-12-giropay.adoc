...
online banking account with one of the __giropay __member banks. Upon
...
payment. __giropay __complements direct debit and credit card payments.
This payment method increases conversion and provides secure payment
processing to the merchant. __giropay __was created by a consortium
...
readybank and several PSD banks participate in the __giropay __scheme.
...
This table illustrates which payment mode __giropay__ belongs to. It
...
[#giropay_CommunicationFormats]
==== Communication Formats

This table illustrates how __giropay__ notifications are encoded and
...
|See
https://document-center.wirecard.com/display/PTD/giropay#giropay-get-url/debit[samples].

|_debit_ |Moves funds from the Account Holder to the merchant. Received
as payment notification. |See
https://document-center.wirecard.com/display/PTD/giropay#giropay-get-url/debit[samples].
|=======================================================================

[[giropay-ReferenceTransaction]]
Reference Transaction
~~~~~~~~~~~~~~~~~~~~~

For additional information regarding the referenced transaction
functionality, see here:
 https://document-center.wirecard.com/display/PTD/General+Platform+Features#GeneralPlatformFeatures-Cross-Payment-MethodsReferencing[Cross-Payment-Methods
Referencing]

[[giropay-TestCredentials]]
Test Credentials
----------------
...
[[giropay-AdditionalTestCredentialsongiropayEnvironment]]
...
The merchant sends a debit request to Wirecard and receives a response
...
receives a payment notification from Wirecard.
 ...
 +
image:attachments/786794/3704150.png[image,height=250]

1.  Consumer adds items to his/her shopping basket.
2.  Consumer selects _giropay_.
3.  The merchant sends a _get-url_ request to _Wirecard Payment
Gateway_.
4.  _Wirecard Payment Gateway_ processes and validates the
transaction._ +
_
5.  _Wirecard Payment Gateway_ forwards the request to _giropay._
6.  _giropay_ provides the URL of the consumer's online banking account
for payment verification.
7.  _Wirecard Payment Gateway_ processes the response._ +
_
8.  _Wirecard Payment Gateway_ redirects the consumer to the provided
online banking URL.
9.  Consumer verifies the payment within the personal online banking
system.
10. _giropay_ transfers funds from the consumer's bank account to the
merchant's bank account.
11. _giropay_ sends a payment notification to the _Wirecard Payment
Gateway_.
12. _Wirecard Payment Gateway_ processes the notification and sends the
payment _debit_ notification to the merchant.
13. The merchant receives the notification with the payment result.

It is also possible to
https://document-center.wirecard.com/display/PTD/SEPA+Credit+Transfer#SEPACreditTransfer-refund[refund]
...
the same as the ReST API Fields. Please refer
to: https://document-center.wirecard.com/display/PTD/Fields[ReST API
Fields] or the request example for the fields required in a
_https://document-center.wirecard.com/display/PTD/giropay#giropay-get-url/debit[debit]_ transaction. +
...
[[giropay-Samples:Requests,ResponsesandNotifications]]
Samples: Requests, Responses and Notifications
----------------------------------------------

[[giropay-get-url/debit]]
_get-url/debit_
~~~~~~~~~~~~~~~
...
*XML Debit Notification (Successful)*  Expand source
...
*NVP get-url Response (Successful)*  Expand source
...
*NVP get-url Request (Successful)*  Expand source
...
*NVP Debit Notification (Successful)*  Expand source
...
*NVP get-url Request (Failure)*  Expand source
...
*NVP get-url Response (Failure)*  Expand source
...
link:attachments/786794/1671674.png[Giropay.svg.png] (image/png) +
image:images/icons/bullet_blue.gif[image,width=8,height=8]
link:attachments/786794/3114529.png[Logo_Giropay.png] (image/png) +
image:images/icons/bullet_blue.gif[image,width=8,height=8]
link:attachments/786794/3114532.png[giropay_workflow_2.png]
(image/png) +
image:images/icons/bullet_blue.gif[image,width=8,height=8]
link:attachments/786794/3704151.png[20180509_Giropay_debit.png]
(image/png) +
image:images/icons/bullet_blue.gif[image,width=8,height=8]
link:attachments/786794/3704150.png[20180509_Giropay_debit.png]
(image/png) +
