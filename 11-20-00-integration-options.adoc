...
- <<API_PBBA_Integrate_BrandIntegrateAndroid_Map, Map _secureToken_ and _brn elements_ to the _{payment-gateway}_>>
...
====== Map _secureToken_ and _brn elements_ to the _{payment-gateway}_
...
- <<API_PBBA_Integrate_BrandIntegrateiOS_Map, Map _secureToken_ and _brn elements_ to the _{payment-gateway}_>>
...
----
include::samples/xml/API_PBBA_IntegrateBrandIntegrateWebMerchantButtonSetup_Example.xml[]
----
...
_{payment-gateway}_'s endpoint 
...
[source,xml,subs=attributes+]
----
include::samples/xml/API_PBBA_IntegrateBrandIntegrateWebTheNotifymethod_Example.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/API_PBBA_IntegrateBrandIntegrateWebTheNotifymethod_Example_4.xml[]
----
