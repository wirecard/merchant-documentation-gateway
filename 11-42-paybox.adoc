...
[source,xml]
----
include::src-files/xml/paybox_Samples_Authorization__authorization__Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/paybox_Samples_Authorization__authorization__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/paybox_Samples_Authorization__authorization__Response_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/paybox_Samples_CaptureAuthorization__authorization__Response_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/paybox_Samples_Purchase__purchase__Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/paybox_Samples_Purchase__purchase__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/paybox_Samples_RefundCapture__purchase__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/paybox_Samples_RefundPurchase__purchase__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/paybox_Samples_VoidAuthorization__purchase__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/paybox_Samples_VoidPurchase__purchase__Response_Successful.xml[]
----
