...
[source,xml]
----
include::src-files/xml/SafetyPay_Samples_debit_debit_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/SafetyPay_Samples_debit_debit_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/SafetyPay_Samples_debit_debit_Request_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/SafetyPay_Samples_debit_debit_Response_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/SafetyPay_Samples_refund_debit_Response_Failure.xml[]
----
