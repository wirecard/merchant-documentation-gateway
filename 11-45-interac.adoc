...
Interac is a Canadian payments solution brand with a portfolio encompassing electronic payments, direct payment services, contactless payments, e-transfers, online services and ABM services. 
Interac [Online] is a secure online payment solution that enables customers to execute payments using their online banking services.
