...
Interac is a Canadian payments solution brand with a portfolio encompassing electronic payments, direct payment services, contactless payments, e-transfers, online payments and ABM services. 
Interac (Online) is a secure online payment solution that enables consumers to make payments using their online banking services. In addition, sharing financial information online is not required.
Authentication of consumers is performed by financial institutions and the transaction is processed in real time. This allows you to attend to an order immediately after it is placed.
