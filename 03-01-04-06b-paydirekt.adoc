...
With _paydirect_ you can send <<PPv2_paydirekt_TransactionType_authorization, _authorization_>>, <<PPv2_paydirekt_TransactionType_debit, _debit_>> and <<PPv2_paydirekt_TransactionType_capture, _capture-authorization_>> transactions.
