...
[source,xml]
----
include::src-files/xml/API_AlipayCrossBorder_Samples_General_debit__debit__Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_AlipayCrossBorder_Samples_General_debit__debit__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_AlipayCrossBorder_Samples_General_refundDebit__debit__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_AlipayCrossBorder_Samples_autoDebit_authorizationOnly_Sign__debit__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_AlipayCrossBorder_Samples_autoDebit_debit_withPeriodic__debit__Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_AlipayCrossBorder_Samples_autoDebit_authorizationOnly_Unsign__debit__Request_Successful.xml[]
----
