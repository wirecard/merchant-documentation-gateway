...
[source,xml]
----
include::samples/xml/alipay-xborder_debit_request_success.xml[]
----
...
[source,xml]
----
include::samples/xml/alipay-xborder_debit_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/alipay-xborder_refund-debit_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/alipay-xborder_authorization-only_request_success.xml[]
----
...
[source,xml]
----
include::samples/xml/alipay-xborder_get-url_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/alipay-xborder_authorization-only_response_success.xml[]
----
