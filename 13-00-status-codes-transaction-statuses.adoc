...
| 400.1437 | error       | Invalid Installment Plan card used. | Invalid Installment Plan card used. The card used is not belong to the installment plan choose.
| 400.1438 | error       | Invalid Installment Plan. | Amount not eligible for Ipp transactions or invalid amount for selected tenure.
| 400.1439 | error       | Unsupport Transaction Type for IPP. | Unsupport Transaction Type for Installment Plan.
...
| <<StatusCodes_Test, 500.1060>> | error       | Denied Transaction Type | The acquirer returned Transaction Type not accepted. Please contact Merchant Support.
| <<StatusCodes_Test, 500.1061>> | error       | Card Type not Supported | The card type is not processed by the authorization center. Please contact Merchant Support.
...
| 500.1076 | error       | Consumer failed or Cancelled authentication. | The cardholder not only cancelled but even denied the payment process. No liability shift is granted and payment should not be processed as consumer expressed his explicit denial.
...
| <<StatusCodes_Test, 500.1094>> | error       | Merchant Account not configured. | The Merchant Account is not properly configured for processing. Please contact Merchant Support.
...
| <<StatusCodes_Test, 500.1099>> | error       | Transaction processing refused. | Transaction processing refused. Please contact Merchant Support.
...
| <<StatusCodes_Test, 500.1117>> | error       | Terminal ID Unknown | Terminal ID Unknown. Please contact Merchant Support.
