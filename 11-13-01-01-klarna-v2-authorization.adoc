...
If _{payment-method-name}_ accepts the order, it guarantees the payment once the authorization has been captured.

[#KlarnaV2_TransactionTypes_authorization_Workflow]
====== _authorization_/_pending-authorization_ Workflow

image::images/11-13-01-klarna-v2/klarnaV2_authorization_workflow.png[width=900]
