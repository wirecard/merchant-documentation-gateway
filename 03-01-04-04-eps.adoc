...
[source,json]
----
include::src-files/json/WPP_eps_TransactionType_debit_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_eps_JSONNVPFields_request_JSON_Structure_for__eps__Requests.json[]
----
