...
----
include::samples/json/WPP_EpsTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
3+|notification-url |String |Optional |256|The URL to which _{payment-gateway}_ sends the transaction outcome.
...
[source,json,subs=attributes+]
----
include::samples/json/WPP_EpsTransactionTypeDebit_2RtCttPPIDR.json[]
----
...
[source,json,subs=attributes+]
----
include::samples/json/WPP_EpsTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
3+|notification-url |String |The URL to which _{payment-gateway}_ sends
...
[source,json,subs=attributes+]
----
include::samples/json/WPP_EpsJSONNVPFieldsRequest_JSON_StructureForEpsRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::samples/json/WPP_EpsJSONNVPFieldsRequest_ResponseOnlyFields.json[]
----
