...
* <<appendixB_transactionTypesforAlternativePaymentMethods, Transaction
Types for Alternative Payment Methods>>
* <<appendixB_transactionTypesforCreditCard, Transaction
Types for Credit Card>>
* <<appendixB_transactionTypesMatrixforAlternativePaymentMethods, Transaction
Types Matrix for Alternative Payment Methods>>
...
cardholder authenticated the transaction within the 3-D Secure Program.
