...
Below, you find an example request for the ``debit`` transaction type,
...
image::images/03-01-04-03-bancontact/bancontact_logo.png[Bancontact Logo,height=150]
...
Bancontact payments, the transaction-type must be set to ``debit``.
