...
[source,json]
----
include::samples/json/WPP_BancontactTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json]
----
include::samples/json/WPP_BancontactTransactionTypeDebit_2RtcttPPIRU.json[]
----
...
[source,json]
----
include::samples/json/WPP_BancontactTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
