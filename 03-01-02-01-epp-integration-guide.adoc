...
[source,html,subs=attributes+]
----
<script type="text/javascript">{payment-page-function-short}.embeddedPayUrl("https://{payment-redirect-url-hostname}/?wPaymentToken=f0c0e5b3-23ad-4cb4-abca-ed80a0e770e7")</script>
----
