...
[source,json]
----
include::src-files/json/PaymentPageSolutions_WPP_EPP_Integration_Example_Create_Create_a_Payment_Session_Initial_Request.json[]
----
...
[source,json]
----
include::src-files/json/PaymentPageSolutions_WPP_EPP_Integration_Example_Embed_Response_to_Authorization_Request.json[]
----
...
[source,json]
----
include::src-files/json/PaymentPageSolutions_WPP_EPP_Integration_Example_Parse_Parse_and_Process_the_Payment_Response_Decoded_Payment_Response.json[]
----
