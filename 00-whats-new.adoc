...
.2019-12-12
- <<PPv2_PaymentMethods, Payment Methods with {payment-page-v2-abbr}>> - New payment methods available for {payment-page-v2-abbr}.
...
- <<API_CC_3DS2_PaymentFlows_MITUCOF_FirstAndUnscheduledMIT, 3D Secure 2 Payment Flows>> - Check-enrollment for UFOC transactions is now available for 3D Secure 2 transactions.
- <<PPv2_CC_3DS2Fields, Credit Card with {payment-page-v2-abbr}>> - New sample request for 3D Secure 2 transactions with {payment-page-v2-abbr}.
- <<GooglePay_MerchantEndToEndTesting, Google Pay>> - Updated Google Pay for REST API.
- <<API_WeChatQRPay_TransactionTypes, WeChat QR Pay>> - Updated transaction type void-debit for WeChat QR Pay with REST API.
