...
=== 2019-07
.2019-07-30
- <<PPv2_paydirekt, paydirekt with {payment-page-abbr}>> - New payment method available for {payment-page-v2}.

[#WhatsNew_2019_06]
[discrete]
=== 2019-06
.2019-06-28
- <<PPv2_paylib, Paylib with {payment-page-abbr}>> - New payment method available for {payment-page-v2}.
...
- <<WPP_CC_3DS2Fields, Credit Card with payment-page-abbr>> - Updated 3D Secure 2 fields.
...
- <<WPP_CC_3DS2Fields, Credit Card with payment-page-abbr>> - Added 3D Secure 2 fields table.
