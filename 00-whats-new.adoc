...
.2020-01-20
- <<PaymentPageSolutions_PPv2_PaymentPageDesigner, Payment Page Designer>> - Updated Payment Page Designer menu description for {payment-page-v2}.
- <<PPD_{payment-page-v2-anchor}-Manager, {payment-page-v2-abbr} design manager>> - Updated {payment-page-v2-abbr} design manager menu description.
