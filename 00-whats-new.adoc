...
- <<PPSolutions_PPv2_PPv2Security, {payment-page-v2-abbr} Security>> - Updated signature verification example (C#) for Wirecard
Payment Page v2.
- <<PP_RedirectUrlsIPNs, Redirect URLs and IPNs>> - Updated description for {payment-page-v1}.
...
- <<PPSolutions_PPv2_PPv2Security, {payment-page-v2-abbr} Security>> - Updated signature verification example (Java) for Wirecard
Payment Page v2.
