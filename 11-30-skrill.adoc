...
_{payment-gateway-abbr}_ receives it from the 3^rd^ party. Usually, this status is
...
Once _{payment-gateway-abbr}_ has received a _debit_ notification from the 3^rd^ party
...
|_transaction-id_                       | |M |M  |String   |36   |The Transaction ID is the unique identifier for a transaction. It is generated automatically.
...
----
include::samples/xml/skrill_get-url_request_success_de_DE.xml[]
----

.XML Get-Url Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/skrill_get-url_response_success_de_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/skrill_get-url_unknown__de_DE.xml[]
----

.XML Get-Url Response - Incorrect Wallet Account ID (Failure)
[source,xml,subs=attributes+]
----
include::samples/xml/skrill_get-url_response_failure_de_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/skrill_credit_request_success.xml[]
----

.XML Credit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/skrill_credit_response_success.xml[]
----
