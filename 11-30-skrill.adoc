...
[source,xml]
----
include::src-files/xml/SkrillDigitalWallet_Samples_geturl__The_merchant_redirects_the_consumer_to_the__Skrill_Digital_Wallet_.xml[]
----
...
[source,xml]
----
include::src-files/xml/SkrillDigitalWallet_Samples_geturlWalletAccountID__The_merchant_redirects_the_consumer_to_the__Skrill_Digital_Wallet_.xml[]
----
...
[source,xml]
----
include::src-files/xml/SkrillDigitalWallet_Samples_credit_Credit_Request_Successful.xml[]
----

.XML Credit Response (Successful)
[source,xml]
----
include::src-files/xml/SkrillDigitalWallet_Samples_credit_Credit_Response_Successful.xml[]
----
