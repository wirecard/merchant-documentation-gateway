...
[source,xml]
----
include::samples/xml/SkrillDigitalWalletSamplesGeturl_GetUrlRequestSuccessful.xml[]
----

.XML Get-Url Response (Successful)
[source,xml]
----
include::samples/xml/SkrillDigitalWalletSamplesGeturl_GetUrlResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SkrillDigitalWalletSamplesgeturlWalletAccountID_GURUaWAIF.xml[]
----

.XML Get-Url Response - Incorrect Wallet Account ID (Failure)
[source,xml]
----
include::samples/xml/SkrillDigitalWalletSamplesgeturlWalletAccountID_GetUrlResponseIncorrectWalletAccount_ID_Failure.xml[]
----
...
[source,xml]
----
include::samples/xml/SkrillDigitalWalletSamplesCredit_CreditRequestSuccessful.xml[]
----

.XML Credit Response (Successful)
[source,xml]
----
include::samples/xml/SkrillDigitalWalletSamplesCredit_CreditResponseSuccessful.xml[]
----
