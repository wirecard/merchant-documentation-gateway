...
[source,xml]
----
include::samples/xml/skrill_get-url_request_success.xml[]
----

.XML Get-Url Response (Successful)
[source,xml]
----
include::samples/xml/skrill_get-url_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/skrill_get-url_unknown_.xml[]
----

.XML Get-Url Response - Incorrect Wallet Account ID (Failure)
[source,xml]
----
include::samples/xml/skrill_get-url_response_failure.xml[]
----
