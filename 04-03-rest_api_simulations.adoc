...
table of <<ReturnCodes_Detail, valid transaction statuses>>.
...
See <<RestApi_Samples_CreditCardOnly_ReferencedTransaction, samples>>
for referenced transaction simulation.
