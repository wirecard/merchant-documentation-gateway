...
Note over Merchant,{payment-gateway-abbr}: Contains card data (card number, CVV, etc).
...
Note over Merchant,{payment-gateway-abbr}: check-enrollment response contains pareq.
{payment-gateway-abbr}->>Merchant: sends a check-enrollment response to merchant.
Note over Merchant,{payment-gateway-abbr}: Receiver is taken from acs-url.
...
Note over Merchant,{payment-gateway-abbr}: check-payer-response request contains pares.
Merchant->>{payment-gateway-abbr}: Sends check-payer-response request to {payment-gateway-abbr}.
Note over Merchant,{payment-gateway-abbr}: Response includes 3D Secure process information.
...
.. This response includes all the 3D Secure process information.
