...
Note over Merchant,{payment-gateway-abbr}: Contains card data.
...
Note over Merchant,{payment-gateway-abbr}: response contains pareq.
...
Note over Merchant,{payment-gateway-abbr}: request contains pares.
Merchant->>{payment-gateway-abbr}: Sends check-payer-response request to {payment-gateway-abbr}.
Note over Merchant,{payment-gateway-abbr}: response includes 3DS process info.
