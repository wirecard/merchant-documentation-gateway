...
* _Pay by Link_ at <<PP_PaymentSolutions_PaybyLink, {payment-page-v1}>> and <<WPP_Features_PaybyLink, {payment-page-v2}>>
* _Invoice via Email_ at <<PP_PaymentSolutions_InvoiceviaEmail, {payment-page-v1}>>
