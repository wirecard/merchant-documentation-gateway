...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Authorization_SendingData_AuthorizationUsingCardData_authorization_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Authorization_SendingData_AuthorizationUsingToken_authorization_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Authorization_SendingData_VoidAuthorization_Request_Header.xml[]
----
