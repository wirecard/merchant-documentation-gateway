...
[source,xml]
----
include::samples/xml/CreditCardTransactionTypesAuthorizationSendingDataAuthorizationUsingCardData_AuthorizationRequestSuccessful.xml[]
----
...
----
include::samples/xml/CreditCardTransactionTypesAuthorizationSendingDataAuthorizationUsingCardData_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/CreditCardTransactionTypesAuthorizationSendingDataAuthorizationUsingToken_AuthorizationRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/CreditCardTransactionTypesAuthorizationSendingDataAuthorizationUsingToken_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/CreditCardTransactionTypesAuthorizationSendingDataVoidAuthorization_VoidAuthorizationRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/CreditCardTransactionTypesAuthorizationSendingDataVoidAuthorization_VoidAuthorizationResponseSuccessful.xml[]
----