...
[cols=",,"]
|===
s|Locale s|Purchase Country +
(country of consumer's address) s|Purchase Currency
...
3+m|phone |String |Required |32 |Consumer's phone number. Phone numbers need to be validated. Click <<PPv2_Klarna_phoneNumberValidation, here>> for details.
...
3+|phone |String |Required |32 |The phone number of the recipient. Phone numbers need to be validated. Click <<PPv2_Klarna_phoneNumberValidation, here>> for details.
