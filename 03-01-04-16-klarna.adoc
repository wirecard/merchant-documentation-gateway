...
[source,json]
----
include::samples/json/WPP_KlarnaV2_AuthorizationRequest.json[]
----
...
[source,json]
----
https://wpp-test.wirecard.com/?wPaymentToken=nbuphpxyYFjdXwNY46kfeqa8Zt0ZWPkMmDTa0_wwP-4
----
...
[source,json]
----
include::samples/json/WPP_KlarnaV2_AuthorizationResponse.json[]
----
...
IMPORTANT: Check the REST API <<KlarnaV2, _{payment-method-name} Payments_ specification>> for details on _{payment-method-name}_-specific post-processing operations.
