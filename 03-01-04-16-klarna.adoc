...
4+|locale	|String |Required |5 |Consumer's locale according to RFC 1766.	E.g. ``en-us`` for US English, ``en-gb`` for British English and ``sv-se`` for Swedish (in Sweden).
