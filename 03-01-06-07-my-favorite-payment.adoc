[#WPP_Features_MyFavoritePayment]
===== My Favorite Payment
...
[.float-group]
--
image:images/03-01-06-07-my-favorite-payment/mfp1.jpg[My Favorite Payment, width=300]
image:images/03-01-06-07-my-favorite-payment/mfp2.jpg[My Favorite Payment (use different card), width=300]
--
