...
[source,xml]
----
include::src-files/xml/VISACheckout_Samples_RESTAPI_without_CallID_debit_Request.xml[]
----
...
[source,xml]
----
include::src-files/xml/VISACheckout_Samples_RESTAPI_without_CallID_debit_Response.xml[]
----
...
[source,xml]
----
include::src-files/xml/VISACheckout_Samples_RESTAPI_without_CallID_debit_Notification.xml[]
----
...
[source,xml]
----
include::src-files/xml/VISACheckout_Samples_RESTAPI_with_CallID_debit_Request.xml[]
----
...
[source,xml]
----
include::src-files/xml/VISACheckout_Samples_RESTAPI_with_CallID_debit_Response.xml[]
----
...
[source,xml]
----
include::src-files/xml/VISACheckout_Samples_RESTAPI_with_CallID_debit_Notification.xml[]
----
