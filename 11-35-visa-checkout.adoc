...
[source,xml]
----
include::samples/xml/VISACheckoutSamples_RESTAPI_WithoutCallID_DebitRequest.xml[]
----
...
[source,xml]
----
include::samples/xml/VISACheckoutSamples_RESTAPI_WithoutCallID_DebitResponse.xml[]
----
...
[source,xml]
----
include::samples/xml/VISACheckoutSamples_RESTAPI_WithoutCallID_DebitNotification.xml[]
----
...
[source,xml]
----
include::samples/xml/VISACheckoutSamples_RESTAPI_WithCallID_DebitRequest.xml[]
----
...
[source,xml]
----
include::samples/xml/VISACheckoutSamples_RESTAPI_WithCallID_DebitResponse.xml[]
----
...
[source,xml]
----
include::samples/xml/VISACheckoutSamples_RESTAPI_WithCallID_DebitNotification.xml[]
----
