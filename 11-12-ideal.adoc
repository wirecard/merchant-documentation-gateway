...
[source,xml]
----
include::src-files/xml/iDEAL_Samples___Wirecard_Payment_Gateway__processes_the_notification_and_sends_the.xml[]
----
...
[source,xml]
----
include::src-files/xml/iDEAL_Samples_Debit_Notification_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/iDEAL_Samples_Debit_Notification_Failure.xml[]
----
