...
captured.
|<<KlarnaV2_TransactionTypes_authorization_Fields, authorization fields>> +
<<KlarnaV2_TransactionTypes_authorization_Samples, authorization samples>>
...
|<<KlarnaV2_TransactionTypes_adjustAuthorization_Fields, adjust-authorization fields>> +
<<KlarnaV2_TransactionTypes_adjustAuthorization_Samples, adjust-authorization samples>>
...
|<<KlarnaV2_TransactionTypes_voidAuthorization_Fields, void-authorization fields>> +
<<KlarnaV2_TransactionTypes_voidAuthorization_Samples, void-authorization samples>>
...
|<<KlarnaV2_TransactionTypes_captureAuthorization_Fields, capture-authorization fields>> +
<<KlarnaV2_TransactionTypes_captureAuthorization_Samples, capture-authorization samples>>
...
|<<KlarnaV2_TransactionTypes_refundCapture_Fields, refund-capture fields>> +
<<KlarnaV2_TransactionTypes_refundCapture_Samples, refund-capture samples>>
