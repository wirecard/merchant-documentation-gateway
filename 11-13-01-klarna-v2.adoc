...
NOTE: _{payment-method-name}_ accepts only physical persons as consumers.
...
This table illustrates how __Klarna Pay Now__, __Klarna Pay Later__ and __Klarna Financing__
