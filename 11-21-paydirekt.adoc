...
| transaction-id                           |          | M        | M             |              | 36   | The Transaction ID is the unique identifier for a transaction. It is generated automatically.
...
page, _{payment-gateway-abbr}_ recalculates/updates the totalAmount in the shopping
cart.
...
----
include::samples/xml/paydirekt_authorization_request_success.xml[]
----

.XML Response Authorization (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_authorization_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_authorization_request_.xml[]
----

.XML Response Authorization (Failed)
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_authorization_response_.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_capture-authorization_request_success_784e748d.xml[]
----

.XML Response Capture-Authorization (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_capture-authorization_response_success_784e748d.xml[]
----

.XML Request Capture-Authorization (Failed)
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_capture-authorization_request__784e748d.xml[]
----

.XML Response Capture-Authorization (Failed)
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_capture-authorization_response__784e748d.xml[]
----

.XML Request Refund-Capture (Failed)
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_refund-capture_request__fb02f827.xml[]
----

.XML Response Refund-Capture (Failed)
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_refund-capture_response__fb02f827.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_debit_request_success.xml[]
----

.XML Response Debit (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_debit_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_debit_request_.xml[]
----

.XML Response Debit (Express Checkout)
[source,xml,subs=attributes+]
----
include::samples/xml/paydirekt_debit_response_.xml[]
----
