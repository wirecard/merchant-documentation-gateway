...
[source,xml]
----
include::src-files/xml/Trustly_Samples_RestApi_debit_debit_Request_Successful.xml[]
----

.XML debit Response (Successful)
[source,xml]
----
include::src-files/xml/Trustly_Samples_RestApi_debit_debit_Response_Successful.xml[]
----

.XML debit Request (Failed)
[source,xml]
----
include::src-files/xml/Trustly_Samples_RestApi_debit_debit_Request_Failed.xml[]
----

.XML debit Response (Failed)
[source,xml]
----
include::src-files/xml/Trustly_Samples_RestApi_debit_debit_Response_Failed.xml[]
----
...
[source,xml]
----
include::src-files/xml/Trustly_Samples_RestApi_refunddebit_debit_Response_Failed.xml[]
----
...
[source,xml]
----
include::src-files/xml/Trustly_Samples_RestApi_credit_credit_Request_Successful.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::src-files/xml/Trustly_Samples_RestApi_credit_credit_Response_Successful.xml[]
----
