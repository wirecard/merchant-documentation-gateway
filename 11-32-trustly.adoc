...
----
include::samples/xml/trustly_debit_request_success.xml[]
----

.XML debit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/trustly_debit_response_success.xml[]
----

.XML debit Request (Failed)
[source,xml,subs=attributes+]
----
include::samples/xml/trustly_debit_request_.xml[]
----

.XML debit Response (Failed)
[source,xml,subs=attributes+]
----
include::samples/xml/trustly_debit_response_.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/trustly_refund-debit_response_success_f62e46b7.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/trustly_credit_request_success.xml[]
----

.XML credit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/trustly_credit_response_success.xml[]
----
