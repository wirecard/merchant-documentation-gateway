...
[source,xml]
----
include::samples/xml/TrustlySamplesRestApiDebit_DebitRequestSuccessful.xml[]
----

.XML debit Response (Successful)
[source,xml]
----
include::samples/xml/TrustlySamplesRestApiDebit_DebitResponseSuccessful.xml[]
----

.XML debit Request (Failed)
[source,xml]
----
include::samples/xml/TrustlySamplesRestApiDebit_DebitRequestFailed.xml[]
----

.XML debit Response (Failed)
[source,xml]
----
include::samples/xml/TrustlySamplesRestApiDebit_DebitResponseFailed.xml[]
----
...
[source,xml]
----
include::samples/xml/TrustlySamplesRestApiRefunddebit_RefundDebitRequestSuccessful.xml[]
----

.XML refund-debit Response (Successful)
[source,xml]
----
include::samples/xml/TrustlySamplesRestApiRefunddebit_RefundDebitResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/TrustlySamplesRestApiCredit_CreditRequestSuccessful.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::samples/xml/TrustlySamplesRestApiCredit_CreditResponseSuccessful.xml[]
----
