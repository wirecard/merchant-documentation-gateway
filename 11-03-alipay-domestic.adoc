...
|_refund-debit_ | See <<API_AlipayDomestic_Samples_RefundDebit, samples>>
|===
...
. Merchant redirects consumer to _Alipay Domestic_.
...
[#API_AlipayDomestic_Samples_RefundDebit_Xml]
====== XML
