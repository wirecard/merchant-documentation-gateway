...
[source,xml]
----
include::samples/xml/alipay_debit_request_success.xml[]
----
...
[source,xml]
----
include::samples/xml/alipay_debit_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/alipay_debit_notification_success.xml[]
----
