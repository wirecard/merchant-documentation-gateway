...
[source,xml]
----
include::src-files/xml/API_AlipayDomestic_Samples_Debit_Xml_debit_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_AlipayDomestic_Samples_Debit_Xml_debit_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_AlipayDomestic_Samples_Debit_Xml_debit_Notification_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_AlipayDomestic_Samples_Debit_Xml_debit_Request_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_AlipayDomestic_Samples_Debit_Xml_debit_Response_Failure.xml[]
----
