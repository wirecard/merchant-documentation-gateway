...
[source, xml]
----
include::samples/xml/MOLPaySamplesDebit_DebitRequestSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/MOLPaySamplesDebit_DebitResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/MOLPaySamplesDebit_DebitRequestFailure.xml[]
----
...
[source, xml]
----
include::samples/xml/MOLPaySamplesDebit_DebitResponseFailure.xml[]
----
