...
[source,json]
----
include::samples/json/WPP_SofortTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json]
----
include::samples/json/WPP_SofortTransactionTypeDebit_2RtCttPPIRU.json[]
----
...
[source,json]
----
include::samples/json/WPP_SofortTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
WARNING: A direct refund through {payment-page-abbr} is not possible for _Sofort_ so you have to
