...
[source,json]
----
include::samples/json/WPP_Sofort_JSON_NVPFields_JSON_StructureForSofortRequests.json[]
----
...
[source,json]
----
include::samples/json/WPP_Sofort_JSON_NVPFieldsRequest_ResponseOnlyFields.json[]
----
