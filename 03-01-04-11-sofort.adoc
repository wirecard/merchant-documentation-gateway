...
[source,json]
----
include::src-files/json/WPP_Sofort_TransactionType_debit_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_Sofort_JSON_NVPFields_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_Sofort_JSON_NVPFields_Request_Optional_fields.json[]
----
