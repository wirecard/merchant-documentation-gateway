...
image::images/11-02-credit-card/Credit-Card-Icons-600px.jpg[Credit Card Icons, 220, align="right"]
...
image::images/11-02-credit-card/CreditCard-referenced-purchase.png[Credit Card referenced purchase]
