...
Merchant ID and a CSR file. <<ContactUs, Merchant Support>> will generate an Apple
...
. Add a live card to the Wallet app and switch the _{payment-gateway}_ instance to production mode (do not forget to
...
Just as well, you may ask <<ContactUs, Merchant Support>> to generate an Apple Merchant ID for you, see
...
with a Certificate Signing Request (csr-file). This csr-file is generated by <<ContactUs, Merchant Support>>, see
...
----
include::samples/xml/apple-pay_creditcard_authorization_request_success.xml[]
----
...
[source, xml,subs=attributes+]
----
include::samples/xml/apple-pay_creditcard_authorization_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/ApplePaySamplesReferencedAuthorization_ReferencedAuthorizationRequestSuccessful.xml[]
----
...
[source, xml,subs=attributes+]
----
include::samples/xml/apple-pay_creditcard_referenced-authorization_response_success_recurring_126cf4e3.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/ApplePaySamplesCaptureAuthorization_CaptureAuthorizationRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/apple-pay_creditcard_capture-authorization_response_success_2f0a5103.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/apple-pay_generic_purchase_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/apple-pay_creditcard_purchase_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/ApplePaySamplesReferencedPurchase_ReferencedPurchaseRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/apple-pay_creditcard_referenced-purchase_response_success_recurring_e835c6e2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/ApplePaySamplesRefund_RefundCaptureRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/apple-pay_creditcard_refund-capture_response_success_407288d0.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/ApplePaySamplesVoid_VoidAuthorizationRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/apple-pay_creditcard_void-authorization_response_success_dd9e64b7.xml[]
----
