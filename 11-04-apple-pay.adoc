...
|===
s|Transaction Type +
(WPG <<ApplePay_TransactionTypes_Footnote, ^(*)^>>)
s|Transaction Type +
(Apple Pay) 
s|Link to the sample
...
[source, xml]
----
include::samples/xml/ApplePaySamplesAuthorization_AuthorizationRequestSuccessful.xml[]
----
...
----
include::samples/xml/ApplePaySamplesAuthorization_AuthorizationResponseSuccessful.xml[]
----
...
[source, xml,subs=attributes+]
----
include::samples/xml/ApplePaySamplesReferencedAuthorization_ReferencedAuthorizationResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/ApplePaySamplesCaptureAuthorization_CaptureAuthorizationResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/ApplePaySamplesPurchase_PurchaseRequestSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/ApplePaySamplesPurchase_PurchaseResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/ApplePaySamplesReferencedPurchase_ReferencedPurchaseResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/ApplePaySamplesRefund_RefundCaptureResponseSuccessful.xml[]
----
...
[source, xml]
----
include::samples/xml/ApplePaySamplesVoid_VoidAuthorizationResponseSuccessful.xml[]
----
