[#ApplePay]
=== Apple Pay
image::images/11-41-apple-pay/ApplePay_Logo.png[Apple Pay Logo, width=200, float="right", align="right"]
...
==== Before You Can Use Your Test Account
...
image::images/11-41-apple-pay/ApplePay_MAID_Workflow_AppleAccount_yes.png[Existing Apple Merchant Account]
|[#ApplePay_Workflow_NoAppleMerchantAccount]
.Apple Merchant Account does not exist
image::images/11-41-apple-pay/ApplePay_MAID_Workflow_AppleAccount_no.png[No existing Apple Merchant Account]
|===

[#ApplePay_Workflow]
==== Workflow

image::images/11-41-apple-pay/ApplePay_Workflow_short.png[Apple Pay Payment Flow, width=950]
