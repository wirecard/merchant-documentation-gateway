[#PPSolutions_WPP_ConfigureRedirects]
==== Redirects and IPNs
...
[source,json]
----
include::src-files/json/WPP_ConfiguringRedirectsIPNs_RedirectPages_Recap___The_third_level_is_defined_in_merchant_configuration_database.json[]
----
...
[source,json]
----
include::src-files/json/WPP_ConfiguringRedirectsIPNs_IPNs_Example_of_IPN_configuration_in_a_payment_request_JSON.json[]
----
