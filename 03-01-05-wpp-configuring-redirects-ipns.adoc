...
In this specific situation, _{payment-gateway}_ returns a
...
----
include::samples/json/WPP_ConfiguringRedirectsIPNsRedirectPagesRecap_Ttlidimcd.json[]
----
...
[source,json,subs=attributes+]
----
include::samples/json/WPP_ConfiguringRedirectsIPNsIPNs_ExampleOf_IPN_ConfigurationInAPaymentRequest_JSON.json[]
----
