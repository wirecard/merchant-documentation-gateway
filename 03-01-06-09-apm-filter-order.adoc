...
The _Sort or Filter_ option requires either an <<PaymentPageSolutions_PPv2_HPP_Integration, HPP>> integration or an <<PaymentPageSolutions_PPv2_EPP_Integration, EPP>> integration.
