...
====
Add the ``payment-method-order-and-filter`` field to the payment request and list the paymenent methods. +
...
If you want to send a request with the _Sort or Filter_ option you can use the test credentials and samples we provide for <<PPv2_CC_TestCredentials, _Credit Card_>>.
