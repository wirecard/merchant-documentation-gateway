...
The _Sort or Filter_ option requires either a <<PaymentPageSolutions_PPv2_HPP_Integration, HPP>> integration or  an <<PaymentPageSolutions_PPv2_EPP_Integration, EPP>> integration.
...
| payment-method-order-and-filter | Array | options (\{ }) | Displays the available payment methods in the {payment-page-v2-abbr} in the order specified in this field.
|===
