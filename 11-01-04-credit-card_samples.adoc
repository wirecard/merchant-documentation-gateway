...
[source,xml]
----
include::samples/xml/creditcard_preauthorization_request_success.xml[]
----

.XML Preauthorization Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_preauthorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/creditcard_tokenize_request_success.xml[]
----

.XML Tokenize Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_tokenize_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/creditcard_detokenize_request_success.xml[]
----

.XML Detokenize Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_detokenize_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_authorization-only_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_authorization-supplementary_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_referenced-authorization_response_success.xml[]
----

.XML Referenced-Authorization Notification (Successful)
[source,xml]
----
include::samples/xml/creditcard_referenced-authorization_notification_success.xml[]
----
...
[source,xml]
----
include::samples/xml/creditcard_credit_request_success.xml[]
----

.XML Credit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_credit_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/creditcard_original-credit_request_success.xml[]
----

.XML Original Credit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_original-credit_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_void-auth-supplementary_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_void-credit_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_void-original-credit_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_void-preauthorization_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_void-refund-capture_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/CreditCardSamplesCheckEnrollment_CheckEnrollmentResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/CreditCardSamplesCheckEnrollment3DS2_XML_CheckEnrollment_RequestSuccess.xml[]
----

.XML Check Enrollment Response (Successful)
[source,xml]
----
include::samples/xml/CreditCardSamplesCheckEnrollment3DS2_XML_CheckEnrollment_ResponseSuccess.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/CreditCardSamplesPaymentFacilitatorTransactions_XML_CheckEnrollmentResponseSuccessful.xml[]
----
