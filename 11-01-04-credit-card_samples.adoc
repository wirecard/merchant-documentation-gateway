...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_authorization-only_request_success_05659f.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_referenced-authorization_response_success_recurring.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_check-enrollment_request_success.xml[]
----

.XML Check Enrollment Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_check-enrollment_response_success.xml[]
----
