...
<<CreditCard_TransactionTypes_Purchase_SendingData_VoidPurchse, _void-purchase_ samples>>
...
[#CreditCard_Samples_CheckEnrollment_XML]
====== XML
...
[#CreditCard_Samples_CheckPayerResponse_XML]
====== XML
...
[#CreditCard_Samples_PaymentRequestPARes_XML]
====== XML
...
[#CreditCard_Samples_PaymentRequest3rdPartyMPI_XML]
====== XML
