...
ifdef::env-wirecard[]
The complete payment process for credit card payments and many other payment methods
can be added to your shop system.
endif::[]

ifndef::env-wirecard[]
The complete payment process for credit card payments can be added to your shop system.
endif::[]
...
If you would like to implement a tight integration of the {payment-gateway} into your online shop, please have a look on our 
