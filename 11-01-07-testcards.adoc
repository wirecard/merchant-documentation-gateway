...
|===
2+| If you want to provoke... 3+| ...Use these card data in the request... 4+|...to obtain this result
...
[#API_CC_TestCards_3D_Error_Diners-14]
.Diners-14
[cols="10,10,10,5,5,10,10,10,10"]
|===
2+| If you want to provoke... 3+| ...Use these card data in the request... 4+|...to obtain this result
| Status Code | Status Name | Card Number | CVV | Card Type | Enrollment Result | Authentication Result | Password ACS | Personal Message ACS
| 500.1072 | Card Not Enrolled | 36259600010052 | 052 .6+| ``?`` | N | -- | -- | --
| 500.1073  | Unable to Verify Enrolment | 36259600010060 | 060 | U | -- | -- | --
| 500.1074 | MPI Error | 36259600010078 | 078 | E | -- | -- | --
| 500.1076 | Consumer failed or Cancelled authentication. | 36259600010029 | 029 | Y | N | wirecard | Testing "Authentication failed"
| 500.1077 | Authentication could not be completed due to technical or other problem. | 36259600010037 | 039 | Y | U | wirecard | Testing "Unable to authenticate"
| 500.1085 | A system error prevented completion of authentication. | 36259600010045 | 045 | Y | E | wirecard | Testing "Authentication failed due to system error"
|===
...
2+| If you want to provoke... 3+| ...Use these card data in the request... 4+|...to obtain this result
| Status Code | Status Name | Card Number | CVV | Card Type | Enrollment Result | Authentication Result | Password ACS | Personal Message ACS
| 500.1072 | Card Not Enrolled | 3800010001000152 | 152 .6+| ``?`` | N | -- | -- | --
...
[#API_CC_TestCards_3D_Error_JCB-19]
.JCB-19
[cols="10,10,10,5,5,10,10,10,10"]
|===
2+| If you want to provoke... 3+| ...Use these card data in the request... 4+|...to obtain this result
| Status Code | Status Name | Card Number | CVV | Card Type | Enrollment Result | Authentication Result | Password ACS | Personal Message ACS
| 500.1072 | Card Not Enrolled | 3572000100000010051 | 051 .6+| ``?`` | N | -- | -- | --
| 500.1073  | Unable to Verify Enrolment | 3572000100000010069 | 069 | U | -- | -- | --
| 500.1074 | MPI Error | 3572000100000010077 | 077 | E | -- | -- | --
| 500.1076 | Consumer failed or Cancelled authentication. | 3572000100000010028 | 028 | Y | N | wirecard | Testing "Authentication failed"
| 500.1077 | Authentication could not be completed due to technical or other problem. | 3572000100000010036 | 036 | Y | U | wirecard | Testing "Unable to authenticate"
| 500.1085 | A system error prevented completion of authentication. | 3572000100000010044 | 044 | Y | E | wirecard | Testing "Authentication failed due to system error"
|===
...
2+| If you want to provoke... 3+| ...Use these card data in the request... 4+|...to obtain this result
| Status Code | Status Name | Card Number | CVV | Card Type | Enrollment Result | Authentication Result | Password ACS | Personal Message ACS
| 500.1072 | Card Not Enrolled | 6222821234560019 | 150 .5+| ``?`` | N | -- | -- | --
