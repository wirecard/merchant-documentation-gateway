...
[source,xml]
----
include::src-files/xml/CarrierBilling_Samples_Debit_Request_Successful.xml[]
----

.Debit Response (Successful)
[source,xml]
----
include::src-files/xml/CarrierBilling_Samples_Debit_Response_Successful.xml[]
----

.Debit Request (Failure)
[source,xml]
----
include::src-files/xml/CarrierBilling_Samples_Debit_Request_Failure.xml[]
----

.Debit Response (Failure)
[source,xml]
----
include::src-files/xml/CarrierBilling_Samples_Debit_Response_Failure.xml[]
----
