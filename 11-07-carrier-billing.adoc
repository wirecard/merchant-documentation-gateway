...
[source,xml]
----
include::samples/xml/CarrierBillingSamples_DebitRequestSuccessful.xml[]
----

.Debit Response (Successful)
[source,xml]
----
include::samples/xml/CarrierBillingSamples_DebitResponseSuccessful.xml[]
----

.Debit Request (Failure)
[source,xml]
----
include::samples/xml/CarrierBillingSamples_DebitRequestFailure.xml[]
----

.Debit Response (Failure)
[source,xml]
----
include::samples/xml/CarrierBillingSamples_DebitResponseFailure.xml[]
----
