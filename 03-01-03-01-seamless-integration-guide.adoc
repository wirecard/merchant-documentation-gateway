...
[source,json,subs=attributes+]
----
include::samples/json/PaydooPPv2_SeamlessIntegrationExampleInitialRequest_CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaydooPPv2_SeamlessIntegrationExampleParse_3DS_DecodedPaymentResponse.json[]
----
endif::[]
