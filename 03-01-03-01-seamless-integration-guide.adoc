...
This is an example of a credit card 3-D Secure transaction to show how to process a payment with the {payment-page-v2} in Seamless Mode.
...
----
{
    "payment-redirect-url": "https://{payment-redirect-url-hostname}/seamless?wPaymentToken=XUcGTdnxwwCWPEP-YOeDmT05_hg1bKbaibLTpcdR8cU"
}
----
