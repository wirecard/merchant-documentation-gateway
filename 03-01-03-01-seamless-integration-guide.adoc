...
<<PaymentPageSolutions_WPP_HPP_Integration, HPP>> and <<PPSolutions_WPP_EPP_Integration, EPP>> payment processing workflow:
...
way as those for <<PPSolutions_WPP_HPP_Integration, HPP>> and <<PaymentPageSolutions_WPP_EPP_Integration, EPP>>
integrations.
