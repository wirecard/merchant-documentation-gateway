...
status. +
*Please consult <<PPSolutions_PPv2_PPv2Security, WPP Security>> for details and examples of response signature verification.*
...
payment, please consult *<<PPSolutions_PPv2_PPv2Security, WPP Security>> for details.*
