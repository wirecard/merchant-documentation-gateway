...
<<PaymentPageSolutions_WPP_HPP_Integration, HPP>> and <<PPSolutions_WPP_EPP_EPPintegration, EPP>> payment processing workflow:
...
To create a payment session with Credit Card using 3-D Secure 2 authentication, you need to include <<CreditCard_3DS2_Fields, 3-D Secure 2 fields in your initial request>>. + 
...
way as those for <<PPSolutions_WPP_HPP_HPPintegration, HPP>> and <<PaymentPageSolutions_WPP_EPP_Integration, EPP>>
integrations.
