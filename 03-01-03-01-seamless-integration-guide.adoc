...
To create a payment session with Credit Card using 3-D Secure 2 authentication, you need to include <<PPv2_CC_3DS2Fields, 3D Secure 2 fields in your initial request>>. +
...
For 3-D Secure transactions, {payment-page-v2-abbr} in Seamless Mode automatically
