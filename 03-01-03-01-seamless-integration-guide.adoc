...
This is an example of a credit card 3D Secure transaction to show how to process a payment with the Wirecard Payment Page in Seamless Mode.
...
[source,json]
----
include::src-files/json/WPP_Seamless_Integration_Example_InitialRequest_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_Seamless_Integration_Example_InitialRequest_Create_a_Payment_Session_Initial_Request.json[]
----
...
[source,json]
----
include::src-files/json/WPP_Seamless_Integration_Example_Render_Response_to_Authorization_Request.json[]
----
...
For 3D Secure transactions, WPP in Seamless Mode automatically
...
[source,json]
----
include::src-files/json/WPP_Seamless_Integration_Example_Parse_Response_to_Authorization_Request.json[]
----
...
[source,json]
----
include::src-files/json/WPP_Seamless_Integration_Example_Parse_3DS_Decoded_Payment_Response.json[]
----
...
.2+|_three-d_ e|cardholder-authentication-status |String  |Result of the 3D Secure check.
            e|attempt-three-d                  |Boolean |Indicates whether the transaction should use the 3D Secure workflow.
