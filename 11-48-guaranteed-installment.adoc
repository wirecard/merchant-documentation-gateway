...
|String
|256 ?????
|Wirecard Bank creditor identifier, provided by Wirecard Support. QUESTION: When is it mandatory????? Is this a response field?
...
When is it mandatory????? Is this a response filed?

4+a|
[[GuaranteedInstallment_Fields_Custom]] 
[discrete]
===== payment.custom-fields.
| *Mandatory for _authorization_*.
