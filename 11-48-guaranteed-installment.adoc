...
//What MAID do I need for Installment Configurator?
...
4+a|*installment-configuration-response.configuration.*
...
//I don't understand this description above...
...
|number-of-rates|Number|Size ?????|Number of months to cover the duration of the installment plan.
...
|payment-first-day|Number|Size ?????|Calendar day of the first payment.
