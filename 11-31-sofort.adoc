...
[cols="20,20,60"]
|===
.2+| *Requests/Responses* | Format | Please contact <<ContactUs, Merchant Support>> for Format.
...
----
include::samples/xml/sofortbanking_get-url_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sofortbanking_get-url_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sofortbanking_get-url_request_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/sofortbanking_get-url_response_failure.xml[]
----
