...
[source,json]
----
include::src-files/json/WPP_AlipayCrossborder_TransactionType_debit_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_AlipayCrossborder_JSON_NVPField_Optional_fields.json[]
----
