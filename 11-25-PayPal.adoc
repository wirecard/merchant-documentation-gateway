...
[#API_PayPal_Express]
==== __PayPal__ Express Checkout

__PayPal__ Express Checkout is a service
...
image:images/graphics/Paypal Workflow_debit.png[debit Workflow,height=100]
...
image:images/graphics/Paypal Workflow_refund debit.png[refund-debit Workflow,height=100]
...
image:images/graphics/Paypal Workflow_credit.png[credit workflow,height=250]
...
image:images/graphics/Paypal Workflow_AuthorizationCapture.png[authorization and capture-authorization workflow,height=100]
...
image:images/graphics/Paypal Workflow_OrderAuthorizationCapture.png[order, authorization and capture-authorization workflow,height=250]
  
...
request or in merchant account configuration. +
...
====== *statuses.status*
|statuses.status.code||M|M|String|12|This is the code of the status of a transaction. It can be any of link:#StatusCodesTransactionStatus[those].
...
1.  Navigate to “Account settings” → “My selling tools” → “API Access”
and select the link “Grant API permission”.

image:attachments/786583/3114181.jpg[image,height=250]

{empty}2. In the textfield “Third Party Permission Username”  enter
_http://payments_api1.wirecard.com[payments_api1.wirecard.com]_ and
click the “Lookup” button.

image:attachments/786583/3114182.jpg[image,height=250]

{empty}3. Select from the list of “Available Permissions” the following
items:
...
image:attachments/786583/3114183.gif[image,height=250]

{empty}4. Check that the permissions were added successfully.

image:attachments/786583/3114184.jpg[image,height=250]

{empty}5. Finally, the merchant’s _PayPal_ registration e-mail address
must be communicated to Wirecard to submit payments.

Confirm by clicking the “Add new Third Party” button.

[[PayPal-IPNConfigurationforWirecard]]
...
image:attachments/786583/3114185.png[image,height=250]

{empty}2. Switch to section *My Selling tools*, find *Instant payment
notification* and click “*Update*” on right side in the corresponding
row

image:attachments/786583/3114186.png[image,height=250]

{empty}3. Click *Edit settings*

*image:attachments/786583/3704855.png[image,height=250] +
*

{empty}4. *Set Notification URL
(https://api.wirecard.com/engine/notification/paypalipn) to Wirecard
server as shown on image below.*

*image:attachments/786583/3704856.png[image,height=250] +
*
...
https://document-center.wirecard.com/display/PTD/Preamble#Preamble-CONTACTINFORMATION[Wirecard's
Merchant Support].
...
[[PayPal-CrossMerchantAccountReferences]]
...
This merchant configuration parameter affects all transaction types.
...
[#API_PayPal_Features_ProviderTransactionID]
...
[[PayPal-SellerProtection&RecurringPayments]]
...
For recurring payments __Wirecard Payment Gateway__ uses the shipping
address which has been received from _PayPal_ during the initial
request.

[[PayPal-Cancelhandling]]
Cancel handling
~~~~~~~~~~~~~~~
...
has cancelation enabled, failed transaction with status 500.1108,
'Transaction was cancelled/aborted. Please try again later.' is created.

image:attachments/786583/3703713.png[image,height=250]
