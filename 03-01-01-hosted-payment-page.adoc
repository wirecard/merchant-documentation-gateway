...
- <<WPP_Features_PaybyLink, Expiration times>> for HPP payment hyperlinks
- PCI DSS SAQ A
...
HPP also allows you to configure <<WPP_Features_PaybyLink, expiration times>> for payment hyperlinks:
