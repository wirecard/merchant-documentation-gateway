...
- Klarna sends an invoice to your consumer.
- Klarna sends payment instructions to your consumer according to the
...
If Klarna provides payment instructions, you are responsible to send the invoice to your consumer. The payment instructions show the Klarna bank account requisites, where the payment should be provided to.
...
Klarna pays the order amount to you according to the agreed billing period.
