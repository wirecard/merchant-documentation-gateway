...
- _Klarna_ sends an invoice to your consumer.
- _Klarna_ sends payment instructions to your consumer according to the
...
If _Klarna_ provides payment instructions, you are responsible to send the invoice to your consumer. The payment instructions show the _Klarna_ bank account requisites, where the payment should be provided to.
...
_Klarna_ pays the order amount to you according to the agreed billing period.
...
image::images/11-13-01-klarna-v2/klarnaV2_captureAuthorization_workflow.png[width=700]
