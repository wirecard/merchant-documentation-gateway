...
[source,xml]
----
include::samples/xml/maybank2u_debit_request_success.xml[]
----

.XML Debit Response (Successful)
[source,xml]
----
include::samples/xml/maybank2u_debit_response_success.xml[]
----

.XML Debit Notification (Successful)
[source,xml]
----
include::samples/xml/maybank2u_debit_notification_success.xml[]
----
...
[source,xml]
----
include::samples/xml/maybank2u_debit_notification_failure.xml[]
----
...
[source,xml]
----
include::samples/xml/maybank2u_debit_response_.xml[]
----
