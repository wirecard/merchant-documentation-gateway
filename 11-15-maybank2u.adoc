...
[source,xml]
----
include::samples/xml/Maybank2uSamplesDebit_DebitRequestSuccessful.xml[]
----

.XML Debit Response (Successful)
[source,xml]
----
include::samples/xml/Maybank2uSamplesDebit_DebitResponseSuccessful.xml[]
----

.XML Debit Notification (Successful)
[source,xml]
----
include::samples/xml/Maybank2uSamplesDebit_DebitNotificationSuccessful.xml[]
----

.XML Debit Request (Failure)
[source,xml]
----
include::samples/xml/Maybank2uSamplesDebit_DebitRequestFailure.xml[]
----

.XML Debit Response (Failure)
[source,xml]
----
include::samples/xml/Maybank2uSamplesDebit_DebitResponseFailure.xml[]
----

.XML Debit Notification (Failure)
[source,xml]
----
include::samples/xml/Maybank2uSamplesDebit_DebitNotificationFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/Maybank2uSamplesqueryWorkflow_GetUrlRequestBody.xml[]
----
+
...
[source,xml]
----
include::samples/xml/Maybank2uSamplesqueryWorkflow_GetUrlResponseBody.xml[]
----
+
...
[source,xml]
----
include::samples/xml/Maybank2uSamplesqueryWorkflow_WPG_RequestBody.xml[]
----
+
.Maybank2u Webservice Response to WPG
[source,xml]
----
include::samples/xml/Maybank2uSamplesqueryWorkflow_Maybank2uWebserviceResponseTo_WPG.xml[]
----
+
...
[source,xml]
----
include::samples/xml/Maybank2uSamplesqueryWorkflow_WPG_ResponseToMerchant'sServerBody.xml[]
----
