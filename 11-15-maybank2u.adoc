...
[source,xml]
----
include::src-files/xml/Maybank2u_Samples_debit_Debit_Request_Successful.xml[]
----

.XML Debit Response (Successful)
[source,xml]
----
include::src-files/xml/Maybank2u_Samples_debit_Debit_Response_Successful.xml[]
----

.XML Debit Notification (Successful)
[source,xml]
----
include::src-files/xml/Maybank2u_Samples_debit_Debit_Notification_Successful.xml[]
----

.XML Debit Request (Failure)
[source,xml]
----
include::src-files/xml/Maybank2u_Samples_debit_Debit_Request_Failure.xml[]
----

.XML Debit Response (Failure)
[source,xml]
----
include::src-files/xml/Maybank2u_Samples_debit_Debit_Response_Failure.xml[]
----

.XML Debit Notification (Failure)
[source,xml]
----
include::src-files/xml/Maybank2u_Samples_debit_Debit_Notification_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/Maybank2u_Samples_queryWorkflow_Workflow_to_get_Transaction_Status_without_Notification.xml[]
----
+
...
[source,xml]
----
include::src-files/xml/Maybank2u_Samples_queryWorkflow_WPG_Request_Body.xml[]
----
+
.Maybank2u Webservice Response to WPG
[source,xml]
----
include::src-files/xml/Maybank2u_Samples_queryWorkflow_Maybank2u_Webservice_Response_to_WPG.xml[]
----
+
