...
image::images/11-38-google-pay/GooglePay_logo.png[Google Pay Logo, width=200, float="right", align="right"]
...
[%autowidth]
|===
|Transaction Type (WPG <<GooglePay_TransactionTypes_RequestFootnote, ^(*)^>>) |Transaction Type (Google Pay)
...
to https://developers.google.com/pay/api/android/guides/setup & https://developers.google.com/pay/api/android/guides/tutorial for
in-app integration
and https://developers.google.com/pay/api/android/guides/setup[ https://developers.google.com/pay/api/web/guides/setup] & https://developers.google.com/pay/api/android/guides/tutorial[https://developers.google.com/pay/api/web/guides/tutorial] 
for web integration)
...
image::images/11-38-google-pay/GooglePay_Workflow.png[Google Pay Workflow, width=950]
