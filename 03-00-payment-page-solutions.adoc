...
ifdef::env-wirecard[]
<<PP, image:images/03-payment-page-solutions/ppv2.jpg[{payment-provider-name} Payment Page, title="Click here to read more"]>>
endif::[]
...
image::images/03-payment-page-solutions/ppv2.jpg[{payment-provider-name} Payment Page, float="none", align="center", link="WPP"]
