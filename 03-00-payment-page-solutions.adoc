...
ifdef::env-wirecard[]
<<{payment-page-v2-abbr}, image:images/03-payment-page-solutions/WPP.jpg[Wirecard Payment Page, title="Click here to read more"]>>
endif::[]
...
payment methods is important for your business, {payment-page-v1} is a great fit. 

ifdef::env-wirecard[]
<<{payment-page-v1-abbr}, image:images/03-payment-page-solutions/Old_PP.jpg[Payment Page, title="Click here to read more"]>>
endif::[]
|===
