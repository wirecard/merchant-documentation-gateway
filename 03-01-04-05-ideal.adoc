...
[source,json]
----
include::src-files/json/WPP_ideal_TransactionType_debit_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_ideal_JSONNVPField_request_JSON_Structure_for__iDEAL__Requests.json[]
----
...
[source,json]
----
include::src-files/json/WPP_ideal_JSONNVPField_response_JSON_Structure_for__iDEAL__Requests.json[]
----
