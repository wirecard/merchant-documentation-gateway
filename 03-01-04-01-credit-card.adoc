...
[source,json]
----
include::src-files/json/WPP_CC_TransactionType_purchase_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_CC_TransactionType_authorization_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_CC_TransactionType_authorization__authorization__Response.json[]
----
...
[source,json]
----
include::src-files/json/WPP_CC_TransactionType_authorizationonly_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_CC_3DSecure_TestCredentials_Additional_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_CC_JSONNVPField_JSON_Structure_for__Credit_Card__Requests.json[]
----
...
[source,json]
----
include::src-files/json/WPP_CC_JSONNVPField_Responseonly_JSON_Structure_for__Credit_Card__Requests.json[]
----
