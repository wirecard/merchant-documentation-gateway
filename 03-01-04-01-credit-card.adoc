...
|Optional                      
|      
|Registration date of the consumer's account in the merchant's shop. Accepted format: YYYYMMDD. For guest checkout, do not send this field.
...
|Date that the consumer last made changes to their account in the merchant's shop. For example, 
 changes to billing and shipping address, new payment account, new email address. Accepted format: YYYYMMDD. For guest checkout, do not send this field. 
...
|3
|Country of the consumer's billing address. Format: numeric ISO 3166-1 standard.
...
|Conditional                   
|3  
|State/province of the consumer's billing address. Format: numeric ISO 3166-2 standard.
...
|Conditional                 
|3
|Country of the consumer's shipping address. Format: numeric ISO 3166-1 standard. Must be sent even if billing country is identical.
...
|Conditional                   
|3  
|State/province of the consumer's shipping address. Format: numeric ISO 3166-2 standard. Must be sent even if billing address is identical.
