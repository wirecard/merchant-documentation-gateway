...
|Conditional                      
|      
|Type of consumer login to the merchant's shop. +
...
|Conditional                      
|      
|Date and time of the consumer login to the merchant's shop. Accepted format: YYYYMMDDHHMM. For guest checkout, the datetime is now.
...
|Optional                      
|      
|Registration date of the consumer's account in merchant's shop. For guest checkout, do not send this field.
                                   
2+|account-update-date        
| Date              
| Optional                      
|      
|Date that the consumer last made changes to their account in the merchant's shop. For example, changes to billing and shipping address, new payment account, new email address. For guest checkout, do not send this field. 
...
| Conditional                   
| 50   
| Third line of the street address or equivalent local portion of the cardholder's billing address associated with the card use for this purchase. +
...
| Optional                      
|      
| Indicates shipping method chosen for the transaction. Merchants must choose the Shipping Indicator code that most accurately describes the cardholder's specific transaction. +
