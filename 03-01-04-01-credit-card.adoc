...
|Type of consumer login in the merchant's shop. +
 ...
 01 = Guest checkout (i.e. the consumer is “logged in” as guest). +
...
|Conditional                      
|12      
|Date and time of the consumer login in the merchant's shop. Accepted format: YYYYMMDDHHMM. For guest checkout, the datetime is now.
                                  
2+|challenge-indicator      
|String              
|Optional ??? Isn't this conditional if it is mandatory for a first transaction?                
|      
|Indicates whether a challenge is requested for this transaction. +
 Possible values: 01, 02, 03, 04 +
 01 = No preference. (This is the default setting if not otherwise specified.) +
...
|Optional                      
|      
|Registration date of the consumer's account in the merchant's shop. Accepted format: YYYYMMDDMM. For guest checkout, do not send this field.
...
|Date that the consumer last made changes to their account in the merchant's shop. For example, 
 changes to billing and shipping address, new payment account, new email address. Accepted format: YYYYMMDDMM. For guest checkout, do not send this field. 
                                   
2+|password-change-date       
|Date              
|Optional                      
|      
|Date that the consumer last changed/reset their password in the merchant's shop. Accepted format: YYYYMMDD. 
...
|Optional                      
|      
|Date that the consumer first used the given shipping address in the merchant's shop. Accepted format: YYYYMMDD. 
 For guest checkout, do not send this field.
...
|Date that the consumer's card was added to their account in the merchant's shop for card-on-file payments 
 (one-click checkout). Accepted format: YYYYMMDD. +
...
|Conditional                   
|50
|City of the consumer's billing address. This field is limited to a maximum of 50 characters.

2+|country
|String            
|Conditional -- "The field is required if Cardholder Billing Address State is present and unless market or regional mandate restricts sending this information." - so it's mandatory?                 
|3
|Country of the consumer's billing address. Format: numeric ISO 3166-1 standard. This field is limited to a maximum of 3 characters.

2+|street1                    
|String            
|Conditional                   
|50   
|Line 1 of the street address of the consumer's billing address. This field is limited to a maximum of 50 characters.

2+|street2                    
|String            
|Conditional                   
|50   
|Line 2 of the street address of the consumer's billing address. This field is limited to a maximum of 50 characters.
       
2+|street3                    
|String            
|Conditional                   
|50   
|Line 3 of the street address of the consumer's billing address. This field is limited to a maximum of 50 characters.

2+|postal-code
|String            
|Conditional                   
|16  
|ZIP/postal code of the consumer's billing address. This field is limited to a maximum of 16 characters.

2+|state
|String            
|Conditional                   
|3  
|State/province of the consumer's billing address. Format: numeric ISO 3166-2 standard. This field is limited to a maximum of 3 characters.
...
|Conditional                   
|    
|Country Code of the mobile phone provided by the cardholder. +
 This field is required if available.
...
|The shipping method chosen by the consumer. 
 ...
 Accepted values are: 01, 02, 03, 04, 05, 06 +
 01 = Ship to merchant's billing address. +
...
|Conditional                   
|50
|City of the consumer's shipping address. This field is limited to a maximum of 50 characters. Must be sent even if billing city is identical.

2+|country
|String            
|Conditional                 
|3
|Country of the consumer's shipping address. Format: numeric ISO 3166-1 standard. This field is limited to a maximum of 3 characters. Must be sent even if billing country is identical.
  
2+|street1                    
|String            
|Conditional                   
|50   
|Line 1 of the street address of the consumer's shipping address. This field is limited to a maximum of 50 characters. Must be sent even if billing address is identical.

2+|street2                    
|String            
|Conditional                   
|50   
|Line 2 of the street address of the consumer's shipping address. This field is limited to a maximum of 50 characters. Must be sent even if billing address is identical.
     
2+|street3                    
|String            
|Optional                      
|50   
|Line 3 of the street address of the consumer's shipping address. This field is limited to a maximum of 50 characters. Must be sent even if billing address is identical.                    

2+|postal-code
|String            
|Conditional                   
|16  
|ZIP/postal code of the consumer's shipping address. This field is limited to a maximum of 16 characters. Must be sent even if billing address is identical.

2+|state
|String            
|Conditional                   
|3  
|State/province of the consumer's shipping address. Format: numeric ISO 3166-2 standard. This field is limited to a maximum of 3 characters. Must be sent even if billing address is identical.
...
|Optional                      
|      
|Expected date of shipping for pre-ordered goods. Format: YYYYMMDD.
...
|Optional                      
|      
|For the purchase of prepaid and gift cards. The total amount of prepaid/gift cards in major units (no decimal places allowed).
...
|Optional                      
|3   
|The currency code for prepaid and gift cards as defined in ISO 4217. 
                                
2+|card-count                     
|Numeric           
|Optional                      
|      
|The total number of prepaid and gift cards that are being purchased. This field is limited to 2 characters.                                                                               
...
|Optional                      
|      
|For recurring payments. Date after which no further recurring payments are allowed.
