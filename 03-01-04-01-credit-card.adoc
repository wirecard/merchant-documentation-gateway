...
[source,json,subs=attributes+]
----
include::samples/json/PaydooPPv2_CC_TransactionTypePurchase_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaydooPPv2_CC_TransactionTypePurchase_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaydooPPv2_CC_TransactionTypeAuthorization_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaydooPPv2_CC_TransactionTypeAuthorization_AuthorizationResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaydooPPv2_CC_TransactionTypeAuthorizationonly_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
ifdef::env-po[]
----
include::samples/json/PaydooPPv2_CC_TransactionTypeAuthorizationonly_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaydooPPv2_CC_3DSecureTestCredentialsAdditional_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaydooPPv2_CC_3DSecureTestCredentialsAdditional_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
Below, you find a <<PPv2_CC_3DS2Sample, 3DS2 sample request>> for the transaction type purchase, including a <<PPv2_CC_3DS2Fields_ROC, field list>> with short descriptions of additional 3D Secure 2 fields. 
...
_Test Card Information for Credit Card with 3D Secure 2_

Please use the <<API_CC_TestCards_3D_Success, test cards provided for successful 3D Secure 2 Transactions for REST API>>.
