...
|Optional                      
|      
|Registration date of the consumer's account in the merchant's shop. For guest checkout, do not send this field.
...
|Date that the consumer last made changes to their account in the merchant's shop. For example, 
 changes to billing and shipping address, new payment account, new email address. For guest checkout, do not send this field. 
...
|Optional                      
|      
|Date that the consumer first used the shipping address in the merchant's shop. Accepted format: YYYYMMDD. 
 For guest checkout, do not send this field.
