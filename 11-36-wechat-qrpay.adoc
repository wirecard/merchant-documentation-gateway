...
[source,xml]
----
include::samples/xml/wechat-qrpay_refund-debit_request_success.xml[]
----

.XML refund-debit Response (Successful)
[source,xml]
----
include::samples/xml/wechat-qrpay_refund-request_response_success.xml[]
----

.XML refund-debit Notification (Successful)
[source,xml]
----
include::samples/xml/wechat-qrpay_refund-request_notification_success.xml[]
----
...
[source,xml]
----
include::samples/xml/wechat-qrpay_void-debit_request_success.xml[]
----

.XML void-debit Response (Successful)
[source,xml]
----
include::samples/xml/wechat-qrpay_void-debit_response_success.xml[]
----

.XML void-debit Notification (Successful)
[source,xml]
----
include::samples/xml/wechat-qrpay_void-debit_notification_success.xml[]
----
