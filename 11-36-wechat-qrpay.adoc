...
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesDebitgeturl_DebitRequestSuccessful.xml[]
----

.XML get-url Response (Successful)
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesDebitgeturl_GetUrlResponseSuccessful.xml[]
----

.XML get-url Notification (Successful)
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesDebitgeturl_GetUrlNotificationSuccessful.xml[]
----

.XML debit Request (Failure)
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesDebitgeturl_DebitRequestFailure.xml[]
----

.XML get-url Response (Failure)
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesDebitgeturl_GetUrlResponseFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesRefunddebit_RefundDebitRequestSuccessful.xml[]
----

.XML refund-debit Response (Successful)
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesRefunddebit_RefundDebitResponseSuccessful.xml[]
----

.XML refund-debit Notification (Successful)
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesRefunddebit_RefundDebitNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesVoiddebit_VoidDebitRequestSuccessful.xml[]
----

.XML void-debit Response (Successful)
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesVoiddebit_VoidDebitResponseSuccessful.xml[]
----

.XML void-debit Notification (Successful)
[source,xml]
----
include::samples/xml/API_WeChatQRPaySamplesVoiddebit_VoidDebitNotificationSuccessful.xml[]
----
