...
[source,xml]
----
include::src-files/xml/API_WeChatQRPay_Samples_debitgeturl_debit_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_WeChatQRPay_Samples_debitgeturl_debit_Request_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_WeChatQRPay_Samples_refunddebit_NVP_Debit_Request_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_WeChatQRPay_Samples_voiddebit_NVP_Debit_Request_Failure.xml[]
----
