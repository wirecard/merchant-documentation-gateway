...
=======
image::images/11-32-wechat-qrpay/Logo_WeChat_QRCode.png[alt=WeChat QR Pay logo, 200, align=right]
>>>>>>> PSPDOC-555
...
=======
image::images/11-32-wechat-qrpay/WeChat_QRCode.png[WeChat QRPay Workflow]
>>>>>>> PSPDOC-555
