...
NOTE: To retrieve all available IPP options, send a request to the <<PPv2_CC_IPP_option2_Samples_IPPSRequest, Installment Payment Plan Service (IPPS)>>.
...
+
[#PPv2_CC_IPP_option2_Samples_IPPSRequest]
.Sample IPPS Request
...
----
+
[#PPv2_CC_IPP_option2_IPPSRequestFields]
[%autowidth, cols="m,,,"]
...
+
[#PPv2_CC_IPP_option2_Samples_IPPSResponse]
...
----
+
[#PPv2_CC_IPP_option2_IPPSResponseFields]
[%autowidth, cols="m,,,,,"]
...
+
-> Retrieve the field values from the <<PPv2_CC_IPP_option2_Samples_IPPSResponse, IPPS response>>.
+
