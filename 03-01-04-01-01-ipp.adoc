...
NOTE: You need a Merchant Account ID (MAID) to offer IPP to your consumers. Be sure that IPP has been set up for you by <<merchant support, contact merchant support>>.
