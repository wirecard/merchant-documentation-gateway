...
[source,json]
----
include::src-files/json/WPP_P24_TransactionType_debit_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_P24_JSON_NVPFields_JSON_Structure_for_P24_Requests.json[]
----
...
[source,json]
----
include::src-files/json/WPP_P24_JSON_NVPFields_Request_JSON_Structure_for_P24_Requests.json[]
----
