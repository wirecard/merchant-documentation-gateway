...
[source,xml]
----
include::samples/xml/monetaRuSamplesDebit_DebitRequestSuccessful.xml[]
----

.XML debit Response (Successful)
[source,xml]
----
include::samples/xml/monetaRuSamplesDebit_DebitResponseSuccessful.xml[]
----

.XML debit Request (Failure)
[source,xml]
----
include::samples/xml/monetaRuSamplesDebit_DebitRequestFailure.xml[]
----

.XML debit Response (Failure)
[source,xml]
----
include::samples/xml/monetaRuSamplesDebit_DebitResponseFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/monetaRuSamplesCredit_CreditRequestSuccessful.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::samples/xml/monetaRuSamplesCredit_CreditResponseSuccessful.xml[]
----

.XML credit Request (Failure)
[source,xml]
----
include::samples/xml/monetaRuSamplesCredit_CreditRequestFailure.xml[]
----

.XML credit Response (Failure)
[source,xml]
----
include::samples/xml/monetaRuSamplesCredit_CreditResponseFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/monetaRuSamplesrefundDebit_RefundDebitRequestSuccessful.xml[]
----

.XML refund-debit Response (Successful)
[source,xml]
----
include::samples/xml/monetaRuSamplesrefundDebit_RefundDebitResponseSuccessful.xml[]
----

.XML refund-debit Request (Failure)
[source,xml]
----
include::samples/xml/monetaRuSamplesrefundDebit_RefundDebitRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/monetaRuSamplesrefundDebit_RefundDebitResponseFailure.xml[]
----
