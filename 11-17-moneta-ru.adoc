...
[source,xml]
----
include::samples/xml/moneta_ru_debit_request_success.xml[]
----

.XML debit Response (Successful)
[source,xml]
----
include::samples/xml/moneta_ru_debit_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/moneta_ru_refund-debit_request_success.xml[]
----

.XML refund-debit Response (Successful)
[source,xml]
----
include::samples/xml/moneta_ru_refund-debit_response_success.xml[]
----

.XML refund-debit Request (Failure)
[source,xml]
----
include::samples/xml/moneta_ru_refund-debit_request_failure.xml[]
----
...
[source,xml]
----
include::samples/xml/moneta_ru_refund-debit_response_failure.xml[]
----
