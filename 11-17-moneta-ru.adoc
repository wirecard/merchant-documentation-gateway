...
----
include::samples/xml/moneta_ru_debit_request_success_en.xml[]
----

.XML debit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_debit_response_success_en.xml[]
----

.XML debit Request (Failure)
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_debit_request_failure.xml[]
----

.XML debit Response (Failure)
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_debit_response_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_credit_request_success.xml[]
----

.XML credit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_credit_response_success.xml[]
----

.XML credit Request (Failure)
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_credit_request_failure.xml[]
----

.XML credit Response (Failure)
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_credit_response_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_refund-debit_request_success_fc6bc03d.xml[]
----

.XML refund-debit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_refund-debit_response_success_en_fc6bc03d.xml[]
----

.XML refund-debit Request (Failure)
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_refund-debit_request_failure_fc6bc03d.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/moneta_ru_refund-debit_response_failure_en_fc6bc03d.xml[]
----
