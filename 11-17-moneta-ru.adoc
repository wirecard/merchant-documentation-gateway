...
[source,xml]
----
include::src-files/xml/monetaRu_Samples_debit_debit_Request_Successful.xml[]
----

.XML debit Response (Successful)
[source,xml]
----
include::src-files/xml/monetaRu_Samples_debit_debit_Response_Successful.xml[]
----

.XML debit Request (Failure)
[source,xml]
----
include::src-files/xml/monetaRu_Samples_debit_debit_Request_Failure.xml[]
----

.XML debit Response (Failure)
[source,xml]
----
include::src-files/xml/monetaRu_Samples_debit_debit_Response_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/monetaRu_Samples_credit_credit_Request_Successful.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::src-files/xml/monetaRu_Samples_credit_credit_Response_Successful.xml[]
----

.XML credit Request (Failure)
[source,xml]
----
include::src-files/xml/monetaRu_Samples_credit_credit_Request_Failure.xml[]
----

.XML credit Response (Failure)
[source,xml]
----
include::src-files/xml/monetaRu_Samples_credit_credit_Response_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/monetaRu_Samples_refundDebit_credit_Response_Failure.xml[]
----
