...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Purchase_SendingData_PurchaseUsingCardData_purchase_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Purchase_SendingData_PurchaseUsingToken_purchase_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Purchase_SendingData_ReferencingPurchaseTransactions_PurchaseRequestFirst_Request_Header.xml[]
----
...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Purchase_SendingData_ReferencingPurchaseTransactions_ReferencedPurchaseRequestRecurring_Request_Header.xml[]
----
...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Purchase_SendingData_ReferencingPurchaseTransactions_ReferencedPurchaseRequestFinal_Request_Header.xml[]
----
...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Purchase_SendingData_VoidPurchase_Request_Header.xml[]
----
...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Purchase_SendingData_RefundPurchase_Request_Header.xml[]
----
...
[source,xml]
----
include::src-files/xml/CreditCard_TransactionTypes_Purchase_SendingData_VoidRefundPurchase_Request_Header.xml[]
----
