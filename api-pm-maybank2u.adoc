...
----
include::samples/xml/maybank2u_debit_request_success_en.xml[]
----

.XML Debit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/maybank2u_debit_response_success_en.xml[]
----

.XML Debit Notification (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/maybank2u_debit_notification_success_bb7320a2.xml[]
----

.XML Debit Request (Failure)
[source,xml,subs=attributes+]
----
include::samples/xml/maybank2u_debit_request_failure.xml[]
----

.XML Debit Response (Failure)
[source,xml,subs=attributes+]
----
include::samples/xml/maybank2u_debit_response_failure.xml[]
----

.XML Debit Notification (Failure)
[source,xml,subs=attributes+]
----
include::samples/xml/maybank2u_debit_notification_failure_bb7320a2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/maybank2u_get-url_request_.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::samples/xml/maybank2u_get-url_response_.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::samples/xml/maybank2u_debit_response__ea8579fd.xml[]
----
