...
<<API_AlipayCrossBorder_Samples_autoDebit_authorizationOnly(Sign), _authorization-only_ (sign) samples>>

<<API_AlipayCrossBorder_Samples_autoDebit_authorizationOnly(Unsign), _authorization-only_ (unsign) samples>>
|===
