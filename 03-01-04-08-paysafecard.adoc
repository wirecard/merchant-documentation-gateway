...
[source,json]
----
include::src-files/json/WPP_paysafecard_TransactionType_debit_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_paysafecard_TransactionType_debit_redirect_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_paysafecard_TransactionType_authorization_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_paysafecard_TransactionType_capture_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_paysafecard_JSONNVPFields_request_JSON_Structure_for__paybox__Requests.json[]
----
...
[source,json]
----
include::src-files/json/WPP_paysafecard_JSONNVPFields_response_JSON_Structure_for__paybox__Requests.json[]
----
