...
v|*Payment processing with the {payment-page-v2} generally follows the same steps:*
...
| cafdc4c6-3eec-424c-9c74-80c31b77cd38
...
| d64e9579-73bc-47cf-b05d-19d6f39610db
...
----
include::samples/json/PaymentPageSolutions_WPP_HPP_IntegrationExampleCreate_CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaymentPageSolutions_PaydooPPv2_HPP_IntegrationExampleCreate_CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaymentPageSolutions_WPP_HPP_IntegrationExampleRedirect_ResponseToAuthorizationRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::samples/json/PaymentPageSolutions_WPP_HPP_IntegrationExampleParse_ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::samples/json/PaymentPageSolutions_PaydooPPv2_HPP_IntegrationExampleParse_ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
