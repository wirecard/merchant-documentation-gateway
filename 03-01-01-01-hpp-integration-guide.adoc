...
*Redirecting Consumers to the Payment Page Using ``PaymentPage.hostedPayUrl``*
...
. Call the ``PaymentPage.hostedPayUrl(payment-redirect-url)`` function in
your HTML code to redirect the consumer to a new window:
+
[source,html,subs=attributes+]
----
<script type="text/javascript">
PaymentPage.hostedPayUrl("https://{test-instance-hostname}/?wPaymentToken=f0c0e5b3-23ad-4cb4-abca-ed80a0e770e7")
</script>
----
+
