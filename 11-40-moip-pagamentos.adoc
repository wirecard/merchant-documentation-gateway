...
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentsPurchase_PurchaseRequestSuccessful.xml[]
----

.XML _pending-purchase_ Response (Successful)
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentsPurchase_PendingPurchaseResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentsPurchase_PurchaseNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentmethodsPurchase_PurchaseRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentmethodsPurchase_PurchaseRequestSuccessful_8.xml[]
----

.XML _purchase_ Response (Successful)
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentmethodsPurchase_PurchaseResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentmethodsAuthorization_CaptureAuthorizationRequestSuccessful.xml[]
----

.XML _capture-authorization_ Response (Successful)
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentmethodsAuthorization_CaptureAuthorizationResponseSuccessful.xml[]
----

.XML _void-authorization_ Request (Successful)
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentmethodsAuthorization_VoidAuthorizationRequestSuccessful.xml[]
----

.XML _void-authorization_ Response (Successful)
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentmethodsAuthorization_VoidAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentmethodsRefund_RefundResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/MoipPagamentosXMLSamplesRestApiPaymentmethodsRefund_RefundCaptureRequestSuccessful.xml[]
----
