...
[source,xml]
----
include::samples/xml/creditcard_capture-authorization_request_success.xml[]
----

.XML _capture-authorization_ Response (Successful)
[source,xml]
----
include::samples/xml/creditcard_capture-authorization_response_success.xml[]
----

.XML _void-authorization_ Request (Successful)
[source,xml]
----
include::samples/xml/creditcard_void-authorization_request_success.xml[]
----

.XML _void-authorization_ Response (Successful)
[source,xml]
----
include::samples/xml/creditcard_void-authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/creditcard_refund-capture_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/creditcard_refund-capture_request_success.xml[]
----
