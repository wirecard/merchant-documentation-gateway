...
* *Guaranteed Invoice, Direct Debit  and Installment:* see
<<GuaranteedInvoiceDirectDebitandInstallments_estCredentials, Guaranteed Invoice, Direct Debit and Installments Test Credentials>>
* *iDEAL:* see
<<iDEAL_TestCredentials, iDEAL Test Credentials>>
* *Klarna Guaranteed Invoice and Installments:* see
<<KlarnaGuaranteedInvoiceandInstallments_TestCredentials, Klarna_Test Credentials>>
* *MasterPass:* see
...
<<POIPIA_TestCredentials, Payment on Invoice/Payment in Avance Test Credentials>>
* *payolution:* see
...
<<SEPACreditTransfer-TestCredentials, SEPA Credit Transfer Test Credentials>>
...
* *WeChat QRPay:* see
<<WeChatQRPay_TestCredentials, WeChat QR Pay Test Credentials>>
