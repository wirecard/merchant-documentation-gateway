...
|{payment-page-abbr-lower-case}_options_max_retries |max-retries |Numeric |options (\{ })
...
----
include::samples/json/WPP_FeaturesMaxRetriesConfiguringMaxRetries_ExampleRequestWMaxRetriesEnabledSetToUnlimitedRetries.json[]
----
