...
[source,xml]
----
include::samples/xml/ratepay-elv_authorization_request_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-elv_authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-elv_capture-authorization_request_success.xml[]
----

.XML capture-authorization Response (Successful)
[source,xml]
----
include::samples/xml/ratepay-elv_capture-authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-elv_refund-capture_request_success.xml[]
----

.XML refund-capture Response (Successful)
[source,xml]
----
include::samples/xml/ratepay-elv_refund-capture_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-elv_credit_request_success.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::samples/xml/ratepay-elv_credit_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-elv_void-authorization_request_success.xml[]
----

.XML void-authorization Response (Successful)
[source,xml]
----
include::samples/xml/ratepay-elv_void-authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-elv_authorization_unknown_.xml[]
----
