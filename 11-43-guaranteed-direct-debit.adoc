...
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitAuthorization_AuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitAuthorization_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitCaptureAuthorization_CaptureAuthorizationRequestSuccessful.xml[]
----

.XML capture-authorization Response (Successful)
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitCaptureAuthorization_CaptureAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitRefundCapture_RefundCaptureRequestSuccessful.xml[]
----

.XML refund-capture Response (Successful)
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitRefundCapture_RefundCaptureResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitCredit_CreditRequestSuccessful.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitCredit_CreditResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitVoidAuthorization_VoidAuthorizationRequestSuccessful.xml[]
----

.XML void-authorization Response (Successful)
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitVoidAuthorization_VoidAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedDirectDebitSamplesDirectDebitDeviceIdentToken_deviceIdentTokenTransfer.xml[]
----
