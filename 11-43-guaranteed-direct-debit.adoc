...
the basket.
| <<GuaranteedDirectDebit_Samples_GuaranteedInvoice, Guaranteed Invoice by Wirecard samples>>
...
[#GuaranteedDirectDebit_GuaranteedInvoice]
...
[#GuaranteedDirectDebit_ProcessChain]
===== Process Chain
...
[#GuaranteedDirectDebit_SimpleProcessChainforGuaranteedInvoice]
...
[#GuaranteedDirectDebit_ComplexProcessChainforGuaranteedInvoice]
...
[#GuaranteedDirectDebit_DeviceFingerprint_GuaranteedInvoice]
===== Device Fingerprint (Guaranteed Invoice by Wirecard)

[#GuaranteedDirectDebit_DeviceFingerprint_GuaranteedInvoice_Introduction]
====== Introduction
...
[#GuaranteedDirectDebit_DeviceFingerprint_GuaranteedInvoice_UniqueToken]
...
[#GuaranteedDirectDebit_DeviceFingerprint_GuaranteedInvoice_RunJavaScript]
====== Run JavaScript
...
[#GuaranteedDirectDebit_DeviceFingerprint_GuaranteedInvoice_DataTransferToWirecard]
====== Data Transfer to Wirecard

Please transfer the ``deviceIdentToken`` within the authorization request to
Wirecard. You can find a corresponding XML sample for either <<GuaranteedDirectDebit_Samples_GuaranteedInvoice, Guaranteed Invoice by Wirecard>> or <<GuaranteedDirectDebit_Samples_DirectDebit, Guaranteed Direct Debit>>.
...
[#GuaranteedDirectDebit_Samples_GuaranteedInvoice]
===== Guaranteed Invoice by Wirecard

[#GuaranteedDirectDebit_Samples_GuaranteedInvoice_Authorization]
====== _authorization_
...
[#GuaranteedDirectDebit_Samples_GuaranteedInvoice_CaptureAuthorization]
...
[#GuaranteedDirectDebit_Samples_GuaranteedInvoice_Credit]
====== _credit_
...
[#GuaranteedDirectDebit_Samples_GuaranteedInvoice_RefundCapture]
====== _refund-capture_
...
[#GuaranteedDirectDebit_Samples_GuaranteedInvoice_VoidAuthorization]
...
[#GuaranteedDirectDebit_Samples_GuaranteedInvoice_DeviceIdentToken]
