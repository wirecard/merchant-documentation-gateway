...
[source,xml]
----
include::src-files/xml/GuaranteedDirectDebit_Samples_DirectDebit_Authorization_authorization_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedDirectDebit_Samples_DirectDebit_Authorization_authorization_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedDirectDebit_Samples_DirectDebit_CaptureAuthorization_authorization_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedDirectDebit_Samples_DirectDebit_RefundCapture_authorization_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedDirectDebit_Samples_DirectDebit_Credit_credit_Request_Successful.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::src-files/xml/GuaranteedDirectDebit_Samples_DirectDebit_Credit_credit_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedDirectDebit_Samples_DirectDebit_VoidAuthorization_credit_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedDirectDebit_Samples_DirectDebit_DeviceIdentToken_deviceIdentToken_Transfer.xml[]
----
