...
[mermaid,API_CC_3DS2_PaymentFlows_OneTimePaymentTransaction_OneStep,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_OneTimePaymentTransaction_TwoStep,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_First,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_SubsequentOptionOne,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_SubsequentOptionTwo,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_StoringCardCredentials_AuthOnly,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_StoringCardCredentials_AuthAndVoid,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_StoringCardCredentials_Subsequent,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_MIT_FirstPaymentAndSubscription_First,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_RecurringMIT_StoringCCAndSubscription_TwoStep,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_RecurringMIT_StoringCCAndSubscription_AuthAndVoid,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (recurring amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_InstallmentMIT_FirstPaymentAndInstallment_FirstCI,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
m| <<CreditCard_3DS2_Fields_PeriodicRecurringNumber, periodic/number-of-installments>>
m| xxx
...
[mermaid,API_CC_3DS2_PaymentFlows_InstallmentMIT_SubsequentNoAuth_TwoStep,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_FirstAndUnscheduledMIT_FirstPayment,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_Subsequent_NoAuth_TwoStepMIT,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_StoringCard_AuthAndVoid,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (initial amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_StoringCard_TwoStepMIT,svg,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. authorization (UCOF amount)")-->B("2. capture-authorization (UCOF amount)")
----
