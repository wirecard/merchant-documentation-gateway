...
[mermaid,API_CC_3DS2_PaymentFlows_OneTimePaymentTransaction_OneStep,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
C("<center>3.<br>check-payer-response<br>(optional)</center>")-->D
D("<center>4.<br>purchase<br>(full amount)</center>")
style B fill:#eee, stroke:#eee
----
...
m| <<CreditCard_Fields_Payment_ParentTransactionId, parent-transaction-id>>
|
...
[mermaid,API_CC_3DS2_PaymentFlows_OneTimePaymentTransaction_TwoStep,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
C("<center>3.<br>check-payer-response<br>(optional)</center>")-->D
D("<center>4.<br>authorization<br>(full amount)</center>")-->E
E("<center>5.<br>capture-authorization<br>(full amount)</center>")
style B fill:#eee, stroke:#eee
----
...
. *Check-payer-response* (optional): Use this request to receive, analyze and store authentication values on your side or use your connection to the Wirecard Payment Gateway for the “MPI Only” option.  The *check-payer-response* provides the authentication values needed later on in the *authorization.* It is executed _after_ you received the *check-enrollment* response and the *PARes*. The *check-payer-response* must contain the following fields:
...
[mermaid,API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_First,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
...
m| <<CreditCard_Fields_Card_MerchantTokenizationFlag, card/merchant-tokenization-flag>>
m| true
|===
+
As a result of the check-enrollment, you receive the *PAReq* with the ACS URL.
...
[mermaid,API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_SubsequentOptionOne,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_SubsequentOptionTwo,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_StoringCardCredentials_AuthOnly,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(non-payment)")-->|2. redirect-| B("<center>3.<br>check-payer-response<br>(optional)")
B-->C("<center>4.<br>authorization-only<br>(zero amount)")
----
...
+
. *Check-payer-response* (optional): Use this request to receive, analyze and store authentication values on your side or use your connection to the Wirecard Payment Gateway for the “MPI Only” option.  The *check-payer-response* provides the authentication values needed later on in the *authorization-only.* It is executed _after_ you received the *check-enrollment* response and the *PARes*. The *check-payer-response* must contain the following fields:
 * ``three-d/pares``: This is the digitally signed, base64-encoded authentication response message containing ARes/CRes received from the issuer.
 * ``parent-transaction-id``: Use the value returned in the ``transaction-id`` field of the *check-enrollment* response.
...
[mermaid,API_CC_3DS2_PaymentFlows_StoringCardCredentials_AuthAndVoid,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
C("<center>3.<br>check-payer-response<br>(optional)</center>")-->D
D("<center>4.<br>authorization<br>(full amount)</center>")-->E
E("<center>5.<br>void-authorization<br>(optional)</center>")
style B fill:#eee, stroke:#eee
----
...
[mermaid,API_CC_3DS2_PaymentFlows_StoringCardCredentials_Subsequent,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
...
m| <<CreditCard_Fields_CardToken_TokenId, card-token/token-id>>
|
...
[mermaid,API_CC_3DS2_PaymentFlows_MIT_FirstPaymentAndSubscription_First,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(recurring amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
C("<center>3.<br>check-payer-response<br>(optional)</center>")-->D
D("<center>4.<br>purchase<br>(recurring amount)</center>")
style B fill:#eee, stroke:#eee
----
...
New 3D Secure 2 fields can be found in the <<CreditCard_3DS2_Fields, 3D Secure 2 field table>> and are included in the <<Appendix_Xml, REST API payment XSD>>.
+
CAUTION: For 3D Secure 2 consumer-initiated  (CI) one-click checkout, include the new field ``three-d/version`` and set its value to ``2.1``. Set ``challenge-indicator`` to ``04``. Mark the transaction as ``recurring`` in ``periodic-type``.
...
+
CAUTION: For 3D Secure 2 consumer-initiated  (CI) one-click checkout, include the new field ``three-d/version`` and set its value to ``2.1``. Set
``challenge-indicator`` to ``04``. Mark the transaction as ``recurring`` in ``periodic-type``.
...
+
CAUTION: Mark the transaction as ``recurring`` in ``periodic-type``.
...
[mermaid,API_CC_3DS2_PaymentFlows_MIT_FirstPaymentAndSubscription_Subscription_TwoStep,svg,width=60]
----
graph LR
A("<center>1.<br>authorization<br>(recurring amount)</center>")-->B("<center>2.<br>capture-authorization<br>(recurring amount)</center>")
----
...
[mermaid,API_CC_3DS2_PaymentFlows_RecurringMIT_StoringCCAndSubscription_AuthAndVoid,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(recurring amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
C("<center>3.<br>check-payer-response<br>(optional)</center>")-->D
D("<center>4.<br>authorization<br>(recurring amount)</center>")-->E
E("<center>5.<br>void-authorization<br>(optional)</center>")
style B fill:#eee, stroke:#eee
----
...
[mermaid,API_CC_3DS2_PaymentFlows_RecurringMIT_StoringCCAndSubscription_TwoStep,svg,width=60]
----
graph LR
A("<center>1.<br>authorization<br>(recurring amount)</center>")-->B("<center>2.<br>capture-authorization<br>(recurring amount)</center>")
----
...
[mermaid,API_CC_3DS2_PaymentFlows_InstallmentMIT_FirstPaymentAndInstallment_FirstCI,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount + interest)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
C("<center>3.<br>check-payer-response<br>(optional)</center>")-->D
D("<center>4.<br>purchase<br>(first installment amount)</center>")
style B fill:#eee, stroke:#eee
----
...
New 3D Secure 2 fields can be found in the <<CreditCard_3DS2_Fields, 3D Secure 2 field table>> and are included in the <<Appendix_Xml, REST API payment XSD>>.
+
CAUTION: For 3D Secure 2 consumer-initiated  (CI) one-click checkout, include the new field ``three-d/version`` and set its value to ``2.1``. Set ``challenge-indicator`` to ``04``. Mark the transaction as ``installment`` in ``periodic-type``.
...
--
+
NOTE: It is not required to mark the *check-payer-response* as ``installment``.
...
+
CAUTION: Mark the transaction as ``installment`` in ``periodic-type``.
...
[mermaid,API_CC_3DS2_PaymentFlows_InstallmentMIT_SubsequentNoAuth_TwoStep,svg,width=60]
----
graph LR
A("<center>1.<br>authorization<br>(installment amount)</center>")-->B("<center>2.<br>capture-authorization<br>(installment amount)</center>")
----
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_FirstAndUnscheduledMIT_FirstPayment,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(initial amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
C("<center>3.<br>check-payer-response<br>(optional)</center>")-->D
D("<center>4.<br>purchase<br>(initial amount)</center>")
style B fill:#eee, stroke:#eee
----
...
New 3D Secure 2 fields can be found in the <<CreditCard_3DS2_Fields, 3D Secure 2 field table>> and are included in the <<Appendix_Xml, REST API payment XSD>>.
+
CAUTION: For 3D Secure 2 consumer-initiated  (CI) one-click checkout, include the new field ``three-d/version`` and set its value to ``2.1``. Set ``challenge-indicator`` to ``04``. 
...
+
CAUTION: Mark the transaction as ``ucof`` in ``periodic-type``.
...
[#API_CC_3DS2_PaymentFlows_MITUCOF_Subsequent_NoAuth]
====== Subsequent Payment without Authentication
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_Subsequent_NoAuth_TwoStepMIT,svg,width=60]
----
graph LR
A("<center>1.<br>authorization<br>(UCOF amount)</center>")-->B("<center>2.<br>capture-authorization<br>(UCOF amount)</center>")
----
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_StoringCard_AuthAndVoid,svg,width=60]
----
graph LR
A("<center>1.<br>check-enrollment<br>(initial amount)</center>")-->B
B["<center>2. ACS URL redirect</center>"]-->C
C("<center>3.<br>check-payer-response<br>(optional)</center>")-->D
D("<center>4.<br>authorization<br>(initial amount)</center>")-->E
E("<center>5.<br>void-authorization<br>(optional)</center>")
style B fill:#eee, stroke:#eee
----
...
--
+
NOTE: It is not required to mark the *check-payer-response* as ``ucof`` and ``recurring``.
...
. *Purchase*: This final step in the transaction flow must reference the initial ``ucof`` transaction. Include the ``transaction-id`` from the _initial_ *authorization* response in the ``parent-transaction-id`` field. Set the ``sequence-type`` to ``recurring``.
+
CAUTION: Mark the transaction as ``ucof`` in ``periodic-type``.
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_StoringCard_TwoStepMIT,svg,width=60]
----
graph LR
A("<center>1.<br>authorization<br>(UCOF amount)</center>")-->B("<center>2.<br>capture-authorization<br>(UCOF amount)</center>")
----
