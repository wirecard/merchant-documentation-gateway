...
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->|2. redirect-| B("<center>3.<br>check-payer-response<br>(optional)</center>")
B-->C("<center>4.<br>purchase<br>(full amount)</center>")
----
...
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->|2. redirect-|B("<center>3.<br>check-payer-response<br>(optional)</center>")
B--> C("<center>4.<br>authorization<br>(full amount)</center>")
C-->D("<center>5.<br>capture-authorization<br>(full amount)</center>")
----
...
A("<center>1.<br>check-enrollment<br>(full amount)</center>")-->|2. redirect-| B("<center>3.<br>check-payer-response<br>(optional)</center>")
B-->C("<center>4.<br>authorization<br>(full amount)</center>")
C-->D("<center>5.<br>void-authorization<br>(optional)</center>")
----
...
----
graph LR
A("<center>1.<br>check-enrollment<br>(recurring amount)</center>")-->|2. redirect-| B("<center>3.<br>check-payer-response<br>(optional)</center>")
B-->C("<center>4.<br>purchase<br>(recurring amount)</center>")
----
...
[mermaid,API_CC_3DS2_PaymentFlows_MIT_FirstPaymentAndSubscription_Subscription_OneStep,svg,width=60]
----
graph LR
C("<center>purchase<br>(recurring amount)</center>")
----
