...
----
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)")-->|2. redirect-| B("<center>3.<br>check-payer-response<br>(optional)")
B-->C("<center>4.<br>purchase<br>(full amount)")
----
...
graph LR
A("<center>1.<br>check-enrollment<br>(full amount)")-->|2. redirect-|B("<center>3.<br>check-payer-response<br>(optional)")
B--> C("<center>4.<br>authorization<br>(full amount)")
C-->D("<center>5.<br>capture-authorization<br>(full amount)")
----
...
A("<center>1.<br>check-enrollment<br>(full amount)")-->|2. redirect-| B("<center>3.<br>check-payer-response<br>(optional)")
B--> C("<center>4.<br>authorization<br>(full amount)")
C-->D("<center>5.<br>void-authorization<br>(optional)")
----
...
----
graph LR
A("<center>1.<br>check-enrollment<br>(recurring amount)")-->|2. redirect-| B("<center>3.<br>check-payer-response<br>(optional)")
B-->C("<center>4.<br>purchase<br>(recurring amount)")
----
...
----
graph LR
A("<center>1.<br>authorization<br>(recurring amount)")-->B("<center>2.<br>capture-authorization<br>(recurring amount)")
----
