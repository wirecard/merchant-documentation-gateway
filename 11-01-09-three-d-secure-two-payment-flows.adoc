...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_OneTimePaymentTransaction_OneStep,svg]
----
graph LR
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_OneTimePaymentTransaction_TwoStep,svg]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_First,svg]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_SubsequentOptionOne,svg]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_SubsequentOptionTwo,svg]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_StoringCardCredentials_AuthOnly,svg]
----
graph LR
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_StoringCardCredentials_AuthAndVoid,svg]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_StoringCardCredentials_Subsequent,svg]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_MIT_FirstPaymentAndSubscription_First,svg]
----
graph LR
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_MIT_FirstPaymentAndSubscription_Subscription_TwoStep,svg]
----
graph LR
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_RecurringMIT_StoringCCAndSubscription_AuthAndVoid,svg]
----
graph LR
A("1. check-enrollment (recurring amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_RecurringMIT_StoringCCAndSubscription_TwoStep,svg]
----
graph LR
A("1. authorization (recurring amount)")-->B("2. capture-authorization (recurring amount)")
----
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_InstallmentMIT_FirstPaymentAndInstallment_FirstCI,svg]
----
graph LR
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_InstallmentMIT_SubsequentNoAuth_TwoStep,svg]
----
graph LR
...
IMPORTANT: Check-enrollment with UCOF is currently under development and will be made available with the next update release. 

[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_MITUCOF_FirstAndUnscheduledMIT_FirstPayment,svg]
----
graph LR
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_MITUCOF_Subsequent_NoAuth_TwoStepMIT,svg]
----
graph LR
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_MITUCOF_StoringCard_AuthAndVoid,svg]
----
graph LR
A("1. check-enrollment (initial amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,images/diagrams/API_CC_3DS2_PaymentFlows_MITUCOF_StoringCard_TwoStepMIT,svg]
----
graph LR
A("1. authorization (UCOF amount)")-->B("2. capture-authorization (UCOF amount)")
----
