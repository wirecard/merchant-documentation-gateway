...
m| <<CreditCard_Fields_AccountHolder_AccountInfo_ChallengeIndicator, account-info/challenge-indicator>>
m| 04
...
m| <<CreditCard_Fields_AccountHolder_AccountInfo_ChallengeIndicator, challenge-indicator>>
m| 04
...
m| <<CreditCard_Fields_Card_MerchantTokenizationFlag, merchant-tokenization-flag>>
m| true
|===
