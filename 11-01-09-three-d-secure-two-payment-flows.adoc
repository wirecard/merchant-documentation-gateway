...
[mermaid,API_CC_3DS2_PaymentFlows_OneTimePaymentTransaction_OneStep,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_OneTimePaymentTransaction_TwoStep,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_First,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_SubsequentOptionOne,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_FirstPaymentCICheckout_SubsequentOptionTwo,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_StoringCardCredentials_AuthOnly,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_StoringCardCredentials_AuthAndVoid,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_StoringCardCredentials_Subsequent,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (full amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_MIT_FirstPaymentAndSubscription_First,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_RecurringMIT_StoringCCAndSubscription_TwoStep,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_RecurringMIT_StoringCCAndSubscription_AuthAndVoid,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (recurring amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_InstallmentMIT_FirstPaymentAndInstallment_FirstCI,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_InstallmentMIT_SubsequentNoAuth_TwoStep,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_FirstAndUnscheduledMIT_FirstPayment,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_Subsequent_NoAuth_TwoStepMIT,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_StoringCard_AuthAndVoid,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. check-enrollment (initial amount)")-->B
B["2. ACS URL redirect"]-->C
...
[mermaid,API_CC_3DS2_PaymentFlows_MITUCOF_StoringCard_TwoStepMIT,png,puppeteerConfig="puppeteer-config.json"]
----
graph LR
A("1. authorization (UCOF amount)")-->B("2. capture-authorization (UCOF amount)")
----
