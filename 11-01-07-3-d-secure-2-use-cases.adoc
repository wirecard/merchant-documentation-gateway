...
NOTE: To process MOTO transactions, your merchant account must be configured accordingly (<<ContactUs, contact merchant support>>).
...
How to mark a transaction as MOTO depends on your MOTO merchant configuration option: two options 

. In case your merchant account 
...
There are two available merchant account 
