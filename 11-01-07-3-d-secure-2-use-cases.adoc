...
You do 3DS Authentication with {payment-provider-name} but do _authorization_ with an external provider (acquirer)
...
The merchant receives the 3DS Authentication from a non-{payment-provider-name} 3DS server and proceed with {payment-provider-name} for _authorization_
