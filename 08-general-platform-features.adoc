...
Referenced transactions (e.g. refund, recurring) have a limited transaction lifecycle within _{payment-gateway}._ Starting on 01.02.2020 only transactions processed in the last two years can be referenced.
====
endif::[]
