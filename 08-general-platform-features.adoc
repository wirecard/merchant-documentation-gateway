...
Surcharging is a feature available in the Wirecard Payment Page V1, aimed
...
Surcharging rates (calculated as either a fixed amount or a percentage)
vary according to:
...
Make sure that you tick the following preconditions for setup:

- Your merchant account must be configured to enable surcharging.
- The country must be defined.
- Surcharging rates must be configured.
//-
...
|===
h| URLs (Endpoints)	| Please contact merchant support for full test credentials.
h| Merchant Account ID (MAID)	|	Please contact merchant support for full test credentials.
h| Username	|	16390-testing
h| Password	|	3!3013=D3fD8X7
h| Secret Key	|	Please contact merchant support for full test credentials.
|===
