...
in {payment-gateway}. It means a transaction from the merchant
...
When you want to find out, whether the {payment-gateway-abbr} servers are available, you
can use a link to the {payment-gateway-abbr} status page:
