...
7. Consumer selects the appropriate installment plan. By submitting,
   ...
   The fields sent in this __purchase__ or __authorization__ request are:
...
[cols="e,,,"]
|===
|Field |<<GeneralPlatformFeatures_IPP_InstallmentCalculator_Fields_MO, M/O>> |Data Type |Description
