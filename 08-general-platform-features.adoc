...
Referenced transactions (e.g. refund, recurring) have a limited transaction lifecycle in _{payment-gateway-abbr}._ Starting on 01.02.2020 only transactions processed within the last two years can be referenced.
====
endif::[]
