...
7. Consumer selects the appropriate installment plan. By submitting,
   the selected program/tenure is sent with the payment authorization request
   to WPG.
//-
...
/engine/rest/utils/installmentcalculator
...
[cols="e,,,,"]
|===
|Field |<<GeneralPlatformFeatures_IPP_InstallmentCalculator_Fields_MO, M/O>> |Data Type |Size |Description
...
|Alphanumeric
|
|Calculated amount of monthly payment. +
