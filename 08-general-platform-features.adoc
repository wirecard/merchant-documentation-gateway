...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossMerchant_Samples_Initial_Xml__Consumer_makes_the_payment_in_the_banking_application_and_is.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossMerchant_Samples_Initial_Xml_Debit_Notification_for_iDEAL.xml[]
----
...
[source,json]
----
include::src-files/json/GeneralPlatformFeatures_CrossMerchant_Samples_Initial_Json_Debit_Notification_for_iDEAL.json[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossMerchant_Samples_Recurring_Xml_Debit_Notification_for_iDEAL.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossMerchant_Samples_Recurring_Xml_SEPA_Credit_Notification_Successful.xml[]
----
...
[source,json]
----
include::src-files/json/GeneralPlatformFeatures_CrossMerchant_Samples_Recurring_Json_SEPA_Credit_Notification_Successful.json[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Initial_Xml_SEPA_Credit_Notification_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Initial_Xml_Debit_Notification_for_Initial_iDEAL.xml[]
----
...
[source,json]
----
include::src-files/json/GeneralPlatformFeatures_CrossPayment_Samples_Initial_Json_Debit_Notification_for_Initial_iDEAL.json[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Initial_RecurringIdeal_Xml_SEPA_Direct_Debit_Request_Following.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Initial_RecurringIdeal_Xml_SEPA_Direct_Debit_Response_Following_Successful.xml[]
----
...
[source,json]
----
include::src-files/json/GeneralPlatformFeatures_CrossPayment_Samples_Initial_RecurringIdeal_Json_JSON_SEPA_Direct_Debit_Request_Following.json[]
----
...
[source,json]
----
include::src-files/json/GeneralPlatformFeatures_CrossPayment_Samples_Initial_RecurringIdeal_Json_JSON_SEPA_Direct_Debit_Response_Following_Successful.json[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Initial_RecurringSepa_Xml_SEPA_Credit_Request_Following.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Initial_RecurringSepa_Xml_SEPA_Credit_Response_Following.xml[]
----
...
[source,json]
----
include::src-files/json/GeneralPlatformFeatures_CrossPayment_Samples_Initial_RecurringSepa_Json_JSON_SEPA_Credit_Request_Following.json[]
----
...
[source,json]
----
include::src-files/json/GeneralPlatformFeatures_CrossPayment_Samples_Initial_RecurringSepa_Json_JSON_SEPA_Credit_Response_Following.json[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Subsequent_Xml_debit_Request_Initial_iDEAL.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Subsequent_Xml_debit_Response_Initial_iDEAL.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Subsequent_Xml_SEPA_Credit_Request.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_CrossPayment_Samples_Subsequent_Xml_SEPA_Credit_Response.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_IPN_Json_Request_determines_notification_in_JSON_format.xml[]
----
...
[source, json]
----
include::src-files/json/GeneralPlatformFeatures_IPN_Json_JSON_Notification.json[]
----
...
[source, xml]
----
include::src-files/xml/GeneralPlatformFeatures_IPN_Xml_Notification_in_Format.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_IPN_Xml_Request_with_different_URL_for_failed_transactions.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_IPN_NotificationExamples_Credit_Card_Payment.xml[]
----

.Alternative Payment Methods
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_IPN_NotificationExamples_Alternative_Payment_Methods.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_RedirectURL_MAID_Alternative_Payment_Methods.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_RedirectURL_Request_General_Request_Sample_for_Redirect_URL.xml[]
----
...
<payments xmlns="http://www.elastic-payments.com/schema/payment"
          ...
          self="https://{test-instance-hostname}:443/engine/rest/resolver-category/CATEGORY_X/payments/?request_id=c1052ad7-1372-4755-b6e1-fb32e7519be1">
    <payment
            self="https://{test-instance-hostname}:443/engine/rest/merchants/44b30ddd-6c31-4db6-8bf3-2b7cbc032373/payments/b36dcb4b-95d2-4f3e-ad4d-0f5e0e4b7d91">
        <merchant-account-id
                ref="https://{test-instance-hostname}:443/engine/rest/config/merchants/44b30ddd-6c31-4db6-8bf3-2b7cbc032373">
    ...
    <payment
            self="https://{test-instance-hostname}:443/engine/rest/merchants/667fddb2-38f4-4982-90c5-8f37dd54a679/payments/a538f7cf-11e8-40a9-ba2a-bac0165f4e56">
        <merchant-account-id
                ref="https://{test-instance-hostname}:443/engine/rest/config/merchants/667fddb2-38f4-4982-90c5-8f37dd54a679">
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_Transactions_Storing_General_Request_Sample_for_Redirect_URL.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_IPP_InstallmentCalculator_Samples_Installment_Calculator_Sample_Request.xml[]
----
...
[source,xml]
----
include::src-files/xml/GeneralPlatformFeatures_IPP_InstallmentCalculator_Samples_Installment_Calculator_Sample_Response.xml[]
----
