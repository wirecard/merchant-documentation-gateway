...
[source,xml]
----
include::src-files/xml/MobilePaymentSDK_Android_EmbeddedForm_You_can_customize_the_following.xml[]
----
+
...
[source,xml]
----
include::src-files/xml/MobilePaymentSDK_Android_PBBA_ImportantNotes_WirecardResponseListener_Initialization.xml[]
----
+
...
[source,xml]
----
include::src-files/xml/MobilePaymentSDK_Android_PBBA_ImportantNotes_Example_Usage.xml[]
----
+
