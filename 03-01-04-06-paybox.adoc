...
[source,json]
----
include::src-files/json/WPP_paybox_TransactionType_purchase_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_paybox_TransactionType_purchase_Redirect_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_paybox_TransactionType_authorization_Request_Headers.json[]
----
...
[source,json]
----
include::src-files/json/WPP_paybox_JSONNVPFields_request_JSON_Structure_for__paybox__Requests.json[]
----
