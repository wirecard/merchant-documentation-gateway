...
//-
====
//KKS: We should try to get rid of M/O; it's just as confusing for merchants as C, which is why it was decided to remove it entirely from 3DS2 documentation.
