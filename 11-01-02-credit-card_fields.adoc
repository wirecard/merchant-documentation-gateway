...
<<CC_Fields_xmlobjects_request_cardemv, card-emv>>

<<CC_Fields_xmlobjects_request_cardpin, card-pin>>

<<CC_Fields_xmlobjects_request_cardraw, card-raw>>
...
2+| card-type 3+| <<CC_Fields_xmlobjects_request_cardtype, card-type>>
