...
// What kind of hierarchy does apply here?
...
//KKS: Follow up task: Provide a brief description for each of these values. See 3DS2 table for similar formatting.
...
_Visa:_ Mandatory if ReferenceNumber is empty, Maximum size: 34
...
2+| card-types 3+| ``card-types`` is the parent element of <<CC_Fields_xmlelements_request_cardtype, ``card-type``>>. 
...
////
vhauss: Reviewer, please check: Is this description correct?
////
