...
===== _payolution_'s Specific Payment Methods
...
_payolution_'s specific payment method (payolution-inv, payolution-b2b
...
[#payolution_Samples]
==== Samples: XML Request, Response and Notification
