...
Shall CC be part of this list? Or shall we leave it out and name the headline "Alternative Payment Methods"?
...
Shall we provide Guaranteed DD and Installment and Invoice as one entry, as we do with the API description? Or does Guaranteed Invoice by Wirecard not comprise DD and Installment?
...
.Payolution Guaranteed Installment
For a short introduction see <<payolution_Introduction, payolution>>

.Payolution Guaranteed Invoice
For a short introduction see <<, >>

////

Shall we provide Payolution Installment and Invoice as one entry, as we do with the API description?
