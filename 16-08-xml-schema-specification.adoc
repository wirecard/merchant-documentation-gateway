...
<xs:schema
    ...
    <xs:simpleType name="integer4">
        <xs:restriction base="xs:int">
            <xs:minInclusive id="int.min" value="1"/>
            <xs:maxInclusive id="int.max" value="4"/>
        </xs:restriction>
    </xs:simpleType>
    ...
    <xs:simpleType name="payment-method-name">
        <xs:restriction base="xs:token">
            ...
            <xs:enumeration value="3pay-carrier"/>
    ...
    <xs:complexType name="address">
        <xs:all>
            <xs:element name="block-no" type="xs:string" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="house-extension" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    <xs:complexType name="account-holder">
        <xs:all>
            ...
            <xs:element name="tax-number" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="shipping">
        <xs:all>
            ...
            <xs:element name="email" type="email" minOccurs="0" maxOccurs="1"/>
            <xs:element name="shipping-method" type="shipping-method" minOccurs="0" maxOccurs="1"/>
            <xs:element name="tracking-number" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="tracking-url" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="shipping-company" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="return-tracking-number" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="return-tracking-url" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="return-shipping-company" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="card">
        <xs:all>
            ...
            <xs:element name="issue-number" type="xs:short" minOccurs="0" maxOccurs="1"/>
            <xs:element name="start-month" type="month" minOccurs="0" maxOccurs="1"/>
            <xs:element name="start-year" type="year" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="pin-data" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <!-- pin-data should be replaced with cardPin - KIV and to be removed -->
            <xs:element name="card-emv" type="card-emv" minOccurs="0" maxOccurs="1"/>
            <xs:element name="card-pin" type="card-pin" minOccurs="0" maxOccurs="1"/>
            <xs:element name="card-raw" type="card-raw" minOccurs="0" maxOccurs="1"/>
            <xs:element name="merchant-tokenization-flag" type="xs:boolean" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    <xs:complexType name="card-emv">
        <xs:all>
            <xs:element name="request-icc-data" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="request-icc-data-encoding" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="response-icc-data" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="response-icc-data-encoding" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    <xs:complexType name="card-pin">
        <xs:all>
            ...
            <xs:element name="encryption-context" type="encryption-context" minOccurs="0" maxOccurs="1"/>
            <xs:element name="encryption-version" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="card-token">
        <xs:all>
            ...
            <xs:element name="token-ext-id" type="token-ext-id" minOccurs="0" maxOccurs="1"/>
    ...
    <xs:complexType name="token-ext-id">
        <xs:simpleContent>
            <xs:extension base="xs:token">
                <xs:attribute name="provider-id" type="xs:token" use="optional"/>
            </xs:extension>
        </xs:simpleContent>
    </xs:complexType>
    <xs:complexType name="cryptogram">
        <xs:all>
            <xs:element name="cryptogram-type" type="cryptogram-type" minOccurs="1" maxOccurs="1"/>
            <xs:element name="cryptogram-value" type="xs:string" minOccurs="1" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="custom-field">
        <xs:simpleContent>
            <xs:extension base="xs:string">
                <xs:attribute name="field-name" type="string36" use="required"/>
                <xs:attribute name="field-value" type="string256" use="required"/>
            </xs:extension>
        </xs:simpleContent>
    </xs:complexType>
    ...
    <xs:complexType name="status">
        <xs:simpleContent>
            <xs:extension base="xs:string">
                ...
                <xs:attribute name="provider-transaction-id" type="xs:string" use="optional"/>
                <xs:attribute name="provider-code" type="xs:string" use="optional"/>
                <xs:attribute name="provider-message" type="xs:string" use="optional"/>
    ...
    <xs:complexType name="three-d">
        <xs:all>
            <xs:element name="pares" type="xs:string" minOccurs="0" maxOccurs="1"/>

            <xs:element name="eci" type="eci" minOccurs="0" maxOccurs="1"/>
            <xs:element name="xid" type="xs:string" minOccurs="0" maxOccurs="1"/>

            <!-- This field is  used for both CAVV (Visa) and AAV (MC)-->
            <xs:element name="cardholder-authentication-value" type="xs:string" minOccurs="0" maxOccurs="1"/>

            <xs:element name="pareq" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="acs-url" type="xs:string" minOccurs="0" maxOccurs="1"/>

            <xs:element name="attempt-three-d" type="xs:boolean" minOccurs="0" maxOccurs="1"/>

            <xs:element name="liability-shift-indicator" type="xs:string" minOccurs="0" maxOccurs="1"/>

            <xs:element name="cardholder-authentication-status" type="xs:string" minOccurs="0" maxOccurs="1">
                <xs:annotation>
    ...
    <xs:complexType name="browser">
        <xs:all>
            <xs:element name="accept" type="string2048" minOccurs="0" maxOccurs="1"/>
            <xs:element name="user-agent" type="string256" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="browser-version" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="os" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="time-zone" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="screen-resolution" type="xs:string" minOccurs="0" maxOccurs="1"/>
    ...
    <xs:complexType name="cookie">
        <xs:all>
            ...
            <xs:element name="max-age" type="xs:long" minOccurs="0" maxOccurs="1"/>
            <xs:element name="secure" type="xs:boolean" minOccurs="0" maxOccurs="1"/>
            <xs:element name="http-only" type="xs:boolean" minOccurs="0" maxOccurs="1"/>            
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="journey">
        <xs:all>
            <xs:element name="type" type="journey-type" minOccurs="0" maxOccurs="1"/>
            <xs:element name="origin-location" type="location" minOccurs="0" maxOccurs="1"/>
            <xs:element name="destination-location" type="location" minOccurs="0" maxOccurs="1"/>
            <xs:element name="valid-from" type="xs:dateTime" minOccurs="0" maxOccurs="1"/>
            <xs:element name="valid-until" type="xs:dateTime" minOccurs="0" maxOccurs="1"/>
            <xs:element name="transferable" type="xs:boolean" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="bank-account">
        <xs:all>
            ...
            <xs:element name="branch-city" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="branch-state" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="branch-address" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="iban" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="bic" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="account-number" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="bank-code" type="xs:string" minOccurs="0" maxOccurs="1"/>
            
            <!-- boleto refunding fields -->
            <xs:element name="type" type="bank-account-type" minOccurs="0" maxOccurs="1" />
            <xs:element name="agency-number" type="xs:string" minOccurs="0" maxOccurs="1" />
            <xs:element name="agency-check-number" type="xs:string" minOccurs="0" maxOccurs="1" />
            <xs:element name="account-check-number" type="xs:string" minOccurs="0" maxOccurs="1" />
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="invoice">
        <xs:all>
            ...
            <xs:element name="invoice-url" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="delivery-method" type="delivery-method" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="periodic">
        <xs:all>
            ...
            <xs:element name="number-of-installments" type="integer4" minOccurs="0" maxOccurs="1"/>
             <!-- YYYY-MM-DD format-->
            <xs:element name="recurring-expire-date" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="wallet">
        <xs:all>
            ...
            <xs:element name="request-token" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="pair-token" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="card-id" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="address-id" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="provider-ref" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="provider-transaction-id" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="wallet-data" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="order-item">
        ...
        <xs:all>
            ...
            <xs:element name="type" type="order-item-type" minOccurs="0" maxOccurs="1"/>
    ...
    <xs:complexType name="iso-fields">
        <xs:sequence>
            <xs:element name="iso-field" type="iso-field" minOccurs="0" maxOccurs="unbounded"/>
        </xs:sequence>
    </xs:complexType>
    <xs:complexType name="iso">
        <xs:all>
            <xs:element name="merchant-id" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="terminal-id" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="bank-terminal-id" type="xs:string" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="pos-pin-input-length-capability" type="xs:int" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="pin-data" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="product-code" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="msg-auth-code" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="iso-fields" type="iso-fields" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    <xs:complexType name="iso-recon">
        <xs:all>
            ...
            <xs:element name="authorized-sale-count" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="authorized-sale-amount" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="authorized-refund-count" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="authorized-refund-amount" type="xs:string" minOccurs="0" maxOccurs="1"/>
    ...
    <xs:complexType name="device">
        <xs:all>
            ...
            <xs:element name="type" type="device-type" minOccurs="0" maxOccurs="1"/>
            <xs:element name="operating-system" type="device-os" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="voucher">
        <xs:all>
            <xs:element name="voucher-code" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="voucher-brand-id" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="voucher-token-id" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="voucher-description" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="voucher-serial-number" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="voucher-alternative-amount" type="alternative-amount" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    ...
    <xs:complexType name="signature">
        <xs:all>
            <xs:element name="signature-type" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="signature-value" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="signature-encoding" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
    <xs:complexType name="avs">
        <xs:sequence>
            <xs:element name="result-code" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="result-message" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="provider-result-code" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="provider-result-message" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:sequence>
    </xs:complexType>
    <xs:complexType name="additional-provider-data">
        <xs:sequence>
            <xs:element name="provider-data" type="provider-data" minOccurs="0" maxOccurs="unbounded"/>
        </xs:sequence>
    </xs:complexType>
    <xs:complexType name="provider-data">
                ...
                <xs:attribute name="provider-id" type="xs:string" use="optional"/>
                <xs:attribute name="provider-transaction-id" type="xs:string" use="optional"/>
    </xs:complexType>
    <xs:complexType name="audit">
        <xs:sequence>
            <xs:element name="request-source" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="user" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:sequence>
    </xs:complexType>
    <xs:complexType name="payment">
        <xs:all>
            <xs:element name="merchant-account-id" type="merchant-account-id" minOccurs="0" maxOccurs="1"/>
            <xs:element name="merchant-account-resolver-category" type="merchant-account-resolver-category"
            ...
            <xs:element name="group-transaction-id" type="uuid" minOccurs="0" maxOccurs="1"/>
            <xs:element name="account-holder" type="account-holder" minOccurs="0" maxOccurs="1"/>
            <xs:element name="account-holder-requested-amount" type="money" minOccurs="0" maxOccurs="1"/>
            <xs:element name="account-holder-conversion-rate" type="xs:decimal" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="cryptogram" type="cryptogram" maxOccurs="1" minOccurs="0"/>
            <xs:element name="ip-address" type="ip-address" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="travel-industry" type="travel-industry" minOccurs="0" maxOccurs="1"/>
            <xs:element name="bank-account" type="bank-account" minOccurs="0" maxOccurs="1"/>
            <xs:element name="merchant-bank-account" type="bank-account" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="consumer-id" type="string50" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="pending-redirect-url" type="xs:string" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="psp-name" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="custom-css-url" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <!-- YYYY-MM-DD format-->
            <xs:element name="due-date" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="capture-date" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="expiration-date" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="hyperlink-expiration-time-stamp" type="xs:dateTime" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="avs" type="avs" minOccurs="0" maxOccurs="1"/>
            <xs:element name="audit" type="audit" minOccurs="0" maxOccurs="1"/>
            ...
            <xs:element name="non-gambling-oct-type" type="non-gambling-oct-type" minOccurs="0" maxOccurs="1"/>
            <xs:element name="credit-sender-data" type="credit-sender-data" minOccurs="0" maxOccurs="1"/>
            ...
            <!-- voucher -->
            <xs:element name="voucher-id" type="voucher-card-id" minOccurs="0" maxOccurs="1"/>
            <xs:element name="voucher" type="voucher" minOccurs="0" maxOccurs="1"/>

            <xs:element name="instrument-country" type="country" minOccurs="0" maxOccurs="1"/>
            <!-- masterpass related fields -->
            <xs:element name="request-type" type="request-type" minOccurs="0" maxOccurs="1"/>
            <xs:element name="merchant-origin-url" type="url" minOccurs="0" maxOccurs="1"/>
            <xs:element name="customer-id" type="xs:string" minOccurs="0" maxOccurs="1"/>

            <!-- signature -->
            <xs:element name="signature" type="signature" minOccurs="0" maxOccurs="1"/>

            <xs:element name="sub-merchant-info" type="sub-merchant-info" minOccurs="0" maxOccurs="1"/>
            <xs:element name="one-time-password" type="xs:string" minOccurs="0" maxOccurs="1"/>

            <!--browser-->
            <xs:element name="browser" type="browser" minOccurs="0" maxOccurs="1"/>
            <xs:element name="additional-provider-data" type="additional-provider-data" minOccurs="0" maxOccurs="1"/>

            <xs:element name="additional-merchant-data" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="b2b" type="xs:boolean" minOccurs="0" maxOccurs="1"/>
            <xs:element name="auto-capture" type="xs:boolean" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    ...
    <xs:complexType name="credit-sender-data">
        <xs:all>
            <xs:element name="receiver-name" type="name" minOccurs="0" maxOccurs="1"/>
            <xs:element name="receiver-last-name" type="name" minOccurs="0" maxOccurs="1"/>
            <xs:element name="reference-number" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="sender-account-number" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="sender-name" type="name" minOccurs="0" maxOccurs="1"/>
            <xs:element name="sender-last-name" type="name" minOccurs="0" maxOccurs="1"/>
            <xs:element name="sender-address" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="sender-city" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="sender-country" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="sender-state" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="sender-postal-code" type="xs:string" minOccurs="0" maxOccurs="1"/>
            <xs:element name="sender-funds-source" type="xs:string" minOccurs="0" maxOccurs="1"/>
        </xs:all>
    </xs:complexType>
</xs:schema>
----
