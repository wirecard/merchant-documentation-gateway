...
// from here
_FPX_ service is suitable for all businesses that offer products or services via the internet. With _FPX_, all payments are concluded online in real-time basis, making the service as good as cash. Plus, it generates payment records, simplifies reconciliation and reduces risk, thereby encouraging more shoppers to shop online. 
//to here
