...
code) in the field ``descriptor``. The descriptor must
...
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceAuthorization_AuthorizationRequestSuccessful.xml[]
----

.XML authorization Response (Successful)
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceAuthorization_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceCaptureAuthorization_CaptureAuthorizationRequestSuccessful.xml[]
----

.XML capture-authorization Response (Successful)
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceCaptureAuthorization_CaptureAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceCredit_CreditRequestSuccessful.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceCredit_CreditResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceRefundCapture_RefundCaptureRequestSuccessful.xml[]
----

.XML refund-capture Response (Successful)
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceRefundCapture_RefundCaptureResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceVoidAuthorization_VoidAuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceVoidAuthorization_VoidAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GuaranteedInvoiceSamplesGuaranteedInvoiceDeviceIdentToken_deviceIdentTokenTransfer.xml[]
----
