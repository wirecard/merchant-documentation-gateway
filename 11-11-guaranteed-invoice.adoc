...
[source,xml]
----
include::samples/xml/ratepay-invoice_authorization_request_success.xml[]
----

.XML authorization Response (Successful)
[source,xml]
----
include::samples/xml/ratepay-invoice_authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-invoice_capture-authorization_request_success.xml[]
----

.XML capture-authorization Response (Successful)
[source,xml]
----
include::samples/xml/ratepay-invoice_capture-authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-invoice_credit_request_success.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::samples/xml/ratepay-invoice_credit_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-invoice_refund-capture_request_success.xml[]
----

.XML refund-capture Response (Successful)
[source,xml]
----
include::samples/xml/ratepay-invoice_refund-capture_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-invoice_void-authorization_request_success.xml[]
----
...
[source,xml]
----
include::samples/xml/ratepay-invoice_void-authorization_response_success.xml[]
----
