...
[source,xml]
----
include::src-files/xml/GuaranteedInvoice_Samples_GuaranteedInvoice_Authorization_authorization_Request_Successful.xml[]
----

.XML authorization Response (Successful)
[source,xml]
----
include::src-files/xml/GuaranteedInvoice_Samples_GuaranteedInvoice_Authorization_authorization_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedInvoice_Samples_GuaranteedInvoice_CaptureAuthorization_authorization_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedInvoice_Samples_GuaranteedInvoice_Credit_credit_Request_Successful.xml[]
----

.XML credit Response (Successful)
[source,xml]
----
include::src-files/xml/GuaranteedInvoice_Samples_GuaranteedInvoice_Credit_credit_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedInvoice_Samples_GuaranteedInvoice_RefundCapture_credit_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedInvoice_Samples_GuaranteedInvoice_VoidAuthorization_credit_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/GuaranteedInvoice_Samples_GuaranteedInvoice_DeviceIdentToken_deviceIdentToken_Transfer.xml[]
----
