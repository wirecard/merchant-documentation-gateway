...
include::index/payment-methods/thai-qr/thai-qr-main.adoc[leveloffset=+1]
include::index/payment-methods/thai-qr/rest/thai-qr.adoc[leveloffset=+2]
include::index/payment-methods/thai-qr/ppv2/thai-qr.adoc[leveloffset=+2]
