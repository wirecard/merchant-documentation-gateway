...
include::index/payment-methods/prompt-pay/prompt-pay-main.adoc[leveloffset=+1]
include::index/payment-methods/prompt-pay/rest/prompt-pay.adoc[leveloffset=+2]
include::index/payment-methods/prompt-pay/ppv2/prompt-pay.adoc[leveloffset=+2]
