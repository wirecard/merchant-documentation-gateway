...
include::index/payment-processing/3-d-secure-2/use-cases/three-d-secure-2-use-cases.adoc[leveloffset=+2]
include::index/payment-processing/3-d-secure-2/use-cases/one-time-payment.adoc[leveloffset=+3]
include::index/payment-processing/3-d-secure-2/use-cases/general-multi-party-commerce.adoc[leveloffset=+3]
