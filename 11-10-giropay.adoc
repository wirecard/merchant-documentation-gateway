...
NOTE: The merchant sends a _debit_ request to the _{payment-gateway}_ and receives a response
...
transaction.
. _{payment-gateway}_ forwards the request to _giropay._
...
----
include::samples/xml/giropay_get-url_request_success_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/giropay_get-url_response_success_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/giropay_debit_notification_success_en_18ad619c.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/giropay_get-url_request_failure_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/giropay_get-url_response_failure_en.xml[]
----
