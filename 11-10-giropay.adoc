...
[source,xml]
----
include::samples/xml/GiropaySamplesGeturlXml_GetUrlRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GiropaySamplesGeturlXml_GetUrlResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GiropaySamplesGeturlXml_DebitNotificationSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/GiropaySamplesGeturlXml_GetUrlRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/GiropaySamplesGeturlXml_GetUrlResponseFailure.xml[]
----
