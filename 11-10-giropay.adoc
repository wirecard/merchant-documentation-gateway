...
[source,xml]
----
include::src-files/xml/giropay_Samples_geturl_xml___Wirecard_Payment_Gateway__processes_the_notification_and_sends_the.xml[]
----
...
[source,xml]
----
include::src-files/xml/giropay_Samples_geturl_xml_debit_Notification_Successful.xml[]
----
