...
[source,html]
----
include::samples/html/AppendixI_FAQ_HtmlInsteadOfXmlResponse_WsaqtIagtHrbbwlitbif.html[]
----
...
[source,xml]
----
include::samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Request.xml[]
----
+
.Response
...
[source,xml]
----
include::samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Response.xml[]
----
+
...
[source,xml]
----
include::samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Request_9.xml[]
----
+
.Response
...
[source,xml]
----
include::samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Response_10.xml[]
----
