...
[source,xml]
----
include::src-files/xml/AppendixI_FAQ_HtmlInsteadOfXmlResponse_Transaction_Types_Matrix_for_Alternative_Payment_Methods.xml[]
----
...
[source,xml]
----
include::src-files/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Request.xml[]
----
+
.Response
...
[source,xml]
----
include::src-files/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Response.xml[]
----
+
