...
[source,xml]
----
include::src-files/xml/PPv1_PaymentSolutions_PaybyLink_Hyperlink_HowTo_authorization_Request_Successful.xml[]
----

.XML authorization Response (Successful)
[source,xml]
----
include::src-files/xml/PPv1_PaymentSolutions_PaybyLink_Hyperlink_HowTo_authorization_Response_Successful.xml[]
----

.JSON authorization Request (Successful)
[source,json]
----
include::src-files/json/PPv1_PaymentSolutions_PaybyLink_Hyperlink_HowTo_JSON_authorization_Request_Successful.json[]
----
