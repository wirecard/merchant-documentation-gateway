...
[source,xml]
----
include::samples/xml/PPv1PaymentSolutionsPaybyLinkHyperlinkHowTo_AuthorizationRequestSuccessful.xml[]
----

.XML authorization Response (Successful)
[source,xml]
----
include::samples/xml/PPv1PaymentSolutionsPaybyLinkHyperlinkHowTo_AuthorizationResponseSuccessful.xml[]
----
...
. The merchant logs in to the {enterprise-portal-url}[{enterprise-portal-name}].
