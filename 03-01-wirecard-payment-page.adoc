...
2+s|Embedded
2+s|Seamless
2+|<<PaymentPageSolutions_WPP_HPP, image:images/03-01-wirecard-payment-page/hosted_cropped.png[Hosted Payment Page, title="Click here to read more", heigth=200]>>
2+|<<PaymentPageSolutions_WPP_EPP, image:images/03-01-wirecard-payment-page/embedded_cropped.png[Embedded Payment Page, title="Click here to read more",height=200]>>
2+|<<WPP_Seamless, image:images/03-01-wirecard-payment-page/seamless_cropped.png[Seamless Mode, title="Click here to read more", heigth=200]>>
