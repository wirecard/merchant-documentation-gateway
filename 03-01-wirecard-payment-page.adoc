...
2+s|Embedded
2+s|Seamless
2+|<<PaymentPageSolutions_PPv2_HPP, image:images/03-01-wirecard-payment-page/hosted_crop.png[Hosted Payment Page, title="Click here to read more", heigth=200]>>
2+|<<PaymentPageSolutions_PPv2_EPP, image:images/03-01-wirecard-payment-page/embedded_crop.png[Embedded Payment Page, title="Click here to read more",height=200]>>
...
|{set:cellbgcolor:red}<<PaymentPageSolutions_PPv2_HPP, [white]#Read more >#>>
|{set:cellbgcolor:white}
|{set:cellbgcolor:red}<<PaymentPageSolutions_PPv2_EPP, [white]#Read more >#>>
|{set:cellbgcolor:white}
