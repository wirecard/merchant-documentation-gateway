...
<<PaymentPageSolutions_WPP_HPP, image:images/03-01-wirecard-payment-page/hosted.png[Hosted Payment Page, title="Click here to read more"]>>
<<PaymentPageSolutions_WPP_EPP, image:images/03-01-wirecard-payment-page/embedded.png[Embedded Payment Page, title="Click here to read more"]>>
