...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeDebit_2RtCttPPIRU.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeAuthorization_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeAuthorization_2RtCttPPIRU.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeAuthorization_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeAuthorizationonly_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeAuthorizationonly_2RtCttPPIRU.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeAuthorizationonly_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeOrder_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeOrder_2RtCttPPIRU.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalTransactionTypeOrder_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalJSONNVPFieldsRequest_JSON_StructureOfAPayPalRequest.json[]
----
...
[source,json]
----
include::samples/json/WPP_PayPalJSONNVPFieldResponse_JSON_StructureOfAPayPalResponse.json[]
----
