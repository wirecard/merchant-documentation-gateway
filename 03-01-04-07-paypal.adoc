...
[source,json]
----
include::src-files/json/WPP_PayPal_TransactionType_debit_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_PayPal_TransactionType_authorization_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_PayPal_TransactionType_authorizationonly_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_PayPal_TransactionType_order_Optional_fields.json[]
----
...
[source,json]
----
include::src-files/json/WPP_PayPal_JSONNVPFields_request_JSON_Structure_of_a__PayPal__Request.json[]
----
...
[source,json]
----
include::src-files/json/WPP_PayPal_JSONNVPField_response_JSON_Structure_of_a__PayPal__Response.json[]
----
