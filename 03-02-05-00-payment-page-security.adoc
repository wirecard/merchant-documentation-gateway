...
consumer's browser, and Wirecard´s Payment Processing Gateway, it is
...
Please note that the order of the fields is important. Also note, the
...
If an optional field is used in the request data, it is mandatory in the
request signature.
