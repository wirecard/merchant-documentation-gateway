...
[source,xml]
----
include::samples/xml/sepadirectdebit_pending-debit_request_success.xml[]
----
...
[source,xml]
----
include::samples/xml/sepadirectdebit_pending-debit_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/sepadirectdebit_debit_request_failure.xml[]
----
...
[source,xml]
----
include::samples/xml/sepadirectdebit_debit_response_failure.xml[]
----
...
[source,xml]
----
include::samples/xml/sepadirectdebit_void-pending-debit_response_success.xml[]
----
