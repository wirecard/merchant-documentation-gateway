...
//-
All these reasons cannot be checked by _Wirecard Payment Gateway_ or
_Wirecard Bank._
...
_Wirecard Payment Gateway_ for future reference.
...
NOTE: The mandate ID may *not* be generated by the _Wirecard Payment Gateway_.
It is solely the responsibility of the merchant.
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebit_PendingDebitRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebit_PendingDebitResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebit_PendingDebitRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebit_PendingDebitResponseFailed.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitPendingDebit_PendingDebitRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitPendingDebit_PendingDebitResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitB2b_DebitRequestB2BTrueSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitB2b_DebitResponseB2BTrueSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitB2b_PendingDebitRequestB2BTrueSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitB2b_PendingDebitResponseB2BTrueSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitRecurring_DebitRequestFirstSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitRecurring_DebitResponseFirstSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitRecurring_DebitRequestRecurringSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitRecurring_DebitResponseRecurringSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitRecurring_DebitRequestRecurringFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesDebitRecurring_DebitResponseRecurringFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesAuthorization_AuthorizationRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesAuthorization_AuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesAuthorization_AuthorizationRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesAuthorization_AuthorizationResponseFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesVoidPendingDebit_VoidPendingDebitRequestSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesVoidPendingDebit_VoidPendingDebitResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesVoidPendingDebit_VoidPendingDebitRequestFailure.xml[]
----
...
[source,xml]
----
include::samples/xml/SEPADirectDebitSamplesVoidPendingDebit_VoidPendingDebitResponseFailure.xml[]
----
