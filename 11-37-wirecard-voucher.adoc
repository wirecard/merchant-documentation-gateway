...
the Wirecard Voucher Module. 

ifndef::env-nova[]
This payment method is available at both
payment and <<MultiPaymentApi, multi-payment>> levels
to make it flexible to combine vouchers together or with other payment
methods, e.g. credit card. 
endif::[]

A _voucher_ is defined as a digital or physical
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_purchase_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_purchase_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_void-purchase_response_success_d424b4b8.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_reserve_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_reserve_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_void-reserve_response_success_83666ab6.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_redeem_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_redeem_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_cancel-redeem_response_success_2bf67fc0.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/voucher_void-cancel-redeem_response_success_75bd223e.xml[]
----
