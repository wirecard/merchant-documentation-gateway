...
[source,xml]
----
include::src-files/xml/WirecardVoucher_Fields_NVP_Notification_Debit_Successful.xml[]
----
...
[source,json]
----
include::src-files/json/WirecardVoucher_Fields_NVP_Notification_Debit_Successful.json[]
----
...
[source,xml]
----
include::src-files/xml/WirecardVoucher_Samples_Purchase_purchase_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/WirecardVoucher_Samples_Purchase_purchase_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/WirecardVoucher_Samples_Reserve_reserve_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/WirecardVoucher_Samples_Reserve_reserve_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/WirecardVoucher_Samples_Redeem_redeem_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/WirecardVoucher_Samples_Redeem_redeem_Response_Successful.xml[]
----
