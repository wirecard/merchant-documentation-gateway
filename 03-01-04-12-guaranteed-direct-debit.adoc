...
<<PPv2_GuaranteedDirectDebit_TransactionType_authorization, Below>>, you can find example requests for the transaction type _authorization_, including a field lists with short descriptions.
...
For transaction type <<PPv2_GuaranteedDirectDebit_TransactionType_authorization, _authorization_>>
...
[#PPv2_{payment-method-name}_PostProcessing]
