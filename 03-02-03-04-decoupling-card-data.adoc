...
----
include::samples/json/SeamlessDecouplingCardDataRenderForm_TransactionDataReceivedFromonSuccessCallbackOfseamlessRenderForm.json[]
----
...
[source,json,subs=attributes+]
----
include::samples/json/SeamlessDecouplingCardDataSubmitForm_TransactionDataReceivedFromonSuccessCallbackOfseamlessSubmitForm.json[]
----
...
[source,json,subs=attributes+]
----
include::samples/json/SeamlessDecouplingCardDataActualPayment_TransactionDataReceivedFromonSuccessCallbackOfseamlessPay.json[]
----
