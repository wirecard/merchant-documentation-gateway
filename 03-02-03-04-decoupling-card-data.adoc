...
[source,json]
----
include::src-files/json/Seamless_DecouplingCardData_RenderForm_Transaction_Data_Received_from_onSuccess_Callback_of_seamlessRenderForm.json[]
----
...
[source,json]
----
include::src-files/json/Seamless_DecouplingCardData_SubmitForm_Transaction_Data_Received_from_onSuccess_Callback_of_seamlessSubmitForm.json[]
----
...
[source,json]
----
include::src-files/json/Seamless_DecouplingCardData_ActualPayment_Transaction_Data_Received_from_onSuccess_Callback_of_seamlessPay.json[]
----
