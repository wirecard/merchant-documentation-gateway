...
:pp-test-instance-hostname: payments-test.{domain}/wpp
:pp-demoshop-instance-hostname: demoshop-test.{domain}
:rest-api-test-endpoint: {test-instance-hostname}/ee/rest/payments/
:rest-api-test-apm-endpoint: {test-instance-hostname}/ee/rest/payments/
