...
.11+|account-holder .5+e|address |street1 |String |Required |64 |The first line of the consumer's address street.
...
.6+|[[PPv2_GuaranteedInvoice_TransactionType_authorization_orderItem]]order-item .2+e|name |description |String |Required |100 |Name of the item in the shopping basket.
|article-number |String |Required |40 |EAN or other merchant side article identifier.

.2+e|amount |value |Numeric |Required |10 |Item’s price per unit.
