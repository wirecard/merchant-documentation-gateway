...
An _authorization_ reserves the specified amount from the account holder’s bank account for a later transfer. It also triggers a creditworthiness-check.
...
We provide JSON examples for this process. You can find them <<PPv2_GuaranteedInvoice_Sample, below>>.
...
[%autowidth]
|===
|Language |Checkbox Text |Correct Links
...
conditions are properly linked.
