...
[#PP2_GuaranteedInvoice_GeneralInformation]
====== General Information
...
NOTE: Check the REST API <<GuaranteedInvoice, {payment-method-name} specification>> for details on {payment-method-name}-specific post-processing operations.
