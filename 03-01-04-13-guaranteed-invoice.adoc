...
----
include::samples/json/PPv2GuaranteedInvoiceTransactionTypeAuthorizationRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::samples/json/PPv2GuaranteedInvoiceTransactionTypeAuthorizationRedirectURL.json[]
----
