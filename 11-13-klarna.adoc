...
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_request_for_DE_successful.xml[]
----

.XML Klarna Invoice Authorization Response for DE (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_Response_for_DE_successful.xml[]
----

.XML Klarna Installments Authorization request for DE (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Installments_Authorization_request_for_DE_successful.xml[]
----

.XML Klarna Installments Authorization Response for DE (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Installments_Authorization_Response_for_DE_successful.xml[]
----

.XML Klarna Invoice Authorization request for NL (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_request_for_NL_successful.xml[]
----

.XML Klarna Invoice Authorization Response for NL (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_Response_for_NL_successful.xml[]
----

.XML Klarna Invoice Authorization request for AT (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_request_for_AT_successful.xml[]
----

.XML Klarna Invoice Authorization response for AT (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_response_for_AT_successful.xml[]
----

.XML Klarna Invoice Authorization request for SE (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_request_for_SE_successful.xml[]
----

.XML Klarna Invoice Authorization Response for SE (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_Response_for_SE_successful.xml[]
----

.XML Klarna Invoice Authorization request for NO (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_request_for_NO_successful.xml[]
----

.XML Klarna Invoice Authorization Response for NO (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_Response_for_NO_successful.xml[]
----

.XML Klarna Invoice Authorization request for FI (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_request_for_FI_successful.xml[]
----

.XML Klarna Invoice Authorization Response for FI (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_Response_for_FI_successful.xml[]
----

.XML Klarna Invoice Authorization request for DK (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_request_for_DK_successful.xml[]
----

.XML Klarna Invoice Authorization Response for DK (successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Klarna_Invoice_Authorization_Response_for_DK_successful.xml[]
----

.XML Authorization Request (Failed)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Authorization_Request_Failed.xml[]
----

.XML Authorization Response (Failed)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Authorization_Response_Failed.xml[]
----

.XML Pending Authorization Request (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Pending_Authorization_Request_Successful.xml[]
----

.XML Pending Authorization Response(Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorization_Pending_Authorization_ResponseSuccessful.xml[]
----
...
[source,xml]
----
include::src-files/xml/Klarna_Samples_adjustAuthorization_Adjust_Authorization_Request_Successful.xml[]
----

.XML Adjust Authorization Response (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_adjustAuthorization_Adjust_Authorization_Response_Successful.xml[]
----

.XML Adjust Authorization Request (Failed)
[source,xml]
----
include::src-files/xml/Klarna_Samples_adjustAuthorization_Adjust_Authorization_Request_Failed.xml[]
----

.XML Adjust Authorization Response (Failed)
[source,xml]
----
include::src-files/xml/Klarna_Samples_adjustAuthorization_Adjust_Authorization_Response_Failed.xml[]
----
...
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorizationRenewal_Authorization_Renewal_Request_Successful.xml[]
----

.XML Authorization Renewal Response(Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorizationRenewal_Authorization_Renewal_ResponseSuccessful.xml[]
----

.XML Authorization Renewal Request (Failed)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorizationRenewal_Authorization_Renewal_Request_Failed.xml[]
----

.XML Authorization Renewal Response(Failed)
[source,xml]
----
include::src-files/xml/Klarna_Samples_authorizationRenewal_Authorization_Renewal_ResponseFailed.xml[]
----
...
[source,xml]
----
include::src-files/xml/Klarna_Samples_voidAuthorization_Void_Authorization_Request_Successful.xml[]
----

.XML Void Authorization Response(Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_voidAuthorization_Void_Authorization_ResponseSuccessful.xml[]
----
...
[source,xml]
----
include::src-files/xml/Klarna_Samples_captureAuthorization_Full_Capture_Authorization_Request_Successful.xml[]
----

.XML Full Capture Authorization Response (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_captureAuthorization_Full_Capture_Authorization_Response_Successful.xml[]
----

.XML Partial Capture Authorization Request (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_captureAuthorization_Partial_Capture_Authorization_Request_Successful.xml[]
----

.XML Partial Capture Authorization Response (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_captureAuthorization_Partial_Capture_Authorization_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/Klarna_Samples_refundCapture_Full_Refund_Capture_Request_Successful.xml[]
----

.XML Full Refund Capture Response (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_refundCapture_Full_Refund_Capture_Response_Successful.xml[]
----

.XML Partial Refund Capture Request (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_refundCapture_Partial_Refund_Capture_Request_Successful.xml[]
----

.XML Partial Refund Capture Response (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_refundCapture_Partial_Refund_Capture_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/Klarna_Samples_getAddress_Get_Address_Request_Successful.xml[]
----

.XML Get Address Response (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_getAddress_Get_Address_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Request_for_DE_Successful.xml[]
----

.XML Installment Calculator Response for DE (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Response_for_DE_Successful.xml[]
----

.XML Installment Calculator Request for DK (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Request_for_DK_Successful.xml[]
----

.XML Installment Calculator Response for DK (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Response_for_DK_Successful.xml[]
----

.XML Installment Calculator Request for NO (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Request_for_NO_Successful.xml[]
----

.XML Installment Calculator Response for NO (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Response_for_NO_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Request_for_FI_Successful.xml[]
----

.XML Installment Calculator Response for FI (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Response_for_FI_Successful.xml[]
----

.XML Installment Calculator Request for SE (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Request_for_SE_Successful.xml[]
----

.XML Installment Calculator Response for SE (Successful)
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Response_for_SE_Successful.xml[]
----

.XML Installment Calculator Request for AT
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Request_for_AT.xml[]
----
...
[source,xml]
----
include::src-files/xml/Klarna_Samples_klarnaInstall_Installment_Calculator_Response_for_AT.xml[]
----
NOTE: payment on installments not available
