...
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationRequestFor_DE_Successful.xml[]
----

.XML Klarna Invoice Authorization Response for DE (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationResponseFor_DE_Successful.xml[]
----

.XML Klarna Installments Authorization request for DE (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInstallmentsAuthorizationRequestFor_DE_Successful.xml[]
----

.XML Klarna Installments Authorization Response for DE (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInstallmentsAuthorizationResponseFor_DE_Successful.xml[]
----

.XML Klarna Invoice Authorization request for NL (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationRequestFor_NL_Successful.xml[]
----

.XML Klarna Invoice Authorization Response for NL (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationResponseFor_NL_Successful.xml[]
----

.XML Klarna Invoice Authorization request for AT (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationRequestFor_AT_Successful.xml[]
----

.XML Klarna Invoice Authorization response for AT (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationResponseFor_AT_Successful.xml[]
----

.XML Klarna Invoice Authorization request for SE (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationRequestFor_SE_Successful.xml[]
----

.XML Klarna Invoice Authorization Response for SE (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationResponseFor_SE_Successful.xml[]
----

.XML Klarna Invoice Authorization request for NO (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationRequestFor_NO_Successful.xml[]
----

.XML Klarna Invoice Authorization Response for NO (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationResponseFor_NO_Successful.xml[]
----

.XML Klarna Invoice Authorization request for FI (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationRequestFor_FI_Successful.xml[]
----

.XML Klarna Invoice Authorization Response for FI (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationResponseFor_FI_Successful.xml[]
----

.XML Klarna Invoice Authorization request for DK (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationRequestFor_DK_Successful.xml[]
----

.XML Klarna Invoice Authorization Response for DK (successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_KlarnaInvoiceAuthorizationResponseFor_DK_Successful.xml[]
----

.XML Authorization Request (Failed)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_AuthorizationRequestFailed.xml[]
----

.XML Authorization Response (Failed)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_AuthorizationResponseFailed.xml[]
----

.XML Pending Authorization Request (Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_PendingAuthorizationRequestSuccessful.xml[]
----

.XML Pending Authorization Response(Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesAuthorization_PendingAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/KlarnaSamplesadjustAuthorization_AdjustAuthorizationRequestSuccessful.xml[]
----

.XML Adjust Authorization Response (Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesadjustAuthorization_AdjustAuthorizationResponseSuccessful.xml[]
----

.XML Adjust Authorization Request (Failed)
[source,xml]
----
include::samples/xml/KlarnaSamplesadjustAuthorization_AdjustAuthorizationRequestFailed.xml[]
----

.XML Adjust Authorization Response (Failed)
[source,xml]
----
include::samples/xml/KlarnaSamplesadjustAuthorization_AdjustAuthorizationResponseFailed.xml[]
----
...
[source,xml]
----
include::samples/xml/KlarnaSamplesauthorizationRenewal_AuthorizationRenewalRequestSuccessful.xml[]
----

.XML Authorization Renewal Response(Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesauthorizationRenewal_AuthorizationRenewalResponseSuccessful.xml[]
----

.XML Authorization Renewal Request (Failed)
[source,xml]
----
include::samples/xml/KlarnaSamplesauthorizationRenewal_AuthorizationRenewalRequestFailed.xml[]
----

.XML Authorization Renewal Response(Failed)
[source,xml]
----
include::samples/xml/KlarnaSamplesauthorizationRenewal_AuthorizationRenewalResponseFailed.xml[]
----
...
[source,xml]
----
include::samples/xml/KlarnaSamplesvoidAuthorization_VoidAuthorizationRequestSuccessful.xml[]
----

.XML Void Authorization Response(Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesvoidAuthorization_VoidAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/KlarnaSamplescaptureAuthorization_FullCaptureAuthorizationRequestSuccessful.xml[]
----

.XML Full Capture Authorization Response (Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplescaptureAuthorization_FullCaptureAuthorizationResponseSuccessful.xml[]
----

.XML Partial Capture Authorization Request (Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplescaptureAuthorization_PartialCaptureAuthorizationRequestSuccessful.xml[]
----

.XML Partial Capture Authorization Response (Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplescaptureAuthorization_PartialCaptureAuthorizationResponseSuccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/KlarnaSamplesrefundCapture_FullRefundCaptureRequestSuccessful.xml[]
----

.XML Full Refund Capture Response (Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesrefundCapture_FullRefundCaptureResponseSuccessful.xml[]
----

.XML Partial Refund Capture Request (Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesrefundCapture_PartialRefundCaptureRequestSuccessful.xml[]
----

.XML Partial Refund Capture Response (Successful)
[source,xml]
----
include::samples/xml/KlarnaSamplesrefundCapture_PartialRefundCaptureResponseSuccessful.xml[]
----
