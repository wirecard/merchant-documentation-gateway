...
[source,xml]
----
include::samples/xml/klarna-invoice_authorization_request_success.xml[]
----

.XML Klarna Invoice Authorization Response for DE (successful)
[source,xml]
----
include::samples/xml/klarna-invoice_authorization_response_success.xml[]
----

.XML Klarna Installments Authorization request for DE (successful)
[source,xml]
----
include::samples/xml/klarna-install_authorization_request_success.xml[]
----

.XML Klarna Installments Authorization Response for DE (successful)
[source,xml]
----
include::samples/xml/klarna-install_authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/klarna-invoice_authorization_request_.xml[]
----

.XML Authorization Response (Failed)
[source,xml]
----
include::samples/xml/klarna-invoice_authorization_response_.xml[]
----
...
[source,xml]
----
include::samples/xml/klarna-invoice_pending-authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/klarna-invoice_adjust-authorization_request_success.xml[]
----

.XML Adjust Authorization Response (Successful)
[source,xml]
----
include::samples/xml/klarna-invoice_adjust-authorization_response_success.xml[]
----

.XML Adjust Authorization Request (Failed)
[source,xml]
----
include::samples/xml/klarna-invoice_adjust-authorization_request_.xml[]
----

.XML Adjust Authorization Response (Failed)
[source,xml]
----
include::samples/xml/klarna-invoice_adjust-authorization_response_.xml[]
----
...
[source,xml]
----
include::samples/xml/klarna-invoice_authorization-renewal_request_success.xml[]
----

.XML Authorization Renewal Response(Successful)
[source,xml]
----
include::samples/xml/klarna-invoice_authorization-renewal_response_success.xml[]
----

.XML Authorization Renewal Request (Failed)
[source,xml]
----
include::samples/xml/klarna-invoice_authorization-renewal_request_.xml[]
----

.XML Authorization Renewal Response(Failed)
[source,xml]
----
include::samples/xml/klarna-invoice_authorization-renewal_response_.xml[]
----
...
[source,xml]
----
include::samples/xml/klarna-invoice_void-authorization_request_success.xml[]
----

.XML Void Authorization Response(Successful)
[source,xml]
----
include::samples/xml/klarna-invoice_void-authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/klarna-invoice_capture-authorization_request_success.xml[]
----

.XML Full Capture Authorization Response (Successful)
[source,xml]
----
include::samples/xml/klarna-invoice_capture-authorization_response_success.xml[]
----
...
[source,xml]
----
include::samples/xml/klarna-invoice_refund-capture_request_success.xml[]
----

.XML Full Refund Capture Response (Successful)
[source,xml]
----
include::samples/xml/klarna-invoice_refund-capture_response_success.xml[]
----
