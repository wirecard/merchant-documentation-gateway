...
[source,xml]
----
include::src-files/xml/API_MasterPass_Samples_Initial_PairingCheckout___Wirecard_Payment_Gateway__requests_for_full_card_information.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_MasterPass_Samples_Initial_Pairing___Wirecard_Payment_Gateway__requests_for_full_card_information.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_MasterPass_Samples_Subsequent_Express__precheckout__Express_Checkout_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_MasterPass_Samples_Subsequent_Express__precheckout__Express_Checkout_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_MasterPass_Samples_debit__debit__Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_MasterPass_Samples_debit__debit__Response_Successful.xml[]
----
