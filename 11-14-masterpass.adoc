...
payment. +
                                    . The {payment-gateway} will receive the credit card information
from _MasterPass_ and proceed with payment authorization with the
acquirer. +
                                    . The {payment-gateway} manages all interactions with
_MasterPass_.
...
. {payment-gateway} redirects consumers to _MasterPass_.
...
precheckout.
. {payment-gateway} requests consumers' preferred card and
shipping address (optional) from _MasterPass_.
. {payment-gateway} returns _precheckout_ information to
merchants.
...
express-checkout.
. {payment-gateway} requests for full card information
from _MasterPass_.
. {payment-gateway} returns the token and shipping address
(optional) information to merchants.
...
----
include::samples/xml/masterpass_request-checkout_request_success_pairing-and-checkout.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/masterpass_request-checkout_response_success_pairing-and-checkout.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/masterpass_request-checkout_request_success_pairing.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/masterpass_request-checkout_response_success_pairing.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/masterpass_request-checkout_notification_success_null.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/masterpass_request-checkout_request_success_express-checkout_37b24b99.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/masterpass_request-checkout_response_success_express-checkout_37b24b99.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/masterpass_debit_request_success_05e44225.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/masterpass_debit_response_success_05e44225.xml[]
----
