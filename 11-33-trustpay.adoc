...
[source,xml]
----
include::src-files/xml/TrustPay_Sample_debit_debit_Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/TrustPay_Sample_debit_debit_Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/TrustPay_Sample_debit_Success_Notification.xml[]
----
...
[source,xml]
----
include::src-files/xml/TrustPay_Sample_debit_debit_Request_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/TrustPay_Sample_debit_debit_Response_Failure.xml[]
----
...
[source,xml]
----
include::src-files/xml/TrustPay_Samples_SelectedGatewayTestPaySK_debit_Response_Failure.xml[]
----
