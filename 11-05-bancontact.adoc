[#Bancontact]
<<<<<<< HEAD:index/payment-methods/bancontact/rest/11-05-bancontact.adoc
<<<<<<< HEAD
== Bancontact

[#Bancontact_Introduction]
=== Introduction
[.clearfix]
--
[.right]
...
[#Bancontact_Introduction_HowtoIntegrate]
==== How to Integrate
