...
*It is strongly recommended to send this field with an adequate value in the request. If you provide this information, the transaction is most likely processed without Strong Customer Authentication (SCA).*
