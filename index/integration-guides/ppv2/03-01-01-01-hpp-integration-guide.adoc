...
----
include::{BASEDIR}/samples/json/PaymentPageSolutions_WPP_HPP_IntegrationExampleCreate_CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/PaymentPageSolutions_PaydooPPv2_HPP_IntegrationExampleCreate_CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/PaymentPageSolutions_WPP_HPP_IntegrationExampleRedirect_ResponseToAuthorizationRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/PaymentPageSolutions_WPP_HPP_IntegrationExampleParse_ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/PaymentPageSolutions_PaydooPPv2_HPP_IntegrationExampleParse_ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
