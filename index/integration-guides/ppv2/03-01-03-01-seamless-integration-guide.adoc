...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_SeamlessIntegrationExampleInitialRequest_CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_SeamlessIntegrationExampleParse_3DS_DecodedPaymentResponse.json[]
----
endif::[]
