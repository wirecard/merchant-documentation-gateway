...
----
include::{BASEDIR}/samples/json/WPP_SeamlessIntegrationExampleInitialRequest_CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/PaydooPPv2_SeamlessIntegrationExampleInitialRequest_CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SeamlessIntegrationExampleRender_ResponseToAuthorizationRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SeamlessIntegrationExampleParse_4ParseAndProcessThePaymentResponseHighlyRecommended.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SeamlessIntegrationExampleParse_3DS_DecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/PaydooPPv2_SeamlessIntegrationExampleParse_3DS_DecodedPaymentResponse.json[]
----
endif::[]
