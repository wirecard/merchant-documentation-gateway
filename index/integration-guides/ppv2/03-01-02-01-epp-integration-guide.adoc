...
[source,json,subs=attributes+]
----
include::{samples}/json/PaymentPageSolutions_PaydooPPv2_EPP_IntegrationExampleCreate_CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{samples}/json/PaymentPageSolutions_PaydooPPv2_EPP_IntegrationExampleParse_ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
