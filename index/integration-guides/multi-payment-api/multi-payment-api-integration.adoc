...
----
include::{BASEDIR}/samples/xml/MultiPaymentApiSamples_RequestPurchaseCreditCardAnd2Vouchers.xml[]
----

.Response Purchase Successful
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/MultiPaymentApiSamples_ResponsePurchaseSuccessful.xml[]
----

.Request Void-Refund-Purchase
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/MultiPaymentApiSamples_RequestVoidRefundPurchase.xml[]
----

.Response Void-Refund-Purchase: Voucher 2 failed, Voucher 1 Rolled Back
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/MultiPaymentApiSamples_RVRPV2fV1RB.xml[]
----
