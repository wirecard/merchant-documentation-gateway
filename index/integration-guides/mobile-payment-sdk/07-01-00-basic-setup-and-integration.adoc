...
----
include::/{base_dir}/samples/xml/MobilePaymentSDKBasicSetupAndroidManifest_MobilePaymentSDKBasicSetupAndroidAndroidStudioImportingThroughAndroidStudio.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/MobilePaymentSDKBasicSetupAndroidManifest.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/MobilePaymentSDKBasicSetupAndroidManifest_1.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/MobilePaymentSDKBasicSetupAndroidManifest_2.xml[]
----
