...
----
include::/{base_dir}/samples/xml/MobilePaymentSDKAndroidEmbeddedForm_ThenProvideYourCustomizedResources.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/MobilePaymentSDKAndroid_PBBA_ImportantNotes_WirecardResponseListenerInitialization.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/MobilePaymentSDKAndroid_PBBA_ImportantNotes_ExampleUsage.xml[]
----
+
