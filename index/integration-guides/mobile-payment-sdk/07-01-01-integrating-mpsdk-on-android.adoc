...
----
include::{BASEDIR}/samples/xml/MobilePaymentSDKAndroidEmbeddedForm_ThenProvideYourCustomizedResources.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/MobilePaymentSDKAndroid_PBBA_ImportantNotes_WirecardResponseListenerInitialization.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/MobilePaymentSDKAndroid_PBBA_ImportantNotes_ExampleUsage.xml[]
----
+
