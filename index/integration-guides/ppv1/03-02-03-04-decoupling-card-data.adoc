...
----
include::{base_dir}/samples/json/SeamlessDecouplingCardDataRenderForm_TransactionDataReceivedFromonSuccessCallbackOfseamlessRenderForm.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/SeamlessDecouplingCardDataSubmitForm_TransactionDataReceivedFromonSuccessCallbackOfseamlessSubmitForm.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/SeamlessDecouplingCardDataActualPayment_TransactionDataReceivedFromonSuccessCallbackOfseamlessPay.json[]
----
