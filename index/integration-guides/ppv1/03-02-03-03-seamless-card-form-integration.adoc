...
----
include::/{base_dir}/samples/json/SeamlessCardFormIntegrationRenderForm_TransactionDataReceivedFromonSuccessCallbackOfseamlessRenderForm.json[]
----
...
[source,json,subs=attributes+]
----
include::/{base_dir}/samples/json/SeamlessCardFormIntegrationSubmitForm_TransactionDataReceivedFromonSuccessCallbackOfseamlessSubmitForm.json[]
----
