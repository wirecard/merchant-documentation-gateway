...
----
include::{BASEDIR}/samples/json/SeamlessCardFormIntegrationRenderForm_TransactionDataReceivedFromonSuccessCallbackOfseamlessRenderForm.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/SeamlessCardFormIntegrationSubmitForm_TransactionDataReceivedFromonSuccessCallbackOfseamlessSubmitForm.json[]
----
