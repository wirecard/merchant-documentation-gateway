...
.2020-04-29
- <<ShopSystems, Shop Systems>> - New payment methods Alipay Cross-border, Guaranteed Invoice (Payolution B2B), Guaranteed Invoice (Payolution B2C), Payment In Advance, Payment On Invoice, and UnionPay International available for OXID.
