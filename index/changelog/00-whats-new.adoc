...
.2020-05-15
- <<CreditCard_3DS2_Exemption_Adviser, 3D Secure 2>> - Added "Grandfathering" to PSD 2 SCA Exemptions section.

//-

.2020-05-13
- <<BatchProcessingApi_Files_Specifications, Batch Processing Files>> - Updated formatting details in csv files.
- <<CreditCard_3DS2_Exemption_Adviser, 3D Secure 2>> - Updated PSD 2 SCA Exemptions section.

//-

.2020-05-07
- <<PPv2_Features_LimitCardBrands, Limit Credit Card Brands>> - New credit card feature available for {payment-page-v2}.
- <<PPv2_Features_OrderFilter, Order and Filter Payment Methods>> - New feature available for {payment-page-v2}.
