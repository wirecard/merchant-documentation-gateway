...
=== 2020-03
.2020-03-03
- <<CreditCard_3DS2, 3D Secure 2>> - Updated content structure of 3D Secure 2 general information.
- <<CreditCard_3DS2, 3D Secure 2>> - Updated content structure of general information on 3D Secure 2.
...
.2020-01-07
- <<KlarnaV2, Klarna Payments (Pay now, Pay later, Financing/Slice it)>> - New payment method available for <<invalid_ref, REST API>>.
