...
- <<3DS2_Worfklow, 3D Secure 2 Workflows>> - Updated structure of 3D Secure 2 Workflows section.
...
- <<API_Fields_xmlelements_cardEMV, ``card-emv``>> and <<API_Fields_xmlelements_ISO, ``iso``>> - New fields for card present transactions.
...
- <<paysafecard, paysafecard>> - New transaction type credit available for paysafecard with REST API.
