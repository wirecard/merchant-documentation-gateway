...
=== 2020-02
.2020-02-27
- <<GuaranteedInstallment, {payment-provider-name} Payment in Installments>> - New payment method available for REST API.
...
.2020-02-24
- <<doc.wirecard.com, doc.wirecard.com>> - Go live of new Home page for Wirecard Online Documentation.
