...
.2020-02-07
- <<API_PaymentInstallment, _{payment-provider-name} Payment in Installments_>> - New payment method available for REST API.
...
.2019-09-11
- <<PPv2_PaymentInstallment, {payment-provider-name} Payment in Installments with {payment-page-v2-abbr}>> - New payment method available for {payment-page-v2}.
...
.2019-08-13
- <<PPv2_PaymentDirectDebit, {payment-provider-name} Payment Guaranteed Direct Debit with {payment-page-v2-abbr}>> - New payment method available for {payment-page-v2}.
...
.2019-08-05
- <<PPv2_PaymentInvoice, {payment-provider-name} Payment on Invoice with {payment-page-v2-abbr}>> - New payment method available for {payment-page-v2}.
...
.2019-03-26
- <<ShopSystems, Shop Systems>> - New payment methods Alipay Cross-border, Guaranteed Invoice by payolution, {payment-provider-name} Payment on Invoice, Masterpass, Payment In Advance, Payment On Invoice, and UnionPay International available for Magento 1.
...
.2018-12-20
- <<API_PaymentInvoice, {payment-provider-name} Payment on Invoice>> - Removed Guaranteed Installments from REST API.

//-

.2018-12-18
- <<API_PaymentInvoice_ConsenttoGeneralTermsandConditions, {payment-provider-name} Payment on Invoice >> - Updated guidelines for General Terms and Conditions.
- <<API_PaymentDirectDebit_ConsenttoGeneralTermsandConditions, {payment-provider-name} Payment Guaranteed Direct Debit>> - Updated guidelines for General Terms and Conditions.
