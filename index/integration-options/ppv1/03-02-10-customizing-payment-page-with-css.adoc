...
{payment-page-v1} image:images/icons/legacy.svg[LEGACY, width="80px", title="Development of this product is discontinued."] can be customized through a feature called _Custom CSS URL_,
