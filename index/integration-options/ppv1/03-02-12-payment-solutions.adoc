...
----
include::{basedir}/samples/xml/creditcard_authorization_request_success_119235.xml[]
----

.XML authorization Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_authorization_response_success_1d5050.xml[]
----

.JSON authorization Request (Successful)
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/PPv1PaymentSolutionsPaybyLinkHyperlinkHowTo_JSON_AuthorizationRequestSuccessful.json[]
----

.JSON authorization Response (Successful)
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/PPv1PaymentSolutionsPaybyLinkHyperlinkHowTo_JSON_AuthorizationResponseSuccessful.json[]
----
