...
h|Payment Processing with _{payment-page-v1}_ image:images/icons/legacyProduct.svg[LEGACY, title="Development of this product is discontinued."] in Seamless Mode
a|.  Create a payment session (initial request).
