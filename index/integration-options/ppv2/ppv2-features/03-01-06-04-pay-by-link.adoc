...
|yyyy-MM-ddTHH:mm:ss±HH:mm |payment ({}) |Indicates the expiration time & date of the respective payment hyperlink.
|===
...
----
include::/{base_dir}/samples/json/PPv2FeaturesPaybyLink_ToSetTheExpirationStampForAPaymentLink.json[]
----
