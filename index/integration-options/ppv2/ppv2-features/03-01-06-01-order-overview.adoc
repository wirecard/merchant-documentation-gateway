...
----
include::/{base_dir}/samples/json/WPP_FeaturesOrderOverview_ToEnableOrderOverviewForAPayment.json[]
----
|
ifdef::env-wirecard[]
...
[source,json,subs=attributes+]
----
include::/{base_dir}/samples/json/WPP_FeaturesOrderOverviewDetailingOrderItems_JSON_ExampleForDetailingOrderItems.json[]
----
|
// ifdef::env-wirecard[]
