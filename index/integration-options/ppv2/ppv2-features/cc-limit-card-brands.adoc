...
Use the _Limit Credit Card Brands_ option to display only those credit card brands which you prefer to charge. Display, for example, a different set of credit card brands to consumers in different regions in the world. 
...
. Include the ``credit-card-brand-filter`` field to the payment request.
...
As a result, {payment-page-v2-abbr} displays only those credit card brands you entered in the array.
