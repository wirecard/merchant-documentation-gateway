...
. Include the ``payment-method-order-and-filter`` field to the payment request.
...
As a result, _{payment-page-v2-abbr}_ displays all the payment methods you offer, with your preferred ones first.
