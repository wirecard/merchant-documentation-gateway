...
----
include::{base_dir}/samples/json/WPP_ConfiguringRedirectsIPNsRedirectPagesRecap_Ttlidimcd.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_ConfiguringRedirectsIPNsIPNs_ExampleOf_IPN_ConfigurationInAPaymentRequest_JSON.json[]
----
