...
^.^a| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct_2.svg[LEGACY PRODUCT, width="3em", title="Development of this product is discontinued."] 
...
^s| {payment-page-v1}
^a| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct_2.svg[LEGACY PRODUCT, width=90, title="Development of this product is discontinued."]
