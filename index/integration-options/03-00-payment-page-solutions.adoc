...
== Payment Page Solutions image:images/icons/legacy.svg[LEGACY, 80, 20, role="no-zoom", title="Development of this product is discontinued."]
...
^.^a|  **{payment-page-v2}** 
^a| **{payment-page-v1}** image:images/icons/legacy.svg[LEGACY, 100, 25, role="no-zoom", title="Development of this product is discontinued."]
|
...
|===
|{set:cellbgcolor:#f8f8f8}
^.^a| **{payment-page-v2}** ^a| **{payment-page-v1}** image:images/icons/legacy.svg[LEGACY, 80, 30, role="no-zoom", title="Development of this product is discontinued."]
