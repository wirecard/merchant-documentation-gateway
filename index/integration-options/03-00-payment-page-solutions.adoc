...
^s| {payment-page-v1} image:images/icons/legacyProduct_label.png[LEGACY PRODUCT, width="20%", title="Development of this product is discontinued."] 
...
^s| {payment-page-v1} image:images/icons/legacyProduct_label.png[LEGACY PRODUCT, width="15%, "title="Development of this product is discontinued."]
^s| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct_3.svg[LEGACY PRODUCT, width="10%, title="Development of this product is discontinued."]
