...
.2+^.^h| **{payment-page-v2}** 
^h| **{payment-page-v1}** 
^h| image:images/icons/legacyProduct_label.png[LEGACY PRODUCT, width="60px", title="Development of this product is discontinued."] 
...
.2+^.^h| **{payment-page-v2}**
^h| **{payment-page-v1}** 
^s| image:images/icons/legacyProduct_label.png[LEGACY PRODUCT, width="70px", "title="Development of this product is discontinued."]
