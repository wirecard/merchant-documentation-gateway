...
image:images/icons/legacy.svg[LEGACY, 640, 480, pdfwidth=50%,scaledwidth=50%, title="Development of this product is discontinued."]
...
image:images/icons/sample_star.svg[star, width="80px", pdfwidth=10%,scaledwidth=20%, title="Development of this product is discontinued."]
