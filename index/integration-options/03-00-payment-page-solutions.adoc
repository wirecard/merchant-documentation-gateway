:env-wirecard:
include::C:\Users\dorothea.bartel\Repo\1483\merchant-documentation-gateway\shortcuts.adoc[]
...
image:images/icons/legacyProduct.svg[LEGACY PRODUCT] 
image:images/icons/legacyProduct_2.svg[LEGACY PRODUCT] 



image:C:\Users\dorothea.bartel\Repo\1483\merchant-documentation-gateway\images\icons\legacyProcuct.svg[]
...
^.^s| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct.png[LEGACY PRODUCT] 
...
^s| {payment-page-v1}
^s| {set:cellbgcolor:#a2aaad} [white]#LEGACY PRODUCT#  
