...
^s| {payment-page-v1} image:images/icons/legacyProcuct_label.png[LEGACY PRODUCT, title="Development of this product is discontinued."] 
...
^.^| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct.png[LEGACY PRODUCT, title="Development of this product is discontinued."] 
...
^s| {payment-page-v1} image:images/icons/legacyProcuct_label.png[LEGACYPRODUCT, title="Development of this product is discontinued."]
