...
^.^| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct.png[LEGACY PRODUCT, width="3em", title="Development of this product is discontinued."] 
...
^s| {payment-page-v1}
^s| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct.png[LEGACY PRODUCT, width="1em", title="Development of this product is discontinued."]
