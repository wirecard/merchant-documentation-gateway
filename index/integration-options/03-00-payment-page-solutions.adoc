...
|===
^.^h| **{payment-page-v2}** 
^h| **{payment-page-v1}** image:images/icons/legacyProduct_label.png[LEGACY PRODUCT, width="100px", title="Development of this product is discontinued."] 
...
h| 
^.^h| **{payment-page-v2}**
^h| **{payment-page-v1}** image:images/icons/legacyProduct_label.png[LEGACY PRODUCT, width="120px", "title="Development of this product is discontinued."]
