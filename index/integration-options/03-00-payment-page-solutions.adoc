...
^.^s| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct_2.svg[LEGACY PRODUCT, height="3em", title="Development of this product is discontinued."] 
...
^s| {payment-page-v1}
^s| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct_2.svg[LEGACY PRODUCT, height="1em", title="Development of this product is discontinued."]
