...
[grid=none]
|===
^.^| **{payment-page-v2}** ^| **{payment-page-v1}** image:images/icons/legacyProduct2.svg[LEGACY, title="Development of this product is discontinued."] 
...
|===
h| ^.^| **{payment-page-v2}** ^| **{payment-page-v1}** image:images/icons/legacyProduct2.svg[LEGACY, title="Development of this product is discontinued."]
