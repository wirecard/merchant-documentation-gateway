...
^.^| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct.png[LEGACY PRODUCT, width="90px", title="Development of this product is discontinued."] 
...
^s| {payment-page-v1}
^s| {set:cellbgcolor:#a2aaad} image:images/icons/legacyProduct.png[LEGACY PRODUCT, width="60px", title="Development of this product is discontinued."]
