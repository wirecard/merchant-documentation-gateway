...
.2+^.^h| **{payment-page-v2}** 
^h| **{payment-page-v1}** 
^h| image:images/icons/legacyProduct_label.png[LEGACY PRODUCT, width="30%", title="Development of this product is discontinued."] 
...
.2+^.^h| **{payment-page-v2}**
^h| **{payment-page-v1}** 
^s| image:images/icons/legacyProduct_label.png[LEGACY PRODUCT, width="25%, "title="Development of this product is discontinued."]
