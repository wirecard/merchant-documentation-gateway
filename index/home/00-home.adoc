...
* 5 March 2020: Update on test environment between 12:00 pm and 12:30 pm CET. +
link:{root}/resources/ssl-certificate/api-test.wirecard.com[Get your certificate for the test environment here]

* 10 March 2020: Update on production environment between 12:00 pm and 12:30 pm CET. +
link:{root}/resources/ssl-certificate/api.wirecard.com[Get your certificate for the production environment here]
