...
include::{root}/resources/ssl-certificate/api.wirecard.com[Certificate for Production Environment]

include::{root}/resources/ssl-certificate/api-test.wirecard.com[Certificate for Test Environment]
