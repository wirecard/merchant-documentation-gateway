...
link:resources/ssl-certificate/api-test-wirecard-com.cer[Get your certificate for the test environment here]

- 10 March 2020: Update on production environment between 12:00 pm and 12:30 pm CET. +
link:resources/ssl-certificate/api-wirecard-com.cer[Get your certificate for the production environment here]
|===
