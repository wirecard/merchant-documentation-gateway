...
include::{root}/resources/ssl-certificate/api.wirecard.com[Certificate for Production System]

include::{root}/resources/ssl-certificate/api-test.wirecard.com[Certificate for Test System]
