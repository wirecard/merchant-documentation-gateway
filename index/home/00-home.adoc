...
We are updating our SSL certificates on the test and production environments on 5 March (test environment) and 10 March 2020 (production environment) between 12:00 and 12:30 pm CET. To ensure end-to-end security ("certificate pinning"), <<ssl-certificates, download your SSL certificates>>.
