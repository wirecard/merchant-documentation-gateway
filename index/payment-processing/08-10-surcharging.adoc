...
----
include::{basedir}/samples/xml/GeneralPlatformFeatures_Surcharging_CalculateFee_request.xml[]
----

.XML Response
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/GeneralPlatformFeatures_Surcharging_CalculateFee_response.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/GeneralPlatformFeatures_Surcharging_request.xml[]
----

.XML Response
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/GeneralPlatformFeatures_Surcharging_response.xml[]
----
