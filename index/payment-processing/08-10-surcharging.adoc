...
Surcharging is a feature for <<PP, {payment-page-v1}>> image:images/icons/legacyProduct.svg[LEGACY, title="Development of this product is discontinued."]  (HPP and EPP) and
<<RestApi, REST API>>.
...
- <<PP, {payment-page-v1}>> image:images/icons/legacyProduct.svg[LEGACY, title="Development of this product is discontinued."]
