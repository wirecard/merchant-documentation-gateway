...
|request-id |M |String| 150 a| Unique identifier assigned to every request (by the merchant). Used when searching for or referencing it later. _{{$guid}}_ serves as a placeholder for a random request-id. Allowed characters: +
a - z +
0 - 9 +
-_
