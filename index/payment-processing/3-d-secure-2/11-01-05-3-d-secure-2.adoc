...
[cols=",,", stripes=none]
|===
a|image::images/icons/3dsecure.png[3dsecure_icon, width=15%]
...
a|image::images/icons/integration.png[integration_icon, width=15%]
...
a|image::images/icons/processing.png[processing_icon, width=15%]
<<API_CC_3DS2_UseCases, *3D Secure 2 Use Cases*>>

a|image::images/icons/speechbubble.png[speechbubble_icon, width=15%] 
https://www.wirecard.com/3d-secure-2/#faq[*FAQs about 3D Secure 2*]

a|image::images/icons/latest-news.png[latest-news_icon, width=15%]
