...
- <<CreditCard_PSD2_SCA, *What is Strong Customer Authentication?*>> +
...
When 3D Secure 1 was first introduced, it provided a
...
Authentication (SCA) requirements set by the https://ec.europa.eu/info/law/payment-services-psd-2-directive-eu-2015-2366_en[EU's Second Payment Service Directive (PSD 2)] for online payments within the European Economic Area (EEA).
