...
<<CreditCard_PaymentFeatures_3DSecure, *From 3D Secure to 3D Secure 2*>> +
...
a|image::images/icons/credit_card_processing.png[credit_card_processing_icon, align="center", width=15%]
...
| To learn more about how you can benefit from implementing 3D Secure 2, watch our webinar https://www.wirecard.com/3d-secure-2/#reasons[Understanding 3D Secure 2: Boosting conversion and security in parallel].
|===
