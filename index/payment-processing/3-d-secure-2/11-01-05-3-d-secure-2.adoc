...
a|image::images/icons/integration.png[integration_icon, width=18%]
- <<3DS2_IntegrationGuide, *General Integration Guide*>> +
//* <<3DS2_IntegrationGuide_REST, *3D Secure 2 for REST API*>> +
- <<3DS2_Testing, *Testing*>> +
- <<3DS2_Fields, *Fields*>> +
- <<3DS2_Worfklow, *Workflows*>>

//-

a|image::images/icons/processing.png[processing_icon, width=18%]
<<API_CC_3DS2_UseCases, *3D Secure 2 Use Cases*>>

a|image::images/icons/speechbubble.png[speechbubble_icon, width=18%] 
https://www.wirecard.com/3d-secure-2/#faq[*FAQs about 3D Secure 2*]

a|image::images/icons/latest-news.png[latest-news_icon, width=18%]
...
As a result, the https://www.emvco.com/about/overview/[EMVCo] have devised a new standard authentication method for payment card transactions: *3D Secure 2 (3DS2).* 

This state-of-the-art protocol fulfills the <<CreditCard_PSD2_SCA, Strong Customer Authentication (SCA)>> requirements set by the https://ec.europa.eu/info/law/payment-services-psd-2-directive-eu-2015-2366_en[EU's Second Payment Service Directive (PSD 2)] for online payments within the European Economic Area (EEA).
...
As with 3DS1, 3D Secure 2 also protects the merchant from <<3DSecureLiabilityShift, liability in cases of fraud>>.

[cols="15,85", stripes=none]
|===
a|image::images/icons/movie.png[movie_icon, align="center", vertical-align="center", width=48%] 
...
//include::{root}/index/payment-processing/3-d-secure-2/3-d-secure-2-liability-shift.adoc[leveloffset=+2]
