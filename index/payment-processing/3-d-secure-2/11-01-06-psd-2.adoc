...
[cols=",,"]
|===
a|image::images/icons/pin.png[pin_icon, align="center", width=15%]
a|image::images/icons/smartphone.png[smartphone_icon, align="center", width=15%]
a|image::images/icons/face-id.png[face-id_icon, align="center", width=15%]
