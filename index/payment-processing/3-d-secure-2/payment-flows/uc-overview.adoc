...
.2+a|Delayed Shipment | <<API_CC_3DS2_UC_delayed-shipment_expect, Expected Delay>> a| NOTE: This use case can be used if the expected delay does not exceed 90 days. 
