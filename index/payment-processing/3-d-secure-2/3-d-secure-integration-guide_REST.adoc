...
ifdef::env-wirecard[]
include::{root}/include/API_3Dtestcredentials_manual.adoc[]
include::{root}/include/API_3Dtestcredentials_automatic.adoc[]
include::{root}/include/API_3Dtestcredentials_nongamblingOCT.adoc[]
endif::[]

ifdef::env-po[]
include::{rood}/include/API_3Dtestcredentials_po.adoc[]
endif::[]
