...
NOTE: --- Note to detailed workflow and different business scenarios / use cases ---
...
ifdef::env-wirecard[]
include::{root}/include/3DSecure/API_3Dtestcredentials_manual.adoc[]
include::{root}/include/3DSecure/API_3Dtestcredentials_automatic.adoc[]
include::{root}/include/3DSecure/API_3Dtestcredentials_nongamblingOCT.adoc[]
endif::[]

ifdef::env-po[]
include::{rood}/include/3DSecure/API_3Dtestcredentials_po.adoc[]
endif::[]
...
//tag::xy[]
[#3DS2_IntegrationGuide_REST_Samples_TestCards]
==== Test Cards
--- include von Credit Card ---
//end::xy[]
