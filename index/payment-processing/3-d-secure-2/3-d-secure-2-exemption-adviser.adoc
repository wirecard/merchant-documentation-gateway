...
Certain types of transactions may be exempted from Strong Customer Authentication even if they fall within the scope of PSD 2. It is up to your bank/acquirer to request these exemptions for you.
...
[NOTE]
====
The issuer can apply this exemption even if you or your acquirer did not request for it. In suche cases the chargeback liability shifts to the issuer.
====
...
- If an exemption is applied by merchants and their acquirer (e.g. the merchant decides to avoid a challenge), the liability generally remains with the merchant.
