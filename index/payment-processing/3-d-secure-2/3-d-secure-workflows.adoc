...
- *Frictionless Flow:* The information provided is sufficient. No further authentication / cardholder interaction required. This is typically the case for low-value and low-risk transactions.
