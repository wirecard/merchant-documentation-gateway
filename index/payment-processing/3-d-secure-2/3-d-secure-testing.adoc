...
Use https://www.postman.com/postman[Postman] to run the collection. Our samples work with https://webhook.site[Webhook.site] to simulate the ACS URL and to obtain the PARes. 

Need more information on how to use Postman to test our samples or to integrate Webhook.site in a test setup? Go to our <<3DS2_IntegrationGuide_REST_PostmanCollection, General Integration Guide page for REST API>>.
