...
Use https://www.postman.com/postman[Postman] to run the collection. Work with https://webhook.site[Webhook.site] to simulate the ACS URL where the consumer will be redirected to for authentication. Need more information on how to use Postman and Webhook.site to test our samples? Go to our <<3DS2_IntegrationGuide_REST_PostmanCollection, General Integration Guide page for REST API>>.
