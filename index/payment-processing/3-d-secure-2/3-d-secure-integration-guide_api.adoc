...
Download the link:resources/3-d-secure-2/usecase_pm-collection/one-time-payment.postman_collection.json[3DS2 postman collection for a one-time payment transaction]. 
