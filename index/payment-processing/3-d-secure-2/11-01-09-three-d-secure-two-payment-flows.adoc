...
include::{root}include/3DSecure/3-d-secure-2-authentication-transactions.adoc[]

include::{root}include/3DSecure/3-d-secure-2-purchase-transaction.adoc[]
...
include::{root}include/3DSecure/3-d-secure-2-authorization-transaction.adoc[]

include::{root}include/3DSecure/3-d-secure-2-capture-authorization-transaction.adoc[]
