...
For 3D Secure 2, more 3D-Secure-specific fields have to be included than for 3D Secure 1.  3D-Secure-2-specific fields can be found in the <<CreditCard_3DS2_Fields, 3D Secure 2 field table>>. They are also included in the <<Appendix_Xml, REST API payment XSD>>.
