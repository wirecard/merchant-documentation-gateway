...
The consumer interacts with an agent that is selling another merchant's product or service. Payments are triggered by merchants. An example would be an online travel agency.

WARNING: Agents must clearly inform consumers that their cards will be charged by merchants and not by the agents.
