...
pass:[<a href="resources/3-d-secure-2/usecase_pm-collection/one-time-payment-option-one.postman_collection.json" target="_blank" rel="noreferrer noopener" download>Download a Postman collection for this use case option here.</a>] 
...
pass:[<a href="resources/3-d-secure-2/usecase_pm-collection/one-time-payment-option-two.postman_collection.json" target="_blank" rel="noreferrer noopener" download>Download a Postman collection for this use case option here.</a>] 
