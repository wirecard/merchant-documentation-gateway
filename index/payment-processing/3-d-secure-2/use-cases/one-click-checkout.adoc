...
pass:[<a href="resources/3-d-secure-2/usecase_pm-collection/one-click-checkout_independend_of_payment.postman_collection.json" target="_blank" rel="noreferrer noopener" download>Download a Postman collection for this use case here.</a>] 
...
pass:[<a href="resources/3-d-secure-2/usecase_pm-collection/one-click-checkout_during_payment.postman_collection.json" target="_blank" rel="noreferrer noopener" download>Download a Postman collection for this use case here.</a>] 
