...
pass:[<a href="resources/3-d-secure-2/usecase_pm-collection/general-multi-party-commerce.postman_collection.json" target="_blank" rel="noreferrer noopener" download>Download a Postman collection for this use case here.</a>]
