...
Recurring transactions are processed at regular intervals, with the same, recurring amount. When you set up a recurring agreement, the first payment is consumer-initiated and therefore requires Strong Customer Authentication. All succeeding payments are merchant-initiated transactions that do not need SCA.
