...
----
include::/{base_dir}/samples/xml/GeneralPlatformFeatures_IPP_InstallmentCalculatorSamples_InstallmentCalculatorSampleRequest.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/GeneralPlatformFeatures_IPP_InstallmentCalculatorSamples_InstallmentCalculatorSampleResponse.xml[]
----
