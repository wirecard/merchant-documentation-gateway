...
----
include::{basedir}/samples/xml/GeneralPlatformFeatures_IPP_InstallmentCalculatorSamples_InstallmentCalculatorSampleRequest.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/GeneralPlatformFeatures_IPP_InstallmentCalculatorSamples_InstallmentCalculatorSampleResponse.xml[]
----
