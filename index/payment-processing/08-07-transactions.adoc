...
|``\https://{rest-api-test-endpoint}/{merchant-account-id}/payments/{transaction-id}``
|===
...
``\https://{rest-api-test-endpoint}/merchants/ba261be8-af94-11df-ab7800163e5eafd7/payments/048b27e0-9c31-4cab-9eab-3b72b1b4d498``
