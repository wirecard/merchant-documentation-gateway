...
----
include::{BASEDIR}/samples/xml/GeneralPlatformFeaturesRetrieveTransactionRequestIDCategorySampleResponse_GeneralRequestSampleForRedirect_URL.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/GeneralPlatformFeaturesTransactionsStoring.xml[]
----
