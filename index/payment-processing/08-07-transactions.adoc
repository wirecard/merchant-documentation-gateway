...
----
include::{base_dir}/samples/xml/GeneralPlatformFeaturesRetrieveTransactionRequestIDCategorySampleResponse_GeneralRequestSampleForRedirect_URL.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/GeneralPlatformFeaturesTransactionsStoring.xml[]
----
