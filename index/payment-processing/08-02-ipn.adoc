...
----
include::/{base_dir}/samples/xml/generic_debit_notification__96ffdc.xml[]
----
...
----
include::/{base_dir}/samples/json/GeneralPlatformFeatures_IPN_Json_JSON_Notification.json[]
----

.application/JSON-signed Notification Example
[source,json,subs=attributes+]
----
include::/{base_dir}/samples/json/GeneralPlatformFeatures_IPN_Json_applicationJSONSignedNotificationExample.json[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/creditcard_purchase_notification_.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/generic_debit_request__edeec5.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/GeneralPlatformFeatures_IPN_NotificationExamples_CreditCardPayment.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/generic_debit_notification__596c76.xml[]
----
