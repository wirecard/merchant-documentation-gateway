...
| link:resources/ssl-certificate/api-test-wirecard-com.cer[Download,window=_blank]
|===
...
|  *Get your new certificate:*
| link:resources/ssl-certificate/api-wirecard-com.cer[Download,window=_blank]
|===
