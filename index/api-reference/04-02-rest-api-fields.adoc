...
These tables list all fields used with _{payment-gateway}_
REST API. 
[#API_Fields_MO]
...
[#API_Fields_xmlelements_payment]
==== payment
...
| String 
| 256 
| The URL to which the consumer will be redirected after completion of a payment regardless of the transaction-state. This is normally a page on the merchant's website. 
ifdef::env-wirecard,env-nova[]
[NOTE]
``redirect-url`` is optional if the payment method is not based on a redirect (e.g. SEPA).
endif::[]

include::include/fields/api/response/res-api-payment.adoc[]

//include::include/fields/rest_cc/request/req-payment-parents.adoc[]

|===


[#API_Fields_xmlelements_paymentmethod]
==== payment-methods.payment-method

include::include\fields\rest_cc\request\req-payment-method.adoc[]


[#API_Fields_xmlelements_accountholder]
==== account-holder
...
[cols="m,,,,a"]
|===
| Field | <<API_Fields_MO, M/O>> | Datatype | Size | Description

include::include/fields/rest_cc/request/req-account-holder.adoc[]

|===

[#API_Fields_xmlelements_accountinfo]
==== account-holder.account-info

``account-info`` fields are used with 3D Secure 2. With ``account-info`` you can gather detailed information about the consumer. Provide all the ``account-info`` data in your 3D Secure 2 request to facilitate fraud prevention.

include::include/fields/rest_cc/request/req-account-info.adoc[]


[#API_Fields_xmlelements_address]
==== address

``address`` is a child of

* <<API_Fields_xmlelements_accountholder, account-holder>>.
* <<API_Fields_xmlelements_shipping, shipping>>.
ifndef::env-nova[]
* <<API_Fields_xmlelements_airlineindustry, airline-industry>>. 
endif::[]
...
[#API_Fields_xmlelements_shipping]
==== shipping

``shipping`` is a child of
<<API_Fields_xmlelements_payment, payment>>.
...
[#API_Fields_xmlelements_card]
==== card

include::include/fields/api/request/req-card.adoc[]


[#API_Fields_xmlelements_cardToken]
==== card-token

include::include/fields/rest_cc/request/req-card-token.adoc[]


[#API_Fields_xmlelements_bankAccount]
==== bank-account

include::include/fields/api/request/req-bankAccount.adoc[]


[#API_Fields_xmlelements_orderItem]
==== order-items.order-item

include::include/fields/api/request/req-orderItem.adoc[]


[#API_Fields_xmlelements_mandate]
==== mandate

include::include/fields/api/request/req-mandate.adoc[]


[#API_Fields_xmlelements_notification]
==== notifications.notification

include::include/fields/rest_cc/request/req-notification.adoc[]


[#API_Fields_xmlelements_3D]
==== three-d
...
[#API_Fields_xmlelements_device]
==== device

include::include/fields/rest_cc/request/req-device.adoc[]


[#API_Fields_xmlelements_device_renderOptions]
==== device.render-options

include::include/fields/api/request/req-device-RenderOptions.adoc[]


[#API_Fields_xmlelements_device-SDK]
==== device.SDK

include::include/fields/api/request/req-device-SDK.adoc[]


[#API_Fields_xmlelements_browser]
==== browser

include::include/fields/rest_cc/request/req-browser.adoc[]


[#API_Fields_xmlelements_customFields]
==== custom-fields.custom-field

include::include/fields/rest_cc/request/req-custom-field.adoc[]


[#API_Fields_xmlelements_periodic]
==== periodic

include::include/fields/rest_cc/request/req-periodic.adoc[]


[#API_Fields_xmlelements_riskInfo]
==== risk-info

include::include/fields/rest_cc/request/req-risk-info.adoc[]


[#API_Fields_xmlelements_giftCard]
==== risk-info.gift-cards.gift-card

include::include/fields/rest_cc/request/req-risk-info-gift-cards.adoc[]


[#API_Fields_xmlelements_cryptogram]
==== cryptogram

include::include/fields/api/request/req-cryptogram.adoc[]


ifndef::env-nova[]
[#API_Fields_xmlelements_surcharge]
==== surcharge

include::include/fields/api/response/res-surcharge.adoc[]
endif::[]
...
include::include/fields/api/response/res-status.adoc[]


ifndef::env-nova[]

[#API_Fields_xmlelements_airline]
==== airline-industry
...
| carrier-code | O | String | 3 | The airline code assigned by IATA.
| agent-code | O | String | 8 | The agency code assigned by IATA.
| travel-package-type-code | O | String | 10	| This indicates if the package includes car rental, airline flight, both or neither. +
Accepted values: +
...
| lodging-check-in-date | O | Date | n/a | The cruise departure date also known as the sail date.
| lodging-check-out-date | O | Date | n/a | The cruise return date also known as the sail end date.
| lodging-room-rate	| O	| Numeric	| n/a	| The total cost of the cruise.
| number-of-nights | O | Short | 3 | The length of the cruise in days.
| lodging-name | O | String	| 100	| The ship name booked for the cruise.
...
ifndef::env-nova[]
[#API_Fields_xmlelements_response_avs]
.avs

``avs`` is a child of
<<API_Fields_xmlelements_response_payment, payment>>.
