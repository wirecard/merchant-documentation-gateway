...
[source,html]
----
include::{basedir}/samples/html/AppendixI_FAQ_HtmlInsteadOfXmlResponse_WsaqtIagtHrbbwlitbif.html[]
----
...
----
include::{basedir}/samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Request.xml[]
----
+
.Response
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_referenced-authorization_response_.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Request_9.xml[]
----
+
.Response
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Response_10.xml[]
----
