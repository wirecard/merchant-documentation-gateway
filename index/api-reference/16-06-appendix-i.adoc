...
[source,html]
----
include::{base_dir}/samples/html/AppendixI_FAQ_HtmlInsteadOfXmlResponse_WsaqtIagtHrbbwlitbif.html[]
----
...
----
include::{base_dir}/samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Request.xml[]
----
+
.Response
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/creditcard_referenced-authorization_response_.xml[]
----
+
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Request_9.xml[]
----
+
.Response
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/AppendixI_FAQ_SubmitRecurringAuthorizationRequest_Response_10.xml[]
----
