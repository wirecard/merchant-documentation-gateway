...
----
include::{BASEDIR}/samples/xml/ratepay-elv_authorization_request_success_de.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_authorization_response_success_de.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_capture-authorization_request_success_f1ed56d2.xml[]
----

.XML capture-authorization Response (Successful)
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_capture-authorization_response_success_de_f1ed56d2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_refund-capture_request_success_674f05af.xml[]
----

.XML refund-capture Response (Successful)
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_refund-capture_response_success_de_674f05af.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_credit_request_success_f1ed56d2.xml[]
----

.XML credit Response (Successful)
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_credit_response_success_de_f1ed56d2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_void-authorization_request_success_f1ed56d2.xml[]
----

.XML void-authorization Response (Successful)
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_void-authorization_response_success_de_f1ed56d2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ratepay-elv_authorization_unknown__de.xml[]
----
