...
[%autowidth, cols="m,,,,,,,"]
|===
4+|Field |<<APIRef_FieldDefs_DataTypes, Data Type>> |<<APIRef_FieldDefs_Cardinality, M/O>> |Size |Description
...
[%autowidth]
|===
4+|Field (JSON) |<<APIRef_FieldDefs_DataTypes, Data Type>> |Description
...
IMPORTANT: Check the REST API <<GuaranteedDirectDebit, _Guaranteed Direct Debit_ specification>> for details on _Guaranteed Direct Debit_-specific post-processing operations.
