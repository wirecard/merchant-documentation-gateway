...
IMPORTANT: Check the REST API <<GuaranteedDirectDebit, _{payment-method-name}_ specification>> for details on _{payment-method-name}_ -specific post-processing operations.
