...
<<KlarnaV2_Main, Klarna{nbsp}Bank{nbsp}Transfer>>

<<KlarnaV2_Main, Klarna{nbsp}Debit>>

<<Maybank2u_Main, Maybank2u>>

<<MoipPagamentos_Main, moip Pagamentos>>
...
<<GuaranteedDirectDebit_Main, Guaranteed Direct Debit by Wirecard>>

<<GuaranteedInstallment_Main, Guaranteed Installment by Wirecard>>

<<GuaranteedInvoice_Main, Guaranteed Invoice by Wirecard>>

<<Klarna_Main, Klarna Services>>

<<KlarnaV2_Main, Klarna{nbsp}Pay{nbsp}later>>

<<KlarnaV2_Main, Klarna{nbsp}Financing (Slice it)>>

<<POIPIA_Main, Payment on Invoice (POI)/Payment in Advance (PIA)>>
endif::[]

<<SEPACreditTransfer_Main, SEPA Credit Transfer>>

<<SEPADirectDebit_Main, SEPA Direct Debit>>
...
|<<WirecardVoucher_Main, Wirecard Voucher>>
endif::[]
...
ifndef::env-nova[]
<<SkrillDigitalWallet_Main, Skrill Digital Wallet>>
