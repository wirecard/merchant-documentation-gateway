...
Interac is a secure Canadian online payment solution. Interac enables consumers to make payments using their online banking services. 
...
[source,xml]
----
include::/{base_dir}/samples/xml/InteracSamplesRestApiDebit_DebitRequestSuccessful.xml[]
----

.XML debit Response (Successful)
[source,xml]
----
include::/{base_dir}/samples/xml/InteracSamplesRestApiDebit_DebitResponseSuccessful.xml[]
----

.XML debit Request (Failed)
[source,xml]
----
include::/{base_dir}/samples/xml/InteracSamplesRestApiDebit_DebitRequestFailed.xml[]
----

.XML debit Response (Failed)
[source,xml]
----
include::/{base_dir}/samples/xml/InteracSamplesRestApiDebit_DebitResponseFailed.xml[]
----
