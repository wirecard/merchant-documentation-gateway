...
[source,xml]
----
include::{BASEDIR}/samples/xml/InteracSamplesRestApiDebit_DebitRequestSuccessful.xml[]
----

.XML debit Response (Successful)
[source,xml]
----
include::{BASEDIR}/samples/xml/InteracSamplesRestApiDebit_DebitResponseSuccessful.xml[]
----

.XML debit Request (Failed)
[source,xml]
----
include::{BASEDIR}/samples/xml/InteracSamplesRestApiDebit_DebitRequestFailed.xml[]
----

.XML debit Response (Failed)
[source,xml]
----
include::{BASEDIR}/samples/xml/InteracSamplesRestApiDebit_DebitResponseFailed.xml[]
----
