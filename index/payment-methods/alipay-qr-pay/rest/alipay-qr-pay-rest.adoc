...
[%autowidth, stripes=none]
|===
|Field |<<APIRef_FieldDefs_Cardinality, M/O>> |Size |Description

|@field-name[alipay_buyer_login_id]
|Notification only
|128
