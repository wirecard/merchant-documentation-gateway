...
|get-url
|<<API_AlipayQRPay_Samples_geturl, _get-url_ samples>>

|check-signature
|

|debit
|<<API_AlipayQRPay_Samples_debit, _debit_ samples>>
...
|===
.2+h|URL(s) Endpoints |For transaction types _get-url_, _debit_ and _void-debit_ |``\https://api-test.wirecard.com/engine/rest/paymentmethods/``
...
[source,xml,subs=attributes+]
----
include::{root}/samples/xml/alipay-qr-pay_debit-response_success.xml[]
----
