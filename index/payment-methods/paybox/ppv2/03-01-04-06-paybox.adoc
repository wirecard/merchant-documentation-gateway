...
----
include::{basedir}/samples/json/WPP_PayboxTransactionTypePurchase_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PayboxTransactionTypePurchaseRedirect_2RtCttPPSRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PayboxTransactionTypePurchaseRedirect_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PayboxTransactionTypeAuthorization_1CreateAnAuthorizationRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PayboxTransactionTypeAuthorization_3PaPtaRDPR.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PayboxJSONNVPFieldsRequest_JSON_StructureForPayboxRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PayboxJSONNVPFieldsRequest_ResponseOnlyFields.json[]
----
