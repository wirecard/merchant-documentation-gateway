...
----
include::{base_dir}/samples/xml/sofortbanking_get-url_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sofortbanking_get-url_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sofortbanking_get-url_request_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sofortbanking_get-url_response_failure.xml[]
----
