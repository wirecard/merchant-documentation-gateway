...
----
include::{basedir}/samples/json/WPP_SofortTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_SofortTransactionTypeDebit_2RtCttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_SofortTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_Sofort_JSON_NVPFields_JSON_StructureForSofortRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_Sofort_JSON_NVPFieldsRequest_ResponseOnlyFields.json[]
----
