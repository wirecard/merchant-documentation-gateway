...
Each field is a child of ``hotel-industry`` and mandatory for business type "Hotel Industry".
...
Each field is a child of ``airline-industry.itinerary.segment`` and mandatory for business type "Airlines".
...
Child of ``custom-fields.custom-field``. 
...
Each field is a child of ``order-items.order-item`` and mandatory for business type "Sales of Goods".
