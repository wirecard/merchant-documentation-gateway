...
----
include::{base_dir}/samples/xml/alipay-xborder_debit_request_success_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/alipay-xborder_debit_response_success_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/alipay-xborder_refund-debit_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/alipay-xborder_refund-debit_response_success_en_a9bbf42e.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/alipay-xborder_authorization-only_request_success_recurring_first.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/alipay-xborder_get-url_response_success_recurring_first.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/alipay-xborder_debit_request_success_recurring_recurring_649cb805.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/alipay-xborder_get-url_response_success_en_recurring_recurring_649cb805.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/alipay-xborder_authorization-only_request_success_recurring_final_f704f0a9.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/alipay-xborder_authorization-only_response_success_recurring_final_f704f0a9.xml[]
----
