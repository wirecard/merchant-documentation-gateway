...
----
include::{base_dir}/samples/json/WPP_AlipayCrossborderTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_AlipayCrossborderTransactionTypeDebit_2RtCttPPIDR.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_AlipayCrossborderTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_AlipayCrossborder_JSON_NVPField_JSON_StructureForAlipayCrossBorderDebitRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_AlipayCrossborder_JSON_NVPField_JSfACbdR.json[]
----
