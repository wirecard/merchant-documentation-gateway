...
----
include::{basedir}/samples/xml/WirecardVoucherFields.xml[]
----
...
----
include::{basedir}/samples/json/WirecardVoucherFields.json[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_purchase_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_purchase_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/WirecardVoucherSamplesPurchase_VoidPurchaseRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_void-purchase_response_success_d424b4b8.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_reserve_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_reserve_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/WirecardVoucherSamplesReserve_VoidReserveRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_void-reserve_response_success_83666ab6.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_redeem_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_redeem_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/WirecardVoucherSamplesRedeem_CancelRedeemRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_cancel-redeem_response_success_2bf67fc0.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/WirecardVoucherSamplesRedeem_VoidCancelRedeemRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/voucher_void-cancel-redeem_response_success_75bd223e.xml[]
----
