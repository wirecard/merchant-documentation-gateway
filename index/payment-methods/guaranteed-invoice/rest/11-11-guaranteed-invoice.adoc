...
----
include::{basedir}/samples/xml/ratepay-invoice_authorization_request_success_nl.xml[]
----

.XML authorization Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_authorization_response_success_nl.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_capture-authorization_request_success_32783284.xml[]
----

.XML capture-authorization Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_capture-authorization_response_success_nl_32783284.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_credit_request_success_32783284.xml[]
----

.XML credit Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_credit_response_success_nl_32783284.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_refund-capture_request_success_789b1a74.xml[]
----

.XML refund-capture Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_refund-capture_response_success_nl_789b1a74.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_void-authorization_request_success_32783284.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_void-authorization_response_success_nl_32783284.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/ratepay-invoice_authorization_unknown_.xml[]
----
