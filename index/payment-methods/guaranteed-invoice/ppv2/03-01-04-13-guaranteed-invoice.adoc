...
include::{BASEDIR}/include/ppv2-general-information-2.adoc[]
...
----
include::{BASEDIR}/samples/json/PPv2GuaranteedInvoiceTransactionTypeAuthorizationRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/PPv2GuaranteedInvoiceTransactionTypeAuthorizationRedirectURL.json[]
----
...
----
include::{BASEDIR}/samples/json/PPv2GuaranteedInvoiceTransactionTypeAuthorizationResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/PPv2GuaranteedInvoice_JSONNVP_FieldReference_JSON_StructureForGuaranteedInvoiceRequests.json[]
----
...
[source,json]
----
include::{BASEDIR}/samples/json/PPv2GuaranteedInvoice_JSON_NVPFieldsRequest_ResponseOnlyFields.json[]
----
