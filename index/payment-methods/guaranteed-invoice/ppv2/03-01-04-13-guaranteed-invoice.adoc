...
3+m|date-of-birth |String |Required |n/a |Consumer's date of birth. {payment-provider-name} validates the consumer's age to check if they are eligible for payment with _{payment-provider-name} Payment on Invoice_.
