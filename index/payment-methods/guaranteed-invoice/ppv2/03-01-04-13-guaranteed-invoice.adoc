...
[cols="m,,,,,,,"]
|===
4+|Field (JSON) |<<APIRef_FieldDefs_DataTypes, Data Type>> |<<APIRef_FieldDefs_Cardinality, M/O>> |Size |Description
...
3+m|date-of-birth |String |Mandatory |n/a |Consumer's date of birth. {payment-provider-name} validates the consumer's age to check if they are eligible for payment with Guaranteed Invoice.
...
[%autowidth, cols="m,v,"]
|===
|Field (JSON) |<<APIRef_FieldDefs_DataTypes, Data Type>> |Description
...
[cols="m,,,,"]
|===
3+|Field (JSON) |<<APIRef_FieldDefs_DataTypes, Data Type>> |Description
