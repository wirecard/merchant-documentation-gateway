...
----
include::{basedir}/samples/xml/cimbclicks_debit_request_success_en.xml[]
----

.debit Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/cimbclicks_debit_response_success_en.xml[]
----

.debit Notification (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/cimbclicks_debit_notification_success.xml[]
----
