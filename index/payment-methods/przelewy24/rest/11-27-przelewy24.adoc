...
----
include::{BASEDIR}/samples/xml/p24_debit_request_success.xml[]
----

.debit Response (Successful)
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/p24_debit_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/p24_refund-request_request_success_77e8f783.xml[]
----

.refund-request Response (Successful)
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/p24_refund-request_response_success_77e8f783.xml[]
----
