...
----
include::/{base_dir}/samples/json/WPP_P24_TransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::/{base_dir}/samples/json/WPP_P24_TransactionTypeDebit_2RtCttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::/{base_dir}/samples/json/WPP_P24_TransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::/{base_dir}/samples/json/WPP_P24_JSON_NVPFields_JSON_StructureFor_P24_Requests.json[]
----
...
[source,json,subs=attributes+]
----
include::/{base_dir}/samples/json/WPP_P24_JSON_NVPFieldsRequest_ResponseOnlyFields.json[]
----
