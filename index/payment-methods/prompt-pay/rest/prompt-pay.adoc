...
. {payment-gateway} sends you the QR code as URL for {payment-provider-name} Hosted Payment Page (HPP) (field ``payment-method url``) and base64-encoded in the field ``qr-code``.
