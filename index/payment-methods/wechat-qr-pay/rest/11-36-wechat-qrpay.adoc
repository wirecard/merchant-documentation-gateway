...
_WeChat QR Pay_ allows merchants to generate a QR code which is then
...
This table illustrates which payment mode _WeChat QR Pay_ belongs to. It
also provides detailed information about the countries and currencies
which are relevant for _WeChat QR Pay_.
...
----
include::/{base_dir}/samples/xml/wechat-qrpay_debit_request_success.xml[]
----

.XML get-url Response (Successful)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_get-url_response_success.xml[]
----

.XML get-url Notification (Successful)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_get-url_notification_success.xml[]
----

.XML debit Request (Failure)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_debit_request_failure.xml[]
----

.XML get-url Response (Failure)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_get-url_response_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_refund-debit_request_success_{from.xml[]
----

.XML refund-debit Response (Successful)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_refund-request_response_success_cb0c0b5f.xml[]
----

.XML refund-debit Notification (Successful)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_refund-request_notification_success_cb0c0b5f.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_void-debit_request_success_{from.xml[]
----

.XML void-debit Response (Successful)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_void-debit_response_success_6e9e80d9.xml[]
----

.XML void-debit Notification (Successful)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/wechat-qrpay_void-debit_notification_success_6e9e80d9.xml[]
----
