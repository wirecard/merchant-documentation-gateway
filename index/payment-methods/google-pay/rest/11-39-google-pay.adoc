...
{payment-provider-name} lets you take advantage of fast, cashless payments for products and services via a mobile device with Google Pay™. +
Google Pay™ is a fast, simple way to pay at millions of places - on sites, in apps, and in stores. It brings together everything you need at checkout and protects your payment info with multiple layers of security. +
Plus, Google Pay™ makes it easy to redeem loyalty points, manage your cards, and get personalized suggestions to help you save time and money.
...
<<API_Fields_xmlelements_request_cryptogram, ``cryptogram-value``>> is optional in the response.

Refer to the <<RestApi_Fields, API field list>> for all the other fields used in Google Pay™ requests, responses and notifications.
