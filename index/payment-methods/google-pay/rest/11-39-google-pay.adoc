...
----
include::{basedir}/samples/xml/google-pay_creditcard_authorization_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/google-pay_creditcard_authorization_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/GooglePaySamplesCaptureAuthorization_CaptureAuthorizationRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/google-pay_creditcard_capture-authorization_response_success_a13463f2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/google-pay_creditcard_purchase_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/google-pay_creditcard_purchase_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/GooglePaySamplesRefund_RefundRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/google-pay_creditcard_refund-capture_response_success_88915dc8.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/GooglePaySamplesVoid.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/google-pay_creditcard_void-authorization_response_success_b517f83a.xml[]
----
