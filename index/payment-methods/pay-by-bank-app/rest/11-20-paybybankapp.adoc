...
|payment-methods/payment-method[@name]  |M |M |M |String  |9  |The name of the Payment Method is "*paybybankapp*".
...
|payment-methods/payment-method[@name]                        |M |String    |9     |The name of the Payment Method is "*paybybankapp*".
