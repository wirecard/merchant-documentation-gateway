...
----
include::{BASEDIR}/samples/json/WPP_SEPADirectDebitTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SEPADirectDebitTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SEPADirectDebitRecurringTransactions_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SEPADirectDebitRecurringTransactions_2RtCttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SEPADirectDebitRecurringTransactions_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SEPADirectDebitB2BScheme_SEPA_DirectDebitExampleRequestWith_B2B_SchemeEnabled.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SEPADirectDebit_JSON_NVPFields_JSON_StructureFor_SEPA_DirectDebitRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_SEPADirectDebit_JSON_NVPFieldsRequest_ResponseOnlyFields.json[]
----
