...
----
include::{base_dir}/samples/xml/sepacredit_pending-credit_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sepacredit_pending-credit_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sepacredit_pending-credit_request_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sepacredit_pending-credit_response_failure.xml[]
----
...
----
include::{base_dir}/samples/json/SEPACreditTransferSamplesPendingCreditJson_JSON_PendingCreditRequestSuccessful.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/SEPACreditTransferSamplesPendingCreditJson_JSON_PendingCreditResponseSuccessful.json[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sepacredit_void-pending-credit_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sepacredit_void-pending-credit_response_success_8938d389.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sepacredit_void-pending-credit_request_.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/sepacredit_void-pending-credit_response_.xml[]
----
