...
----
include::{basedir}/samples/xml/wiretransfer_deposit_notification__a88b4b46.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/sepadirectdebit_debit-return_notification__3fa23529.xml[]
----
