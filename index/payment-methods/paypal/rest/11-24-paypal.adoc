...
IMPORTANT: The endpoint for referenced transactions is: ``\https://payments.wirecard.com/ee/rest/payments/``.
...
ifdef::env-nova[]
h|URL (Endpoint) 3+|``\https://payments-test.wirecard.com/ee/rest/payments``
endif::[]
