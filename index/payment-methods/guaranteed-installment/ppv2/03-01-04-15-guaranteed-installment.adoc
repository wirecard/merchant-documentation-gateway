...
[#PPv2_GuaranteedInstallment_TestCredentials_Additional]
...
----
include::{base_dir}/samples/json/PPv2_GuaranteedInstallment_TransactionTypeAuthorization_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/PPv2_GuaranteedInstallment_TransactionTypeAuthorization_3DecodedPaymentResponse.json[]
----
...
include::{base_dir}/include/ppv2-post-processing-operation.adoc[]
