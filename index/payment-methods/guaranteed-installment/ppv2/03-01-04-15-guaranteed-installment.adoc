...
----
include::{basedir}/samples/json/PPv2_GuaranteedInstallment_TransactionTypeAuthorization_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/PPv2_GuaranteedInstallment_TransactionTypeAuthorization_3DecodedPaymentResponse.json[]
----
...
include::{basedir}/include/ppv2-post-processing-operation.adoc[]
