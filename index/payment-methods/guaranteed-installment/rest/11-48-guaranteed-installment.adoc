...
You can use these credentials for payment tests as well as testing the <<GuaranteedInstallment_Config, installment configuration service>> and the <<GuaranteedInstallment_Features_InstallCalc, installment calculator>>.
