...
_Guaranteed Installments_ is a type of <<PaymentMethods_PaymentMode_OfflineBankTransfer, Offline Bank Transfer>>.
...
You can use these credentials - aside from the endpoints - for payment tests as well as testing the <<GuaranteedInstallment_Config, Guaranteed Installment Configuration>> and <<GuaranteedInstallment_Features_InstallCalc, Installment Calculator>>.
...
You can use the installment configuration service to configure installment plan parameters tailored for your merchant profile.
