...
You can use these credentials for payment tests as well as testing the <<GuaranteedInstallment_Config, Guaranteed Installment Configuration>> and <<GuaranteedInstallment_Features_InstallCalc, Installment Calculator>>.
