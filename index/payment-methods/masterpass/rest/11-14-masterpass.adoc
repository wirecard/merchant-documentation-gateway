...
to _Masterpass_ website to login and select the preferred credit card for
payment. +
...
----
include::/{base_dir}/samples/xml/masterpass_request-checkout_request_success_pairing-and-checkout.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_request-checkout_response_success_pairing-and-checkout.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_request-checkout_request_success_pairing.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_request-checkout_response_success_pairing.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_request-checkout_notification_success_null.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_precheckout_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_precheckout_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_request-checkout_request_success_express-checkout_37b24b99.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_request-checkout_response_success_express-checkout_37b24b99.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_debit_request_success_05e44225.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/masterpass_debit_response_success_05e44225.xml[]
----
//-
