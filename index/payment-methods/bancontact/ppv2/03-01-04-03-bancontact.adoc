...
----
include::{BASEDIR}/samples/json/WPP_BancontactTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_BancontactTransactionTypeDebit_2RtcttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_BancontactTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
