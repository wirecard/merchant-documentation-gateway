...
----
include::/{base_dir}/samples/json/WPP_BancontactTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::/{base_dir}/samples/json/WPP_BancontactTransactionTypeDebit_2RtcttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::/{base_dir}/samples/json/WPP_BancontactTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
