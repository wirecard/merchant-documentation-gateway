...
----
include::/{base_dir}/samples/xml/bancontact_debit_request_success.xml[]
----

.debit Response (Successful)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/bancontact_debit_response_success.xml[]
----

.debit Request (Failure)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/bancontact_debit_request_failure.xml[]
----

.debit Response (Failure)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/bancontact_debit_response_failure.xml[]
----
