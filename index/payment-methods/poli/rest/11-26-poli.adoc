...
----
include::{BASEDIR}/samples/xml/poli_debit_request_success_en.xml[]
----

.XML debit Response (Successful)
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/poli_debit_response_success_en.xml[]
----

.XML debit Request (Failure)
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/poli_debit_request_failure_en.xml[]
----

.XML debit Response (Failure)
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/poli_debit_response_failure_en.xml[]
----
