...
include::{root}/index/payment-methods/klarna-payments/rest/11-13-01-05-klarna-v2-authorization-renewal.adoc[]
...
include::{root}/index/payment-methods/klarna-payments/rest/11-13-01-05-klarna-v2-adjust-capture.adoc[]
