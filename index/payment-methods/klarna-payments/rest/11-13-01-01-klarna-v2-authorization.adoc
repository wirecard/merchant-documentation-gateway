...
|Boolean
|
|``true``: If this ``authorization`` is successful, it will be <<KlarnaV2_TransactionTypes_authorization_autoCapture, captured automatically.>> +
For <<KlarnaV2_TransactionTypes_authorization_Fields_orderItem_digital, digital goods/services>> only.
