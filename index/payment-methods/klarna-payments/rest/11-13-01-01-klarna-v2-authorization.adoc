...
The <<KlarnaV2_TransactionTypes_authorization_Fields_orderItems, ``order-item.type``>> of each <<KlarnaV2_TransactionTypes_authorization_Fields_orderItems, ``order-item``>> must be <<KlarnaV2_TransactionTypes_authorization_Fields_orderItems, ``digital``.>> +
...
include::{root}/include/klarna-payments/fields/klarnaPayments_fields_paymentMethod.adoc[tags=**;!optional;!recurring;!adjust-authorization;!recurringAuthorization]
...
[[KlarnaV2_TransactionTypes_authorization_Fields_orderItems]]
