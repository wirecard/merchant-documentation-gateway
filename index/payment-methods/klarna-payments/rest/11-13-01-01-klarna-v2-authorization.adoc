...
The <<KlarnaV2_TransactionTypes_{listname}_Fields_orderItem_type_digital, ``order-item.type``>> of each ``order-item`` must be <<KlarnaV2_TransactionTypes_{listname}_Fields_orderItem_type_digital, ``digital``.>> +
