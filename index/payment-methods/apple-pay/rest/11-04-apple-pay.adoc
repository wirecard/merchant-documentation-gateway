...
You can either provide your key account manager with your Apple Merchant Identifier or you can contact our mailto:support@wirecard.com?subject=Apple%20Pay%20Certificate%20Signing%20Request[Merchant Support] and request a CSR file. 
+
NOTE: {payment-provider-name} will provide you with separate CSRs for test and production environments. When moving from test to production environments, just request a new CSR for production from mailto:support@wirecard.com?subject=Apple%20Pay%20Certificate%20Signing%20Request[Merchant Support] and proceed to Step 2.
