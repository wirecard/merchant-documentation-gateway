...
----
include::{BASEDIR}/samples/xml/giropay_get-url_request_success_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/giropay_get-url_response_success_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/giropay_debit_notification_success_en_18ad619c.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/giropay_get-url_request_failure_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/giropay_get-url_response_failure_en.xml[]
----
