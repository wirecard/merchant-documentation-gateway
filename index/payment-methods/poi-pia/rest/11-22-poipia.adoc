...
----
include::{basedir}/samples/xml/wiretransfer_authorization_request_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/wiretransfer_authorization_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/wiretransfer_authorization_request_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/wiretransfer_authorization_response_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/wiretransfer_void-authorization_request_success_c8d40613.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/wiretransfer_void-authorization_response_success_c8d40613.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/wiretransfer_void-authorization_request_failure_a7953048.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/wiretransfer_void-authorization_response_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/wiretransfer_deposit_notification_.xml[]
----
