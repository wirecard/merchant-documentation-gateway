...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_CC_TransactionTypePurchase_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]

[cols="20,10,10,10,5,45"]
|===
2+|Field (JSON) |<<APIRef_FieldDefs_DataTypes, Data Type>> |<<APIRef_FieldDefs_Cardinality, M/O>> |Size |Description

e|merchant-account-id |value |String |Mandatory |36 |A unique identifier
assigned to every merchant account (by {payment-provider-name}).
2+e|request-id |String |Mandatory |64 a|A unique identifier assigned to every
...
2+e|transaction-type |String |Mandatory |36 |The requested transaction type.
.2+e|requested-amount |value |Numeric |Mandatory |18 a|The full amount that is
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_CC_TransactionTypePurchase_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]

[cols="20,10,5,65"]
|===
2+|Field (JSON) |<<APIRef_FieldDefs_DataTypes, Data Type>> |Description
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_CC_TransactionTypeAuthorization_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]

[cols="20,10,10,10,5,45"]
|===
2+|Field (JSON) |<<APIRef_FieldDefs_DataTypes, Data Type>> |
<<APIRef_FieldDefs_Cardinality, M/O>> |Size |Description
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_CC_TransactionTypeAuthorization_AuthorizationResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_CC_TransactionTypeAuthorizationonly_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_CC_TransactionTypeAuthorizationonly_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_CC_3DSecureTestCredentialsAdditional_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
e|payment-method |name |String |Optional |15 |The name of the payment method
used. Set this value to ``creditcard``.
2+e|attempt-three-d |Boolean |Conditional |N/A |Mandatory for 3D Secure
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/PaydooPPv2_CC_3DSecureTestCredentialsAdditional_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
|===
5+|Field |<<APIRef_FieldDefs_DataTypes, Data Type>> |<<APIRef_FieldDefs_Cardinality, M/O>> |Size |Description
