...
| Username                   | 51126-PAYDOO
| Password                   | ic1-781Tp14715
| Secret Key (used for response verification) | d64e9579-73bc-47cf-b05d-19d6f39610db
|===
endif::[]
...
ifdef::env-po[]
|===
| Authorization | Basic NTExMjYtUEFZRE9POmljMS03ODFUcDE0NzE1
| Content-Type  | application/json
|===
endif::[]
...
----
include::{base_dir}/samples/json/WPP_CC_TransactionTypePurchase_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/PaydooPPv2_CC_TransactionTypePurchase_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_TransactionTypePurchase_2RtCttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_TransactionTypePurchase_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/PaydooPPv2_CC_TransactionTypePurchase_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_TransactionTypeAuthorization_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/PaydooPPv2_CC_TransactionTypeAuthorization_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_TransactionTypeAuthorization_2RtCttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_TransactionTypeAuthorization_AuthorizationResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/PaydooPPv2_CC_TransactionTypeAuthorization_AuthorizationResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_TransactionTypeAuthorizationonly_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/PaydooPPv2_CC_TransactionTypeAuthorizationonly_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_TransactionTypeAuthorizationonly_2RtCttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_TransactionTypeAuthorizationonly_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/PaydooPPv2_CC_TransactionTypeAuthorizationonly_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_JSONNVPField_JSON_StructureForCreditCardRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_JSONNVPFieldResponseonly.json[]
----
...
| Username                   | 51126-PAYDOO
| Password                   | ic1-781Tp14715
| Secret Key (used for response verification) | dd333a07-6535-41e8-9324-e78110cea672
|===
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_3DSecureTestCredentialsAdditional_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/PaydooPPv2_CC_3DSecureTestCredentialsAdditional_1CreateAPaymentSessionInitialRequest.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_3DSecureTestCredentialsAdditional_2RtCttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_3DSecureTestCredentialsAdditional_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/PaydooPPv2_CC_3DSecureTestCredentialsAdditional_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
endif::[]
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_CC_Additional3DS2Fields_Sample.json[]
----

.Additional Fields for 3DS2
[#PPv2_CC_3DS2Fields_ROC]
A field can be **R**equired or **O**ptional.
[%autowidth, stripes="none"]
|===
5+|JSON |Datatype |<<PPv2_CC_3DS2Fields_ROC, R/O>> |Size |Description
