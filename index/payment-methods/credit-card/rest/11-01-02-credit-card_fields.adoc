...
| card-emv
| <<CC_Fields_xmlelements_cardEMV, X>>
| <<CC_Fields_xmlelements_cardEMV, X>>
...
ifndef::env-nova[]
| encryption-context
| <<CC_Fields_xmlelements_card_encryptionContext>, X>>
| 

| iso
| <<CC_Fields_xmlelements_ISO>, X>>
| 
endif::[]
