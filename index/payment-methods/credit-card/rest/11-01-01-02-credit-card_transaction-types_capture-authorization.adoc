...
----
include::{basedir}/samples/xml/creditcard_authorization_request_success_de4dea_2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_authorization_response_success_784ca3.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/CreditCardTransactionTypesCaptureAuthorizationSendingDataCaptureAuthorization_CaptureAuthorizationRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_capture-authorization_response_success_df92ce59.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/CreditCardTransactionTypesCaptureAuthorizationSendingDataVoidCapture_VoidCaptureRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_void-capture_response_success_76c1fcbf.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/CreditCardTransactionTypesCaptureAuthorizationSendingDataRefundCapture_RefundCaptureRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_refund-capture_response_success_dce8eb51.xml[]
----
