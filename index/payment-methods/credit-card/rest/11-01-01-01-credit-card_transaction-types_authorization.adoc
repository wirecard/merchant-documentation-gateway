...
----
include::{base_dir}/samples/xml/creditcard_authorization_request_success_091c42.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/creditcard_authorization_response_success_8d2ff4.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/creditcard_authorization_request_success_de4dea_1.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/creditcard_authorization_response_success_3fd72a.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/CreditCardTransactionTypesAuthorizationSendingDataVoidAuthorization_VoidAuthorizationRequestSuccessful.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/creditcard_void-authorization_response_success_878d86d2.xml[]
----
