...
. WPG processes the request and forwards it to _payolution_.
. _payolution_ captures the requested amount and sends a response to WPG.
. WPG processes the response informs you about the transaction outcome.
