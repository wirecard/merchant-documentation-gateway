...
----
include::{basedir}/samples/xml/creditcard_purchase_request_success_a51636.xml[]
----

.XML _pending-purchase_ Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_pending-purchase_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_purchase_notification_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_purchase_request_success_74ddf4.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_purchase_request_success_ad6d80.xml[]
----

.XML _purchase_ Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_purchase_response_success_2e2a6b.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_capture-authorization_request_success_2ba623d0.xml[]
----

.XML _capture-authorization_ Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_capture-authorization_response_success_2ba623d0.xml[]
----

.XML _void-authorization_ Request (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_void-authorization_request_success_adbd1fdc.xml[]
----

.XML _void-authorization_ Response (Successful)
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_void-authorization_response_success_adbd1fdc.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_refund-capture_response_success_3f7d5d69.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/creditcard_refund-capture_request_success_3f7d5d69.xml[]
----
