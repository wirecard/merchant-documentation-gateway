...
----
include::{base_dir}/samples/xml/fpx_abb_debit_request_success_MY.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/fpx_abb_debit_response_success_MY.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/fpx_abb_debit_request_failure_MY.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/fpx_abb_debit_response_failure_MY.xml[]
----
