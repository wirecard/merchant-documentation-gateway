...
The response and notification of <<GeneralPlatformFeatures_Transactions_Recurring, recurring transactions>> return the RegKey of _LINE Pay_ in <<Linepay_Fields, wallet.token-id>>, which is useful for later reference. You do not need to submit it in later recurring transactions. +
...
. You redirect the consumer to his/her _LINE Pay_ account.
. Consumer logs in and confirms the payment.
. You redirect the consumer to your confirmation page.
...
In case of a successful payment, {payment-gateway} redirects the consumer back to your website and sends you a notification of the successful transaction.
...
<payment xmlns="http://www.elastic-payments.com/schema/payment">
   ...
   <cancel-redirect-url>{pp-redirect-url-cancel}</cancel-redirect-url>
