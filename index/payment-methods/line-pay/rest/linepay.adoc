...
|_pending-debit_ |A step in a group of transactions where the account holder is redirected to the provider's page. | <<Linepay_Samples_pendingdebit, _pending-debit sample>>
