...
----
include::{BASEDIR}/samples/xml/ideal_get-url_request_success_de.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ideal_get-url_response_success_de.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ideal_debit_notification_success_de_67bea562.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ideal_get-url_request_failure_de.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ideal_get-url_response_failure_de.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/ideal_get-url_notification_failure_de_40f59357.xml[]
----
