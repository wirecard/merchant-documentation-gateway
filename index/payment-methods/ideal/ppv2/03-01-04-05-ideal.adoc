...
----
include::{basedir}/samples/json/WPP_IdealTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_IdealTransactionTypeDebit_2RtCttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_IdealTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_IdealJSONNVPFieldRequest_JSON_StructureForiDEALRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_IdealJSONNVPFieldResponse_ResponseOnlyFields.json[]
----
