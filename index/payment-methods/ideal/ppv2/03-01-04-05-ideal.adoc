...
|===
3+|Field (JSON) |<<APIRef_FieldDefs_DataTypes, Data Type>> |<<APIRef_FieldDefs_Cardinality, M/O>> |Size |Description
...
3+|request-id |String |Mandatory |64 a|A unique identifier assigned to every request
