...
----
include::{BASEDIR}/samples/xml/alipay_debit_request_success_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/alipay_debit_response_success_en.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/alipay_debit_notification_success_en_12ba0604.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/alipay_debit_request_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{BASEDIR}/samples/xml/alipay_debit_response_failure.xml[]
----
