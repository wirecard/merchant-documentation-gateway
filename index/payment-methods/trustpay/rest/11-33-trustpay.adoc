...
----
include::{base_dir}/samples/xml/trustpay_debit_request_success_d3dad6.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/trustpay_debit_response_success_1fc184.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/trustpay_debit_notification_success_6e2e230b.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/trustpay_debit_request_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/trustpay_debit_response_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/trustpay_debit_request_success_b25243.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/trustpay_debit_response_success_548b14.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{base_dir}/samples/xml/trustpay_debit_notification_success.xml[]
----
