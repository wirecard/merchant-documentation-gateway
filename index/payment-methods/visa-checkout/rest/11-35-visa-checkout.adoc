...
----
include::{samples}/xml/visacheckout_debit_request__5caaa5.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{samples}/xml/visacheckout_debit_response__3254fe.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{samples}/xml/visacheckout_debit_notification__79b05b49.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{samples}/xml/visacheckout_debit_request__4da196.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{samples}/xml/visacheckout_debit_response__fb254f.xml[]
----
