...
----
include::/{base_dir}/samples/xml/skrill_get-url_request_success_de_DE.xml[]
----

.XML Get-Url Response (Successful)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/skrill_get-url_response_success_de_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/skrill_get-url_unknown__de_DE.xml[]
----

.XML Get-Url Response - Incorrect Wallet Account ID (Failure)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/skrill_get-url_response_failure_de_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/skrill_credit_request_success.xml[]
----

.XML Credit Response (Successful)
[source,xml,subs=attributes+]
----
include::/{base_dir}/samples/xml/skrill_credit_response_success.xml[]
----
