...
include::{base_dir}/include/list-eps-banks.adoc[]
...
----
include::{base_dir}/samples/json/WPP_EpsTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_EpsTransactionTypeDebit_2RtCttPPIDR.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_EpsTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_EpsJSONNVPFieldsRequest_JSON_StructureForEpsRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::{base_dir}/samples/json/WPP_EpsJSONNVPFieldsRequest_ResponseOnlyFields.json[]
----
