...
include::{BASEDIR}/include/list-eps-banks.adoc[]
...
----
include::{BASEDIR}/samples/json/WPP_EpsTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_EpsTransactionTypeDebit_2RtCttPPIDR.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_EpsTransactionTypeDebit_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_EpsJSONNVPFieldsRequest_JSON_StructureForEpsRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::{BASEDIR}/samples/json/WPP_EpsJSONNVPFieldsRequest_ResponseOnlyFields.json[]
----
