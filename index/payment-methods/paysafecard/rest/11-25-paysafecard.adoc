...
----
include::{basedir}/samples/xml/paysafecard_authorization_request_success_de_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_authorization_response_success_de_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_authorization_request_failure_de_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_authorization_response_failure_de_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_capture-authorization_request_success_None_DE_df662ff2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_capture-authorization_response_success_None_DE_df662ff2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_capture-authorization_request_failure_None_DE_ab662ff2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_capture-authorization_response_failure_None_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_void-authorization_request_success_df662ff2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_void-authorization_response_success_de_DE_df662ff2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_void-authorization_request_failure_a56c26e6.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_void-authorization_response_failure.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_debit_request_success_DE_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_debit_response_success_DE_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_debit_request_failure_DE_DE.xml[]
----
...
[source,xml,subs=attributes+]
----
include::{basedir}/samples/xml/paysafecard_debit_response_failure_DE_DE.xml[]
----
