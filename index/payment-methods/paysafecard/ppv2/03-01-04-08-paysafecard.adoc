...
2+|request-id |String |Mandatory |64 a|A unique identifier assigned by the merchant
...
[source,json,subs=attributes+]
----
include::{root}/samples/json/WPP_PaysafecardJSONNVPFieldsRequest_JSON_StructureForPayboxRequests.json[]
----
