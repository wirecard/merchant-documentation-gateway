...
----
include::{basedir}/samples/json/WPP_PaysafecardTransactionTypeDebit_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PaysafecardTransactionTypeDebitRedirect_2RtCttPPIRU.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PaysafecardTransactionTypeDebitRedirect_3ParseAndProcessThePaymentResponseDecodedPaymentResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PaysafecardTransactionTypeAuthorization_1CreateAPaymentSessionInitialRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PaysafecardTransactionTypeAuthorization_3PaPtaRDPR.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PaysafecardTransactionTypeCapture_CaptureAuthorizationRequest.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PaysafecardTransactionTypeCapture_CaptureAuthorizationResponse.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PaysafecardJSONNVPFieldsRequest_JSON_StructureForPayboxRequests.json[]
----
...
[source,json,subs=attributes+]
----
include::{basedir}/samples/json/WPP_PaysafecardJSONNVPFieldsResponse_ResponseOnlyFields.json[]
----
