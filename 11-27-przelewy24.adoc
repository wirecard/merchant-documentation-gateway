...
[source,xml]
----
include::samples/xml/Przelewy24SamplesDebit_DebitRequestSuccessful.xml[]
----

.debit Response (Succcessful)
[source,xml]
----
include::samples/xml/Przelewy24SamplesDebit_DebitResponseSucccessful.xml[]
----
...
[source,xml]
----
include::samples/xml/Przelewy24SamplesRefund_RefundRequestRequestSuccessful.xml[]
----

.refund-request Response (Successful)
[source,xml]
----
include::samples/xml/Przelewy24SamplesRefund_RefundRequestResponseSuccessful.xml[]
----
