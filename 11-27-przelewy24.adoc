...
[source,xml]
----
include::src-files/xml/Przelewy24_Samples_debit_debit_Request_Successful.xml[]
----

.debit Response (Succcessful)
[source,xml]
----
include::src-files/xml/Przelewy24_Samples_debit_debit_Response_Succcessful.xml[]
----
...
[source,xml]
----
include::src-files/xml/Przelewy24_Samples_refund_debit_Response_Succcessful.xml[]
----
