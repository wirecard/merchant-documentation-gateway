...
. Wirecard Bank collects all funds on a collecting bank account owned by Wirecard.
...
A ``refund`` transaction is a backend process. _{payment-gateway-abbr}_ can only provide a
...
----
include::samples/xml/p24_debit_request_success.xml[]
----

.debit Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/p24_debit_response_success.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/p24_refund-request_request_success_77e8f783.xml[]
----

.refund-request Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/p24_refund-request_response_success_77e8f783.xml[]
----
