...
<<PPv2_paydirekt_TransactionType_debitauth, _debit_>>,  
...
With _paydirect_ you can use the transaction types <<PPv2_paydirekt_TransactionType_debitauth, _authorization_>> and <<PPv2_paydirekt_TransactionType_debitauth, _debit_>>.
