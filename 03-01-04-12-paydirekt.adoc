...
[#PPv2_general_JSON_NVPFields]
====== JSON/NVP Field Reference

In this section migrating merchants can find the NVP equivalents for JSON fields.

.JSON Structure for a General Request
...
[#PPv2_general_JSON_NVPFields_Request]
[cols="e,e,e"]
|===
...
.JSON Structure for Response-Only Fields
...
----
{
  "payment": {
    ...
    "completion-time-stamp": "Date time",
    "statuses": {
      "status": [
        {
          "code": "String",
...
[#PPv2_general_JSON_NVPFields_Response]
