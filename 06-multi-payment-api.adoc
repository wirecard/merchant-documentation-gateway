...
[source,xml]
----
include::src-files/xml/MultiPaymentApi_Samples_Request_Purchase_Credit_Card_and_2_Vouchers.xml[]
----

.Response Purchase Successful
[source,xml]
----
include::src-files/xml/MultiPaymentApi_Samples_Response_Purchase_Successful.xml[]
----
