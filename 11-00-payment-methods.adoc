...
Also some <<API_PM_APM_PaymentMode_Mobile, _Mobile Payment_>> options, which
...
a|[#PaymentMethods_PaymentMode_OnlineBankTransfer]
[discrete]
...
a|[#PaymentMethods_PaymentMode_OfflineBankTransfer]
[discrete]
...
a|[#PaymentMethods_PaymentMode_Prepaid]
[discrete]
===== _Prepaid_
...
a|[#PaymentMethods_PaymentMode_Voucher]
[discrete]
===== _Voucher_
|<<WirecardVoucher, Wirecard Voucher>>

a|[#PaymentMethods_PaymentMode_Wallet]
[discrete]
===== _Wallet_
...
a|[#PaymentMethods_PaymentMode_MobilePayment]
[discrete]
===== _Mobile Payment_
