...
<<API_PM_APM_PaymentMode_Online, _Online Bank Transfer_>> and
<<API_PM_APM_PaymentMode_Offline, _Offline Bank Transfer_>> APMs. Each payment method can be used depending
...
<<API_PM_APM_PaymentMode_Prepaid, _Prepaid_, _Voucher_>> or
<<API_PM_APM_PaymentMode_Wallet, _Wallet_>>.

Also some <<API_PM_APM_PaymentMode_Mobile, _Mobile Payment_>> options, which are just a variety of the above
...
<<API_PM_APM_PaymentMode_Online, _Online Bank Transfer_>>

<<API_PM_APM_PaymentMode_Offline, _Offline Bank Transfer_>>
