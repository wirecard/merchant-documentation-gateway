[#mobicred]
=== mobicred
_mobicard_ is a type of <<PaymentMethods_PaymentMode_Wallet, Wallet>>.
...
----
include::samples/xml/mobicred_get-url_request_success.xml[]
----

.XML get-url Response (Successful)
[source,xml,subs=attributes+]
----
include::samples/xml/mobicred_get-url_response_success.xml[]
----
