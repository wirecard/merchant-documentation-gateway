...
[source,xml]
----
include::src-files/xml/API_PaybyBankapp_Samples_debit_withPC__debit__Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_PaybyBankapp_Samples_debit_withPC__debit__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_PaybyBankapp_Samples_debit_withPC__debit__Notification_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_PaybyBankapp_Samples_debit_withoutPC__debit__Request_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_PaybyBankapp_Samples_debit_withoutPC__debit__Response_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_PaybyBankapp_Samples_debit_withoutPC__debit__Notification_Successful.xml[]
----
...
[source,xml]
----
include::src-files/xml/API_PaybyBankapp_Samples_refundrequest__debit__Notification_Successful.xml[]
----
