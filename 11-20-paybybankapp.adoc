...
--
[.right]
image::images/11-20-paybybankapp/logo_pay-by-bank-app.jpg[Pay by Bank app Logo, width=200]
...
[%autowidth]
|===
.2+h| URL(s) Endpoints |For the transaction type _debit_.        |``\https://{test-instance-hostname}/engine/rest/paymentmethods/``
...
. Merchants send _refund_ request to _{payment-gateway-abbr}_.
...
|custom-field/[@zapp.in.RefundMethod]    |M |O |O |String    |  |The method of Refund that will be used by _{payment-gateway-abbr}_ to make the refund payment
...
|custom-field/[@zapp.in.RefundMethod]        |O |String    |      |The method of Refund that will be used by _{payment-gateway-abbr}_ to make the refund payment
...
[source,xml,subs=attributes+]
----
include::samples/xml/zapp_debit_response_success_87c979.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/zapp_debit_notification_success_fb22856d.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/zapp_debit_request_success_ad66b3.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/zapp_debit_response_success_670826.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/zapp_debit_notification_success_3958a84c.xml[]
----
...
supplies consumer's bank account details kept by _{payment-gateway-abbr}_. These are
...
[source,xml,subs=attributes+]
----
include::samples/xml/zapp_refund-request_request_success_24b115ba.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/zapp_refund-request_response_success_b1ca738d.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/zapp_refund-debit_notification_success_1309ca5e.xml[]
----
