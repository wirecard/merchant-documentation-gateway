...
sequenceDiagram
    ...
    participant giropay/Consumer Bank
...
{payment-gateway-abbr}->>giropay/Consumer Bank: sends the request to giropay
giropay/Consumer Bank->>{payment-gateway-abbr}: provides URL of the consumer's online banking account for payment verification
{payment-gateway-abbr}->>Consumer: processes the response and redirects the consumer to the provided online banking URL
Consumer->>giropay/Consumer Bank: verifies the payment within the personal online basket system
giropay/Consumer Bank->>giropay/Consumer Bank: transfers funds from consumer's bank to merchant's bank
giropay/Consumer Bank->>{payment-gateway-abbr}: sends payment notification
