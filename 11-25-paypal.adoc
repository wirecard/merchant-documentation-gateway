...
image::images/11-25-paypal/PaypalWorkflow_refundDebit.png[refund-debit Workflow]
...
image::images/11-25-paypal/PaypalWorkflow_AuthorizationCapture.png[authorization and capture-authorization workflow]
...
+
image::images/11-25-paypal/Granting_3rdParty_APIAccess.jpg[Paypal 3rdparty APIaccess]
+
. In the textfield _Third Party Permission Username_  enter
``\payments_api1.wirecard.com`` and click _Lookup_.
+
image::images/11-25-paypal/Granting_3rdParty_AddNewTPP.jpg[Paypal 3rdparty Newaccess]
+
...
- Click _Add_.
+
image::images/11-25-paypal/Granting_3rdParty_AddNewTPP_Detail.gif[Paypal 3rdparty NewaccessDetail]
+
. Check that the permissions were added successfully.
+
image::images/11-25-paypal/Granting_3rdParty_ManageThirdParty.jpg[Paypal Manage3rdparty]
+
...
+
image::images/11-25-paypal/IPN_PayPal_Profile.png[PaypalProfile]
+
...
row.
+
image::images/11-25-paypal/IPN_PayPal_MySellingTools.png[PayPal Selling Tools]
+
. Click _Edit settings_
+
image::images/11-25-paypal/IPN_PayPal_EditSettings.png[PayPal Edit Settings]
+
. Set Notification URL ``\https://api.wirecard.com/engine/notification/paypalipn`` to Wirecard server as shown on image below.
+
image::images/11-25-paypal/IPN_PayPal_SetNotificationURL.png[PayPal Set Notification URL]
//-

[#API_PayPal_Configuration_Addresses]
==== Addresses

The _Wirecard Payment Processing Gateway_ offers three options to configure the
consumer's address:
...
NOTE: For recurring payments __Wirecard Payment Processing Gateway__ uses the shipping
...
image::images/11-25-paypal/PayPal_CancelHandling.png[PayPal Cancel Handling]
...
----
[#API_PayPal_Workflow_PendingCredit]
====== _pending-credit_
...
[#API_PayPal_Workflow_AuthorizationOnly]
====== _authorization-only_
...
NOTE: Using PayPal to <<API_PayPal_Addresses, show consumer's address>>, please
