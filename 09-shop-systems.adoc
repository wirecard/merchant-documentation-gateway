...
| link:https://magento1.wirecard.com[Magento 1]
  a|  - Credit Card
      - Alipay Cross-border
      - eps-Überweisung
      - giropay
      ...
      - SEPA Direct Debit
      - Sofort.
      - UnionPay International a|  
      
      - English
      - German  a|  
      
      - link:https://github.com/wirecard/magento-ee/wiki[English]
| link:https://magento.wirecard.com[Magento 2]
  a|  - Credit Card
      - Alipay Cross-border
      - giropay
      - Guaranteed Invoice by Wirecard
      ...
      - link:https://github.com/wirecard/magento2-ee/wiki[English]
      - link:https://github.com/wirecard/magento2-ee/wiki/Accueil[French]
| link:https://opencart.wirecard.com[OpenCart]
  a|  - Credit Card
      - Alipay Cross-border
      - Guaranteed Invoice by Wirecard
      - iDEAL
      ...
      - link:https://github.com/wirecard/opencart-ee/wiki[English]
| link:https://prestashop.wirecard.com[PrestaShop]
  a|  - Credit Card and Maestro SecureCode
      ...
      - link:https://github.com/wirecard/prestashop-ee/wiki[English]
      - link:https://github.com/wirecard/prestashop-ee/wiki/Accueil[French]
| link:https://sapcommerce.wirecard.com[SAP Commerce]
  a|  - Credit Card and Maestro SecureCode
      - Alipay Cross-border
      - Guaranteed Invoice by Wirecard
      - iDEAL
      ...
      - link:https://github.com/wirecard/sap-commerce-ee/wiki[English]
| link:https://shopify.wirecard.com[Shopify]
  a|  - Credit Card and Maestro SecureCode
      - Pay by Bank app
      - PayPal
      - SEPA Direct Debit
      ...
      - link:https://github.com/wirecard/shopify-ee/wiki[English]
      - link:https://github.com/wirecard/shopify-ee/wiki/Accueil[French]
| link:https://shopware.wirecard.com[Shopware]
  a|  - Credit Card and Maestro SecureCode
      - Alipay Cross-border
      - eps-Überweisung
      - Guaranteed Invoice by Wirecard
      ...
      - link:https://github.com/wirecard/shopware-ee/wiki[English]
| link:https://woocommerce.wirecard.com[WooCommerce]
  a|  - Credit Card and Maestro SecureCode
      - Alipay Cross-border
      - eps-Überweisung
      - Guaranteed Invoice by Wirecard
      ...
      - link:https://github.com/wirecard/woocommerce-ee/wiki[English]
