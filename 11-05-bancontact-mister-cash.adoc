...
[source,xml]
----
include::src-files/xml/BancontactMisterCash_Sample_ReSTAPI_debit_Request_Successful.xml[]
----

.debit Response (Successful)
[source,xml]
----
include::src-files/xml/BancontactMisterCash_Sample_ReSTAPI_debit_Response_Successful.xml[]
----

.debit Request (Failure)
[source,xml]
----
include::src-files/xml/BancontactMisterCash_Sample_ReSTAPI_debit_Request_Failure.xml[]
----

.debit Response (Failure)
[source,xml]
----
include::src-files/xml/BancontactMisterCash_Sample_ReSTAPI_debit_Response_Failure.xml[]
----
