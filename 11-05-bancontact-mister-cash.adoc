...
[source,xml]
----
include::samples/xml/BancontactMisterCashSampleReSTAPI_DebitRequestSuccessful.xml[]
----

.debit Response (Successful)
[source,xml]
----
include::samples/xml/BancontactMisterCashSampleReSTAPI_DebitResponseSuccessful.xml[]
----

.debit Request (Failure)
[source,xml]
----
include::samples/xml/BancontactMisterCashSampleReSTAPI_DebitRequestFailure.xml[]
----

.debit Response (Failure)
[source,xml]
----
include::samples/xml/BancontactMisterCashSampleReSTAPI_DebitResponseFailure.xml[]
----
