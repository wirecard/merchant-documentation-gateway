...
- <<CreditCard_TransactionTypes_CaptureAuthorization_SendingData_RefundCapture, _refund-capture_>> (details see <<CreditCard_TransactionTypes__VoidRefund_Refund, refund>>).
//-

[#CreditCard_TransactionTypes_CaptureAuthorization_SendingData_VoidCapture]
._void-capture_

A __void-capture__ request must reference a successful
