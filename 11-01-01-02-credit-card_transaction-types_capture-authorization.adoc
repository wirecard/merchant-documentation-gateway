...
Typically, a _capture-authorization_ captures either a part of or the full amount
of the authorized amount.

[#CreditCard_Overcapturing]
NOTE: *Overcapturing* +
There is also the option of overcapturing. Overcapturing allows you to capture an amount larger than initially authorized. The amount captured may exceed the initially authorized amount by up to 40%. To enable overcapturing, your merchant account needs to be configured. Please mailto:{e-mail-support}[contact merchant support].
...
----
include::samples/xml/creditcard_authorization_request_success_de4dea_2.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_authorization_response_success_784ca3.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_capture-authorization_response_success_df92ce59.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_void-capture_response_success_76c1fcbf.xml[]
----
...
[source,xml,subs=attributes+]
----
include::samples/xml/creditcard_refund-capture_response_success_dce8eb51.xml[]
----
