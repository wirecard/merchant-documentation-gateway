...
NOTE: *Overcapturing* +
There is also the option to capture an amount up to 40% higher than initially authorized. To enable this option, your merchant account needs to be configured. Please mailto:{e-mail-support}[contact merchant support].
