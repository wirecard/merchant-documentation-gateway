...
NOTE: *Overcapturing* +
There is also the option to capture an amount larger than initially authorized. The amount captured may exceed the initially authorized amount by up to 40%. To enable this option, your merchant account needs to be configured. Please mailto:{e-mail-support}[contact merchant support].
